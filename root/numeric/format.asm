...
; format_FixedWidth~32u[118] = {56 48 83 ec 40 33 c0 48 89 44 24 20 48 89 44 24 28 48 89 44 24 30 48 89 44 24 38 8b f1 48 b9 08 8f 70 c7 f7 7f 00 00 e8 e4 1c 79 5f 89 70 08 45 33 c0 48 ba 88 13 dc 44 0f 02 00 00 48 8b 12 48 b9 00 97 dc 44 0f 02 00 00 48 8b 09 4c 8d 4c 24 20 49 89 01 4d 89 41 08 4d 89 41 10 49 89 51 18 4c 8d 44 24 20 48 8b d1 33 c9 e8 31 0c 23 4f 90 48 83 c4 40 5e c3}
...
0027h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e4 1c 79 5f}
002ch mov [rax+8],esi                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 08}
002fh xor r8d,r8d                             ; XOR r32, r/m32 || o32 33 /r || encoded[3]{45 33 c0}
0032h mov rdx,20f44dc1388h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 88 13 dc 44 0f 02 00 00}
003ch mov rdx,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 12}
003fh mov rcx,20f44dc9700h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 00 97 dc 44 0f 02 00 00}
...
006ah call 7ff816d05c40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 31 0c 23 4f}
