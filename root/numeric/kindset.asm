...
; kindset_NumericKind~32u[145] = {57 56 53 48 83 ec 20 8b f1 48 b9 b0 76 ac c6 f7 7f 00 00 e8 f8 c5 50 5f 48 8b f8 48 b9 d8 8a 4c c6 f7 7f 00 00 ba 27 00 00 00 e8 e1 c9 50 5f 48 ba 88 6a 56 e7 0b 02 00 00 48 8b 1a 48 8d 4f 08 48 8b d7 e8 08 b7 50 5f 48 b9 e0 d9 24 c6 f7 7f 00 00 48 89 4f 18 48 b9 40 67 39 c6 f7 7f 00 00 48 89 4f 20 48 8b cb 8b d6 4c 8b c7 48 b8 88 76 99 c6 f7 7f 00 00 39 09 48 83 c4 20 5b 5e 5f 48 ff e0 00 00 19 07 04 00 07 32 03 30 02 60 01 70 40}
; TermCode = ZEDx7_000
...
0009h mov rcx,7ff7c6ac76b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 76 ac c6 f7 7f 00 00}
0013h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f8 c5 50 5f}
...
002ah call 7ff825ea70b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e1 c9 50 5f}
002fh mov rdx,20be7566a88h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 88 6a 56 e7 0b 02 00 00}
...
0043h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 08 b7 50 5f}
...
0056h mov rcx,7ff7c6396740h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 40 67 39 c6 f7 7f 00 00}
