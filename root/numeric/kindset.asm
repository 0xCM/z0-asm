...
; kindset_(NumericKind~32u)[145] = {57 56 53 48 83 ec 20 8b f1 48 b9 48 ce de c7 f7 7f 00 00 e8 98 61 55 5f 48 8b f8 48 b9 48 f7 8c c7 f7 7f 00 00 ba 3c 00 00 00 e8 81 65 55 5f 48 ba d0 69 4e 76 9e 01 00 00 48 8b 1a 48 8d 4f 08 48 8b d7 e8 a8 52 55 5f 48 b9 70 dc 61 c7 f7 7f 00 00 48 89 4f 18 48 b9 50 36 76 c7 f7 7f 00 00 48 89 4f 20 48 8b cb 8b d6 4c 8b c7 48 b8 f0 db d0 c7 f7 7f 00 00 39 09 48 83 c4 20 5b 5e 5f 48 ff e0 00 00 19 07 04 00 07 32 03 30 02 60 01 70 40}
; TermCode = CTC_Zx7
...
0009h mov rcx,7ff7c7dece48h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 48 ce de c7 f7 7f 00 00}
0013h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 98 61 55 5f}
...
002ah call 7ff8272670b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 81 65 55 5f}
002fh mov rdx,19e764e69d0h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba d0 69 4e 76 9e 01 00 00}
...
0043h call 7ff827265df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a8 52 55 5f}
...
0056h mov rcx,7ff7c7763650h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 50 36 76 c7 f7 7f 00 00}
