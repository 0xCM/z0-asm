...
; type_(NumericKind~32u)[71] = {57 56 48 83 ec 28 8b f1 81 fe 20 00 00 42 77 6c 81 fe 10 00 04 20 77 2f 81 fe 08 00 01 20 0f 84 b9 00 00 00 81 fe 10 00 04 20 0f 85 25 01 00 00 48 b9 38 87 72 c7 f7 7f 00 00 e8 a1 2e 4b 5f 90 48 83 c4 28 5e 5f c3}
...
003ah call 7ff82720eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a1 2e 4b 5f}
