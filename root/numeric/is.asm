...
; is_NumericKind~32u_NumericKind~32u[111] = {57 56 55 53 48 83 ec 28 8b f1 8b fa 48 b9 b0 75 ad c6 f7 7f 00 00 e8 65 cc 4f 5f 48 8b d8 48 b9 48 8b 4d c6 f7 7f 00 00 ba 33 00 00 00 e8 4e d0 4f 5f 48 ba 88 6a cf df 23 02 00 00 48 8b 2a 48 8d 4b 08 48 8b d3 e8 75 bd 4f 5f 48 b9 10 da 25 c6 f7 7f 00 00 48 89 4b 18 48 b9 30 57 7b c6 f7 7f 00 00 48 89 4b 20 48 8b cd 8b d6 4c 8b c3}
...
000ch mov rcx,7ff7c6ad75b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 75 ad c6 f7 7f 00 00}
0016h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 65 cc 4f 5f}
...
002dh call 7ff825ea70b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4e d0 4f 5f}
0032h mov rdx,223dfcf6a88h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 88 6a cf df 23 02 00 00}
...
0046h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 75 bd 4f 5f}
004bh mov rcx,7ff7c625da10h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 da 25 c6 f7 7f 00 00}
