...
; kind_[155] = {56 48 83 ec 20 48 8b f1 48 8b ce 48 8b 06 48 8b 40 70 ff 50 30 85 c0 74 04 33 c0 eb 78 48 8b ce e8 3b d2 ff ff 48 8b c8 e8 63 d2 76 4f 83 c0 fb 83 f8 09 77 5e 8b c0 48 8d 15 62 00 00 00 8b 14 82 48 8d 0d c0 ff ff ff 48 03 d1 ff e2 b8 08 00 01 20 eb 41 b8 08 00 02 80 eb 3a b8 10 00 08 80 eb 33 b8 10 00 04 20 eb 2c b8 20 00 20 80 eb 25 b8 20 00 10 20 eb 1e b8 40 00 80 80 eb 17 b8 40 00 40 20 eb 10 b8 20 00 00 42 eb 09 b8 40 00 00 44 eb 02 33 c0 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
...
0020h call 7ff7c67bbf50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3b d2 ff ff}
0025h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0028h call 7ff815f2bf80h                      ; CALL rel32 || E8 cd || encoded[5]{e8 63 d2 76 4f}
