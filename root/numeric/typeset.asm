...
; typeset_NumericKind~32u[125] = {57 56 53 48 83 ec 20 8b f1 48 b9 d8 a0 f2 c7 f7 7f 00 00 e8 98 5f 3d 5f 48 8b f8 48 ba 50 6a 1f d3 5d 02 00 00 48 8b 1a 48 8d 4f 08 48 8b d7 e8 bc 50 3d 5f 48 b9 60 dd 62 c7 f7 7f 00 00 48 89 4f 18 48 b9 40 2d 77 c7 f7 7f 00 00 48 89 4f 20 48 8b cb 8b d6 4c 8b c7 48 b8 80 7a d3 c7 f7 7f 00 00 39 09 48 83 c4 20 5b 5e 5f 48 ff e0 00 00 19 07 04 00 07 32 03 30 02 60 01 70 40}
; TermCode = CTC_Zx7
...
0009h mov rcx,7ff7c7f2a0d8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 d8 a0 f2 c7 f7 7f 00 00}
0013h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 98 5f 3d 5f}
0018h mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
001bh mov rdx,25dd31f6a50h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 50 6a 1f d3 5d 02 00 00}
...
002fh call 7ff827265df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bc 50 3d 5f}
...
0042h mov rcx,7ff7c7772d40h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 40 2d 77 c7 f7 7f 00 00}
