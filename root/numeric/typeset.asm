...
; typeset_NumericKind~32u[145] = {57 56 53 48 83 ec 20 8b f1 48 b9 b8 82 ea c7 f7 7f 00 00 e8 d8 c0 50 5f 48 8b f8 48 b9 60 84 8b c7 f7 7f 00 00 ba 33 00 00 00 e8 c1 c4 50 5f 48 ba 00 6a 25 75 85 01 00 00 48 8b 1a 48 8d 4f 08 48 8b d7 e8 e8 b1 50 5f 48 b9 70 da 63 c7 f7 7f 00 00 48 89 4f 18 48 b9 48 5a b9 c7 f7 7f 00 00 48 89 4f 20 48 8b cb 8b d6 4c 8b c7 48 b8 50 a6 d5 c7 f7 7f 00 00 39 09 48 83 c4 20 5b 5e 5f 48 ff e0 00 00 19 07 04 00 07 32 03 30 02 60 01 70 40}
...
0009h mov rcx,7ff7c7ea82b8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b8 82 ea c7 f7 7f 00 00}
0013h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d8 c0 50 5f}
...
002ah call 7ff8272670b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c1 c4 50 5f}
002fh mov rdx,18575256a00h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 00 6a 25 75 85 01 00 00}
...
0043h call 7ff827265df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e8 b1 50 5f}
...
0056h mov rcx,7ff7c7b95a48h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 48 5a b9 c7 f7 7f 00 00}
