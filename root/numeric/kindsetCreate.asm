...
; kindsetCreate_NumericKind~32u[287] = {57 56 48 83 ec 28 8b f1 48 b9 e8 a4 90 c6 f7 7f 00 00 e8 59 c4 4f 5f 48 8b f8 48 b9 20 00 35 c6 f7 7f 00 00 ba 4f 00 00 00 e8 32 73 4c 5f 48 ba e0 2e 9e 20 da 01 00 00 48 8b 12 48 8b cf e8 05 6f e1 ff f7 c6 00 00 01 00 74 0d 48 8b cf ba 08 00 01 20 e8 38 70 e1 ff f7 c6 00 00 02 00 74 0d 48 8b cf ba 08 00 02 80 e8 23 70 e1 ff f7 c6 00 00 04 00 74 0d 48 8b cf ba 10 00 04 20 e8 0e 70 e1 ff f7 c6 00 00 08 00 74 0d 48 8b cf ba 10 00 08 80 e8 f9 6f e1 ff f7 c6 00 00 10 00 74 0d 48 8b cf ba 20 00 10 20 e8 e4 6f e1 ff f7 c6 00 00 20 00 74 0d 48 8b cf ba 20 00 20 80 e8 cf 6f e1 ff f7 c6 00 00 40 00 74 0d 48 8b cf ba 40 00 40 20 e8 ba 6f e1 ff f7 c6 00 00 80 00 74 0d 48 8b cf ba 40 00 80 80 e8 a5 6f e1 ff f7 c6 00 00 00 02 74 0d 48 8b cf ba 20 00 00 42 e8 90 6f e1 ff f7 c6 00 00 00 04 74 0d 48 8b cf ba 40 00 00 44 e8 7b 6f e1 ff 48 8b c7 48 83 c4 28 5e 5f c3}
...
0012h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 59 c4 4f 5f}
...
0029h call 7ff825e71ba0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 32 73 4c 5f}
002eh mov rdx,1da209e2ee0h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba e0 2e 9e 20 da 01 00 00}
...
003eh call 7ff7c67c1788h                      ; CALL rel32 || E8 cd || encoded[5]{e8 05 6f e1 ff}
...
0053h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 38 70 e1 ff}
...
0068h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 23 70 e1 ff}
...
007dh call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0e 70 e1 ff}
...
0092h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f9 6f e1 ff}
...
00a7h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e4 6f e1 ff}
...
00bch call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cf 6f e1 ff}
...
00d1h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ba 6f e1 ff}
...
00e6h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a5 6f e1 ff}
...
00fbh call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 6f e1 ff}
...
0110h call 7ff7c67c18d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7b 6f e1 ff}
