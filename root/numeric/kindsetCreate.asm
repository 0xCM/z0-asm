...
; kindsetCreate_NumericKind~32u[287] = {57 56 48 83 ec 28 8b f1 48 b9 98 99 cd c7 f7 7f 00 00 e8 49 c0 4e 5f 48 8b f8 48 b9 20 00 72 c7 f7 7f 00 00 ba 4f 00 00 00 e8 22 6f 4b 5f 48 ba e0 2e a2 f6 3a 02 00 00 48 8b 12 48 8b cf e8 7d 6b e1 ff f7 c6 00 00 01 00 74 0d 48 8b cf ba 08 00 01 20 e8 b0 6c e1 ff f7 c6 00 00 02 00 74 0d 48 8b cf ba 08 00 02 80 e8 9b 6c e1 ff f7 c6 00 00 04 00 74 0d 48 8b cf ba 10 00 04 20 e8 86 6c e1 ff f7 c6 00 00 08 00 74 0d 48 8b cf ba 10 00 08 80 e8 71 6c e1 ff f7 c6 00 00 10 00 74 0d 48 8b cf ba 20 00 10 20 e8 5c 6c e1 ff f7 c6 00 00 20 00 74 0d 48 8b cf ba 20 00 20 80 e8 47 6c e1 ff f7 c6 00 00 40 00 74 0d 48 8b cf ba 40 00 40 20 e8 32 6c e1 ff f7 c6 00 00 80 00 74 0d 48 8b cf ba 40 00 80 80 e8 1d 6c e1 ff f7 c6 00 00 00 02 74 0d 48 8b cf ba 20 00 00 42 e8 08 6c e1 ff f7 c6 00 00 00 04 74 0d 48 8b cf ba 40 00 00 44 e8 f3 6b e1 ff 48 8b c7 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0006h mov esi,ecx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f1}
0008h mov rcx,7ff7c7cd9998h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 98 99 cd c7 f7 7f 00 00}
0012h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 49 c0 4e 5f}
...
0029h call 7ff827231ba0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 22 6f 4b 5f}
002eh mov rdx,23af6a22ee0h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba e0 2e a2 f6 3a 02 00 00}
...
003eh call 7ff7c7b91810h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7d 6b e1 ff}
...
0053h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b0 6c e1 ff}
...
0068h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9b 6c e1 ff}
...
007dh call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 86 6c e1 ff}
...
0092h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 71 6c e1 ff}
...
00a7h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c 6c e1 ff}
...
00bch call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 47 6c e1 ff}
...
00d1h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 32 6c e1 ff}
...
00e6h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d 6c e1 ff}
...
00fbh call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 08 6c e1 ff}
...
0110h call 7ff7c7b91958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f3 6b e1 ff}
