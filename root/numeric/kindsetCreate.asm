...
; kindsetCreate_(NumericKind~32u)[287] = {57 56 48 83 ec 28 8b f1 48 b9 e8 71 dc c7 f7 7f 00 00 e8 f9 5a 55 5f 48 8b f8 48 b9 20 00 71 c7 f7 7f 00 00 ba 4e 00 00 00 e8 d2 09 52 5f 48 ba a8 2f 31 98 37 02 00 00 48 8b 12 48 8b cf e8 65 07 fe ff f7 c6 00 00 01 00 74 0d 48 8b cf ba 08 00 01 20 e8 98 08 fe ff f7 c6 00 00 02 00 74 0d 48 8b cf ba 08 00 02 80 e8 83 08 fe ff f7 c6 00 00 04 00 74 0d 48 8b cf ba 10 00 04 20 e8 6e 08 fe ff f7 c6 00 00 08 00 74 0d 48 8b cf ba 10 00 08 80 e8 59 08 fe ff f7 c6 00 00 10 00 74 0d 48 8b cf ba 20 00 10 20 e8 44 08 fe ff f7 c6 00 00 20 00 74 0d 48 8b cf ba 20 00 20 80 e8 2f 08 fe ff f7 c6 00 00 40 00 74 0d 48 8b cf ba 40 00 40 20 e8 1a 08 fe ff f7 c6 00 00 80 00 74 0d 48 8b cf ba 40 00 80 80 e8 05 08 fe ff f7 c6 00 00 00 02 74 0d 48 8b cf ba 20 00 00 42 e8 f0 07 fe ff f7 c6 00 00 00 04 74 0d 48 8b cf ba 40 00 00 44 e8 db 07 fe ff 48 8b c7 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0006h mov esi,ecx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f1}
0008h mov rcx,7ff7c7dc71e8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e8 71 dc c7 f7 7f 00 00}
0012h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f9 5a 55 5f}
0017h mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
001ah mov rcx,7ff7c7710020h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 20 00 71 c7 f7 7f 00 00}
0024h mov edx,4eh                             ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 4e 00 00 00}
0029h call 7ff827231ba0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d2 09 52 5f}
002eh mov rdx,23798312fa8h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba a8 2f 31 98 37 02 00 00}
...
003eh call 7ff7c7cf1948h                      ; CALL rel32 || E8 cd || encoded[5]{e8 65 07 fe ff}
...
0053h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 98 08 fe ff}
...
0068h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 83 08 fe ff}
...
007dh call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6e 08 fe ff}
...
0092h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 59 08 fe ff}
...
00a7h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 44 08 fe ff}
...
00bch call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2f 08 fe ff}
...
00d1h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1a 08 fe ff}
...
00e6h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 05 08 fe ff}
...
00fbh call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f0 07 fe ff}
...
0110h call 7ff7c7cf1a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 db 07 fe ff}
