...
; vincrements~n256_g64x64u[7ff7c724aba0h, 7ff7c724abbeh][30] = {c5 f8 77 66 90 48 b8 99 56 ab ba cf 01 00 00 c5 ff f0 00 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:11:18:208
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1cfbaab5699h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 99 56 ab ba cf 01 00 00}
