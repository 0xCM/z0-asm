...
; vdecrements~n256_g64x64i[7ff7c6fddda0h, 7ff7c6fdddbeh][30] = {c5 f8 77 66 90 48 b8 b9 57 2c e0 fe 01 00 00 c5 ff f0 00 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code, RET_INTR
; 2020-01-24 18:45:16:255
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1fee02c57b9h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 b9 57 2c e0 fe 01 00 00}
