...
; vunits~n128_g8x8u[27] = {c5 f8 77 66 90 48 b8 59 57 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
...
; vunits~n128_g8x8i[27] = {c5 f8 77 66 90 48 b8 59 57 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5759h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 59 57 0e eb e6 01 00 00}
...
; vunits~n128_g16x16u[27] = {c5 f8 77 66 90 48 b8 59 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vunits~n128_g16x16i[27] = {c5 f8 77 66 90 48 b8 59 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5459h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 59 54 0e eb e6 01 00 00}
...
; vunits~n128_g32x32u[27] = {c5 f8 77 66 90 48 b8 29 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vunits~n128_g32x32i[27] = {c5 f8 77 66 90 48 b8 29 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5429h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 29 54 0e eb e6 01 00 00}
...
; vunits~n128_g64x64u[27] = {c5 f8 77 66 90 48 b8 19 56 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vunits~n128_g64x64i[27] = {c5 f8 77 66 90 48 b8 19 56 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5619h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 19 56 0e eb e6 01 00 00}
