...
; vconvert~2x8u~2x64i~vconvert[7ff7c6bd9e80h, 7ff7c6bd9e9eh][30] = {c5 f8 77 66 90 48 8b 02 41 d1 e0 49 63 d0 48 03 c2 c4 e2 79 32 00 c5 f9 11 01 48 8b c1 c3}
; Capture completion code, RET_INTR
; 2020-01-24 18:44:59:215
