...
; vshuf32x8_256x8u[90] = {c5 f8 77 66 90 48 b8 05 84 8a e4 17 02 00 00 c5 ff f0 00 c4 c1 7d 10 08 c5 f5 fc c0 c5 fd 10 0a c4 e2 75 00 c0 c5 fd 10 0a c4 e3 75 46 c9 03 48 b8 35 82 8a e4 17 02 00 00 c5 ff f0 10 c4 c1 7d 10 18 c5 e5 fc d2 c4 e2 75 00 ca c5 fd eb c1 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,217e48a8405h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 05 84 8a e4 17 02 00 00}
...
002fh mov rax,217e48a8235h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 35 82 8a e4 17 02 00 00}
