; Vector128<Int16> vswaphl(Vector128<Int16> x)
; vswaphl_128x16i[7ff7c6be78c0h, 7ff7c6be78d6h][22] = {c5 f8 77 66 90 c5 f9 10 02 c5 f9 70 c0 4e c5 f9 11 01 48 8b c1 c3}
; Capture completion code, RET_INTR
; 2020-01-24 18:45:01:003
