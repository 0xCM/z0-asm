...
; vbyteswap_128x32u[7ff7c71dfb40h, 7ff7c71dfb64h][36] = {c5 f8 77 66 90 48 b8 a9 54 ab ba cf 01 00 00 c5 fb f0 00 c5 f9 10 0a c4 e2 71 00 c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:11:04:325
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1cfbaab54a9h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 a9 54 ab ba cf 01 00 00}
