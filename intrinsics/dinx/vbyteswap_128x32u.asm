...
; vbyteswap_128x32u[7ff7c6beb4a0h, 7ff7c6beb4c4h][36] = {c5 f8 77 66 90 48 b8 a9 54 2c e0 fe 01 00 00 c5 fb f0 00 c5 f9 10 0a c4 e2 71 00 c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code, RET_INTR
; 2020-01-24 18:45:01:959
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1fee02c54a9h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 a9 54 2c e0 fe 01 00 00}
