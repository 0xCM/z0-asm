...
; vinc_v128x8i[35] = {c5 f8 77 66 90 48 b8 ad 57 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fc c0 c5 f9 11 01 48 8b c1 c3}
...
; vinc_v128x8u[35] = {c5 f8 77 66 90 48 b8 ad 57 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fc c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e6557adh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 ad 57 65 6e a2 01 00 00}
...
; vinc_v128x16i[35] = {c5 f8 77 66 90 48 b8 ad 54 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fd c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v128x16u[35] = {c5 f8 77 66 90 48 b8 ad 54 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fd c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e6554adh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 ad 54 65 6e a2 01 00 00}
...
; vinc_v128x32i[35] = {c5 f8 77 66 90 48 b8 7d 54 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fe c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v128x32u[35] = {c5 f8 77 66 90 48 b8 7d 54 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fe c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e65547dh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 7d 54 65 6e a2 01 00 00}
...
; vinc_v128x64i[35] = {c5 f8 77 66 90 48 b8 6d 56 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 d4 c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v128x64u[35] = {c5 f8 77 66 90 48 b8 6d 56 65 6e a2 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 d4 c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e65566dh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 6d 56 65 6e a2 01 00 00}
...
; vinc_v256x8i[38] = {c5 f8 77 66 90 48 b8 3d 56 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fc c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v256x8u[38] = {c5 f8 77 66 90 48 b8 3d 56 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fc c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e65563dh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 3d 56 65 6e a2 01 00 00}
...
; vinc_v256x16i[38] = {c5 f8 77 66 90 48 b8 bd 54 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fd c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v256x16u[38] = {c5 f8 77 66 90 48 b8 bd 54 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fd c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e6554bdh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 bd 54 65 6e a2 01 00 00}
...
; vinc_v256x32i[38] = {c5 f8 77 66 90 48 b8 5d 54 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fe c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v256x32u[38] = {c5 f8 77 66 90 48 b8 5d 54 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fe c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e65545dh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 5d 54 65 6e a2 01 00 00}
...
; vinc_v256x64i[38] = {c5 f8 77 66 90 48 b8 8d 55 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 d4 c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_v256x64u[38] = {c5 f8 77 66 90 48 b8 8d 55 65 6e a2 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 d4 c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1a26e65558dh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 8d 55 65 6e a2 01 00 00}
