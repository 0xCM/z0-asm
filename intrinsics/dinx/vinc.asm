...
; vinc_128x8i[35] = {c5 f8 77 66 90 48 b8 59 57 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fc c0 c5 f9 11 01 48 8b c1 c3}
...
; vinc_128x8u[35] = {c5 f8 77 66 90 48 b8 59 57 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fc c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5759h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 59 57 0e eb e6 01 00 00}
...
; vinc_128x16i[35] = {c5 f8 77 66 90 48 b8 59 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fd c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_128x16u[35] = {c5 f8 77 66 90 48 b8 59 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fd c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5459h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 59 54 0e eb e6 01 00 00}
...
; vinc_128x32i[35] = {c5 f8 77 66 90 48 b8 29 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fe c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_128x32u[35] = {c5 f8 77 66 90 48 b8 29 54 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 fe c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5429h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 29 54 0e eb e6 01 00 00}
...
; vinc_128x64i[35] = {c5 f8 77 66 90 48 b8 19 56 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 d4 c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_128x64u[35] = {c5 f8 77 66 90 48 b8 19 56 0e eb e6 01 00 00 c5 fb f0 00 c5 f9 10 0a c5 f1 d4 c0 c5 f9 11 01 48 8b c1 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5619h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 19 56 0e eb e6 01 00 00}
...
; vinc_256x8i[38] = {c5 f8 77 66 90 48 b8 e9 55 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fc c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_256x8u[38] = {c5 f8 77 66 90 48 b8 e9 55 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fc c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e55e9h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 e9 55 0e eb e6 01 00 00}
...
; vinc_256x16i[38] = {c5 f8 77 66 90 48 b8 69 54 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fd c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_256x16u[38] = {c5 f8 77 66 90 48 b8 69 54 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fd c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5469h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 69 54 0e eb e6 01 00 00}
...
; vinc_256x32i[38] = {c5 f8 77 66 90 48 b8 09 54 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fe c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_256x32u[38] = {c5 f8 77 66 90 48 b8 09 54 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 fe c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5409h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 09 54 0e eb e6 01 00 00}
...
; vinc_256x64i[38] = {c5 f8 77 66 90 48 b8 39 55 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 d4 c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; vinc_256x64u[38] = {c5 f8 77 66 90 48 b8 39 55 0e eb e6 01 00 00 c5 ff f0 00 c5 fd 10 0a c5 f5 d4 c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,1e6eb0e5539h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 39 55 0e eb e6 01 00 00}
