------------------------------------------------------------------------------------------------------------------------
; vrotrx_(v128x64u,8u)-imm5
; vrotrx_(v128x64u,8u)-imm5[63] = {c5 f8 77 c5 f9 10 02 c5 f8 28 c8 c5 e9 73 d1 05 c5 f1 73 d9 08 b8 3b 00 00 00 c5 f9 6e d8 c5 f1 f3 cb c5 e9 eb c9 c5 f9 73 f8 08 c5 f9 6e d0 c5 f9 f3 c2 c5 f1 eb c0 c5 f9 11 01 48 8b c1 c3}
...
------------------------------------------------------------------------------------------------------------------------
; vrotrx_(v128x64u,8u)-imm9
; vrotrx_(v128x64u,8u)-imm9[63] = {c5 f8 77 c5 f9 10 02 c5 f8 28 c8 c5 e9 73 d1 09 c5 f1 73 d9 08 b8 37 00 00 00 c5 f9 6e d8 c5 f1 f3 cb c5 e9 eb c9 c5 f9 73 f8 08 c5 f9 6e d0 c5 f9 f3 c2 c5 f1 eb c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovaps xmm1,xmm0                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 c8}
...
003eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; vrotrx_(v128x64u,8u)-imm13
; vrotrx_(v128x64u,8u)-imm13[63] = {c5 f8 77 c5 f9 10 02 c5 f8 28 c8 c5 e9 73 d1 0d c5 f1 73 d9 08 b8 33 00 00 00 c5 f9 6e d8 c5 f1 f3 cb c5 e9 eb c9 c5 f9 73 f8 08 c5 f9 6e d0 c5 f9 f3 c2 c5 f1 eb c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovaps xmm1,xmm0                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 c8}
...
003eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; vrotrx_(v256x64u,8u)-imm5
; vrotrx_(v256x64u,8u)-imm5[66] = {c5 f8 77 c5 fd 10 02 c5 fc 28 c8 c5 ed 73 d1 05 c5 f5 73 d9 08 b8 3b 00 00 00 c5 f9 6e d8 c5 f5 f3 cb c5 ed eb c9 c5 fd 73 f8 08 c5 f9 6e d0 c5 fd f3 c2 c5 f5 eb c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
------------------------------------------------------------------------------------------------------------------------
; vrotrx_(v256x64u,8u)-imm9
; vrotrx_(v256x64u,8u)-imm9[66] = {c5 f8 77 c5 fd 10 02 c5 fc 28 c8 c5 ed 73 d1 09 c5 f5 73 d9 08 b8 37 00 00 00 c5 f9 6e d8 c5 f5 f3 cb c5 ed eb c9 c5 fd 73 f8 08 c5 f9 6e d0 c5 fd f3 c2 c5 f5 eb c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovaps ymm1,ymm0                       ; VMOVAPS ymm1, ymm2/m256 || VEX.256.0F.WIG 28 /r || encoded[4]{c5 fc 28 c8}
...
0041h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; vrotrx_(v256x64u,8u)-imm13
; vrotrx_(v256x64u,8u)-imm13[66] = {c5 f8 77 c5 fd 10 02 c5 fc 28 c8 c5 ed 73 d1 0d c5 f5 73 d9 08 b8 33 00 00 00 c5 f9 6e d8 c5 f5 f3 cb c5 ed eb c9 c5 fd 73 f8 08 c5 f9 6e d0 c5 fd f3 c2 c5 f5 eb c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovaps ymm1,ymm0                       ; VMOVAPS ymm1, ymm2/m256 || VEX.256.0F.WIG 28 /r || encoded[4]{c5 fc 28 c8}
