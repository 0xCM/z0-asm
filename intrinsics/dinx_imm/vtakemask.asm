------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[31] = {c5 f8 77 c5 f9 10 02 b8 02 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[31] = {c5 f8 77 c5 f9 10 02 b8 fe 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[31] = {c5 f8 77 c5 f9 10 02 b8 fa 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[33] = {c5 f8 77 c5 fd 10 02 b8 02 00 00 00 c5 f9 6e c8 c5 fd f3 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[33] = {c5 f8 77 c5 fd 10 02 b8 fe 00 00 00 c5 f9 6e c8 c5 fd f3 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h mov eax,0feh                            ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 fe 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[33] = {c5 f8 77 c5 fd 10 02 b8 fa 00 00 00 c5 f9 6e c8 c5 fd f3 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h mov eax,0fah                            ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 fa 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[33] = {c5 f8 77 c5 fd 10 02 b8 02 00 00 00 c5 f9 6e c8 c5 fd f2 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h mov eax,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 02 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[33] = {c5 f8 77 c5 fd 10 02 b8 fe 00 00 00 c5 f9 6e c8 c5 fd f2 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h mov eax,0feh                            ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 fe 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[33] = {c5 f8 77 c5 fd 10 02 b8 fa 00 00 00 c5 f9 6e c8 c5 fd f2 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h mov eax,0fah                            ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 fa 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[41] = {c5 f8 77 c5 f9 10 02 c4 c1 79 10 08 c4 e2 79 47 c1 b8 02 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[41] = {c5 f8 77 c5 f9 10 02 c4 c1 79 10 08 c4 e2 79 47 c1 b8 fe 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovupd xmm1,[r8]                       ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[5]{c4 c1 79 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[41] = {c5 f8 77 c5 f9 10 02 c4 c1 79 10 08 c4 e2 79 47 c1 b8 fa 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovupd xmm1,[r8]                       ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[5]{c4 c1 79 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[41] = {c5 f8 77 c5 f9 10 02 c4 c1 79 10 08 c4 e2 f9 47 c1 b8 02 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovupd xmm1,[r8]                       ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[5]{c4 c1 79 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[41] = {c5 f8 77 c5 f9 10 02 c4 c1 79 10 08 c4 e2 f9 47 c1 b8 fe 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovupd xmm1,[r8]                       ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[5]{c4 c1 79 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[41] = {c5 f8 77 c5 f9 10 02 c4 c1 79 10 08 c4 e2 f9 47 c1 b8 fa 00 00 00 c5 f9 6e c8 c5 f9 f3 c1 c5 f9 d7 c0 66 89 01 48 8b c1 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0007h vmovupd xmm1,[r8]                       ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[5]{c4 c1 79 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[43] = {c5 f8 77 c5 fd 10 02 c4 c1 7d 10 08 c4 e2 7d 47 c1 b8 02 00 00 00 c5 f9 6e c8 c5 fd f2 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[43] = {c5 f8 77 c5 fd 10 02 c4 c1 7d 10 08 c4 e2 7d 47 c1 b8 fe 00 00 00 c5 f9 6e c8 c5 fd f2 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[43] = {c5 f8 77 c5 fd 10 02 c4 c1 7d 10 08 c4 e2 7d 47 c1 b8 fa 00 00 00 c5 f9 6e c8 c5 fd f2 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm5
; vtakemask-imm5[43] = {c5 f8 77 c5 fd 10 02 c4 c1 7d 10 08 c4 e2 fd 47 c1 b8 02 00 00 00 c5 f9 6e c8 c5 fd f3 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm9
; vtakemask-imm9[43] = {c5 f8 77 c5 fd 10 02 c4 c1 7d 10 08 c4 e2 fd 47 c1 b8 fe 00 00 00 c5 f9 6e c8 c5 fd f3 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
...
------------------------------------------------------------------------------------------------------------------------
; vtakemask-imm13
; vtakemask-imm13[43] = {c5 f8 77 c5 fd 10 02 c4 c1 7d 10 08 c4 e2 fd 47 c1 b8 fa 00 00 00 c5 f9 6e c8 c5 fd f3 c1 c5 fd d7 c0 89 01 48 8b c1 c5 f8 77 c3}
; TermCode = RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0007h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
