...
; vinc_g256x16i[7ff7c7216130h, 7ff7c7216156h][38] = {c5 f8 77 66 90 c5 fd 10 02 48 b8 69 54 ab ba cf 01 00 00 c5 ff f0 08 c5 fd fd c1 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:11:12:280
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0009h mov rax,1cfbaab5469h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 69 54 ab ba cf 01 00 00}
