...
; vshuf32x8__256x16i[7ff7c6dc1700h, 7ff7c6dc1751h][81] = {c5 f8 77 66 90 c5 fd 10 02 c4 c1 7d 10 08 48 b8 09 7b 99 f8 fe 01 00 00 c5 ff f0 10 c5 f5 fc d2 c4 e2 7d 00 d2 c4 e3 7d 46 c0 03 48 b8 39 79 99 f8 fe 01 00 00 c5 ff f0 18 c5 f5 fc cb c4 e2 7d 00 c1 c5 ed eb c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code, RET_INTR
; 2020-01-24 18:45:07:954
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0009h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
000eh mov rax,1fef8997b09h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 09 7b 99 f8 fe 01 00 00}
...
002bh mov rax,1fef8997939h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 39 79 99 f8 fe 01 00 00}
