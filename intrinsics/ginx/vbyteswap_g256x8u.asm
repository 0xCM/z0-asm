; Vector256<byte> vbyteswap<byte>(Vector256<byte> x)
; vbyteswap_g256x8u[7ff7c7212260h, 7ff7c7212274h][20] = {c5 f8 77 66 90 c5 fd 10 02 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:11:11:864
