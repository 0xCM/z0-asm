...
; vbyteswap_g256x32u[7ff7c6dd2be0h, 7ff7c6dd2c07h][39] = {c5 f8 77 66 90 c5 fd 10 02 48 b8 79 57 2c e0 fe 01 00 00 c5 ff f0 08 c4 e2 7d 00 c1 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; Capture completion code, RET_INTR
; 2020-01-24 18:45:08:585
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0009h mov rax,1fee02c5779h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 79 57 2c e0 fe 01 00 00}
