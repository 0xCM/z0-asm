...
------------------------------------------------------------------------------------------------------------------------
; ref Block128<Int16> vmax<Int16>(in Block128<Int16> a, in Block128<Int16> b, in Block128<Int16> c)
; vmax_gb128x16i_128x16i_128x16i[100] = {c5 f8 77 66 90 45 8b 48 08 45 8b d1 41 c1 fa 1f 41 83 e2 07 45 03 ca 41 c1 f9 03 45 33 d2 45 85 c9 7e 3d 48 8b 01 48 8b 02 48 8b 01 45 8b da 41 c1 e3 03 4d 63 db 49 d1 e3 49 03 c3 c5 fb f0 00 48 8b 02 49 03 c3 c5 fb f0 08 c5 f9 ee c1 49 8b 00 49 03 c3 c5 fa 7f 00 41 ff c2 45 3b d1 7c c9 49 8b c0 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov r9d,[r8+8]                          ; MOV r32, r/m32 || o32 8B /r || encoded[4]{45 8b 48 08}
...
0065h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; ref Block128<ulong> vmax<ulong>(in Block128<ulong> a, in Block128<ulong> b, in Block128<ulong> c)
; vmax_gb128x64u_128x64u_128x64u[97] = {50 c5 f8 77 90 41 8b 40 08 44 8b c8 41 c1 e9 1f 41 03 c1 d1 f8 45 33 c9 85 c0 0f 8e 8d 00 00 00 4c 8b 11 45 8b d9 41 d1 e3 4d 63 db 49 c1 e3 03 4d 03 d3 c4 c1 7b f0 02 4c 8b 12 4d 03 d3 c4 c1 7b f0 0a c5 f8 28 d0 c5 f8 28 d9 c5 dc 57 e4 c4 e3 5d 38 d2 00 c5 dc 57 e4 c4 e3 5d 38 db 00 49 ba}
...
001ah jle near ptr 00adh                      ; JLE rel32 || 0F 8E cd || encoded[6]{0f 8e 8d 00 00 00}
...
004fh vinserti128 ymm2,ymm4,xmm2,0            ; VINSERTI128 ymm1, ymm2, xmm3/m128, imm8 || VEX.256.66.0F3A.W0 38 /r ib || encoded[6]{c4 e3 5d 38 d2 00}
0055h vxorps ymm4,ymm4,ymm4                   ; VXORPS ymm1, ymm2, ymm3/m256 || VEX.256.0F.WIG 57 /r || encoded[4]{c5 dc 57 e4}
0059h vinserti128 ymm3,ymm4,xmm3,0            ; VINSERTI128 ymm1, ymm2, xmm3/m128, imm8 || VEX.256.66.0F3A.W0 38 /r ib || encoded[6]{c4 e3 5d 38 db 00}
005fh (bad)                                   ; <invalid> || <invalid> || encoded[2]{49 ba}
------------------------------------------------------------------------------------------------------------------------
; ref Block128<long> vmax<long>(in Block128<long> a, in Block128<long> b, in Block128<long> c)
; vmax_gb128x64i_128x64i_128x64i[131] = {c5 f8 77 66 90 45 8b 48 08 45 8b d1 41 c1 ea 1f 45 03 ca 41 d1 f9 45 33 d2 45 85 c9 7e 5e 48 8b 01 48 8b 02 48 8b 01 45 8b da 41 d1 e3 4d 63 db 49 c1 e3 03 49 03 c3 c5 fb f0 00 48 8b 02 49 03 c3 c5 fb f0 08 c5 ec 57 d2 c4 e3 6d 38 c0 00 c5 ec 57 d2 c4 e3 6d 38 c9 00 c4 e2 7d 37 d1 c4 e3 75 4c c0 20 c4 e3 7d 19 c0 00 49 8b 00 49 03 c3 c5 fa 7f 00 41 ff c2 45 3b d1 7c a8 49 8b c0 c5 f8 77 c3}
; Capture completion code = RET_INTRx2
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov r9d,[r8+8]                          ; MOV r32, r/m32 || o32 8B /r || encoded[4]{45 8b 48 08}
