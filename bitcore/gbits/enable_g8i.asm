...
; enable_g8i[7ff7c6e84290h, 7ff7c6e842b3h][35] = {0f 1f 44 00 00 48 0f be c1 41 b8 01 00 00 00 8b ca 41 d3 e0 49 0f be d0 0b c2 48 0f be c0 48 0f be c0 c3}
; Capture completion code, RET_ZED_SBB
; 2020-01-24 01:44:34:199
