...
; stitch_g32u[7ff7c6e8b390h, 7ff7c6e8b3aeh][30] = {0f 1f 44 00 00 8b c1 8b ca d3 e0 41 83 e1 1f 41 8b c9 41 d3 e8 41 0b c0 41 8b c9 d3 e8 c3}
; Capture completion code, RET_ZEDx3
; 2020-01-25 02:10:53:215
