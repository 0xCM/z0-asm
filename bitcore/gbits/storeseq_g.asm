...
; storeseq_g0o_span0o_0o[43] = {0f 1f 44 00 00 48 8b 02 0f b6 d1 49 63 c8 48 03 c1 c1 e2 03 48 63 d2 48 b9 bd 20 cb ea e6 01 00 00 48 03 d1 48 8b 12 48 89 10 c3}
...
0017h mov rcx,1e6eacb20bdh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 bd 20 cb ea e6 01 00 00}
...
; storeseq_g0o_span0o_0o[79] = {0f 1f 44 00 00 48 8b 02 0f b7 d1 49 63 c8 48 03 c8 44 0f b6 ca 41 c1 e1 03 4d 63 c9 49 ba bd 20 cb ea e6 01 00 00 4d 03 ca 4d 8b 09 4c 89 09 41 83 c0 08 49 63 c8 48 03 c1 c1 fa 08 0f b6 d2 c1 e2 03 48 63 d2 49 03 d2 48 8b 12 48 89 10 c3}
; Capture completion code = RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
...
001ch mov r10,1e6eacb20bdh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 ba bd 20 cb ea e6 01 00 00}
...
; storeseq_g0o_span0o_0o[74] = {0f 1f 44 00 00 48 8b 02 8b d1 45 33 c9 41 8b c9 c1 e1 03 45 8d 14 08 4d 63 d2 4c 03 d0 44 8b da 41 d3 eb 41 0f b6 cb c1 e1 03 48 63 c9 49 bb bd 20 cb ea e6 01 00 00 49 03 cb 48 8b 09 49 89 0a 41 ff c1 41 83 f9 04 7c c4 c3}
...
002dh mov r11,1e6eacb20bdh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb bd 20 cb ea e6 01 00 00}
...
; storeseq_g0o_span0o_0o[75] = {0f 1f 44 00 00 48 8b 02 48 8b d1 45 33 c9 41 8b c9 c1 e1 03 45 8d 14 08 4d 63 d2 4c 03 d0 4c 8b da 49 d3 eb 41 0f b6 cb c1 e1 03 48 63 c9 49 bb bd 20 cb ea e6 01 00 00 49 03 cb 48 8b 09 49 89 0a 41 ff c1 41 83 f9 08 7c c4 c3}
; Capture completion code = RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
...
002eh mov r11,1e6eacb20bdh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb bd 20 cb ea e6 01 00 00}
