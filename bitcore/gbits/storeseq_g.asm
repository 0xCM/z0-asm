...
; storeseq_g[8u](8u)[89] = {57 56 48 83 ec 28 48 8b f1 8b fa 48 b9 10 ea 72 c7 f7 7f 00 00 ba 08 00 00 00 e8 f1 f2 c1 5e 48 8d 50 10 40 0f b6 cf c1 e1 03 48 63 c9 49 b8 91 02 5e 6f 4d 02 00 00 49 03 c8 48 8b 09 48 89 0a 48 83 c0 10 ba 08 00 00 00 48 89 06 89 56 08 48 8b c6 48 83 c4 28 5e 5f c3}
...
001ah call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f1 f2 c1 5e}
...
002dh mov r8,24d6f5e0291h                     ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 b8 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[16u](16u)[121] = {57 56 48 83 ec 28 48 8b f1 8b fa 48 b9 10 ea 72 c7 f7 7f 00 00 ba 10 00 00 00 e8 71 f2 c1 5e 48 8d 50 10 0f b7 cf 4c 8b c2 44 0f b6 c9 41 c1 e1 03 4d 63 c9 49 ba 91 02 5e 6f 4d 02 00 00 4d 03 ca 4d 8b 09 4d 89 08 48 83 c2 08 c1 f9 08 0f b6 c9 c1 e1 03 48 63 c9 49 03 ca 48 8b 09 48 89 0a 48 83 c0 10 ba 10 00 00 00 48 89 06 89 56 08 48 8b c6 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001ah call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 71 f2 c1 5e}
001fh lea rdx,[rax+10h]                       ; LEA r64, m || REX.W 8D /r || encoded[4]{48 8d 50 10}
...
0034h mov r10,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 ba 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[32u](32u)[119] = {57 56 48 83 ec 28 48 8b f1 8b fa 48 b9 10 ea 72 c7 f7 7f 00 00 ba 20 00 00 00 e8 d1 ed c1 5e 48 8d 50 10 45 33 c0 41 8b c8 c1 e1 03 4c 63 c9 4c 03 ca 44 8b d7 41 d3 ea 41 0f b6 ca c1 e1 03 48 63 c9 49 ba 91 02 5e 6f 4d 02 00 00 49 03 ca 48 8b 09 49 89 09 41 ff c0 41 83 f8 04 7c c8 48 83 c0 10 ba 20 00 00 00 48 89 06 89 56 08 48 8b c6 48 83 c4 28 5e 5f c3}
...
001ah call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d1 ed c1 5e}
001fh lea rdx,[rax+10h]                       ; LEA r64, m || REX.W 8D /r || encoded[4]{48 8d 50 10}
...
0042h mov r10,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 ba 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[64u](64u)[120] = {57 56 48 83 ec 28 48 8b f1 48 8b fa 48 b9 10 ea 72 c7 f7 7f 00 00 ba 40 00 00 00 e8 40 ed c1 5e 48 8d 50 10 45 33 c0 41 8b c8 c1 e1 03 4c 63 c9 4c 03 ca 4c 8b d7 49 d3 ea 41 0f b6 ca c1 e1 03 48 63 c9 49 ba 91 02 5e 6f 4d 02 00 00 49 03 ca 48 8b 09 49 89 09 41 ff c0 41 83 f8 08 7c c8 48 83 c0 10 ba 40 00 00 00 48 89 06 89 56 08 48 8b c6 48 83 c4 28 5e 5f c3}
...
001bh call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 40 ed c1 5e}
...
0043h mov r10,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 ba 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[8u](8u,span8u,32i)[43] = {0f 1f 44 00 00 48 8b 02 0f b6 d1 49 63 c8 48 03 c1 c1 e2 03 48 63 d2 48 b9 91 02 5e 6f 4d 02 00 00 48 03 d1 48 8b 12 48 89 10 c3}
; TermCode = CTC_RET_ZED_SBB
...
0017h mov rcx,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[16u](16u,span8u,32i)[79] = {0f 1f 44 00 00 48 8b 02 0f b7 d1 49 63 c8 48 03 c8 44 0f b6 ca 41 c1 e1 03 4d 63 c9 49 ba 91 02 5e 6f 4d 02 00 00 4d 03 ca 4d 8b 09 4c 89 09 41 83 c0 08 49 63 c8 48 03 c1 c1 fa 08 0f b6 d2 c1 e2 03 48 63 d2 49 03 d2 48 8b 12 48 89 10 c3}
; TermCode = CTC_RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
...
001ch mov r10,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 ba 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[32u](32u,span8u,32i)[74] = {0f 1f 44 00 00 48 8b 02 8b d1 45 33 c9 41 8b c9 c1 e1 03 45 8d 14 08 4d 63 d2 4c 03 d0 44 8b da 41 d3 eb 41 0f b6 cb c1 e1 03 48 63 c9 49 bb 91 02 5e 6f 4d 02 00 00 49 03 cb 48 8b 09 49 89 0a 41 ff c1 41 83 f9 04 7c c4 c3}
; TermCode = CTC_RET_Zx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
...
0027h shl ecx,3                               ; SHL r/m32, imm8 || o32 C1 /4 ib || encoded[3]{c1 e1 03}
002ah movsxd rcx,ecx                          ; MOVSXD r64, r/m32 || REX.W 63 /r || encoded[3]{48 63 c9}
002dh mov r11,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 91 02 5e 6f 4d 02 00 00}
...
; storeseq_g[64u](64u,span8u,32i)[75] = {0f 1f 44 00 00 48 8b 02 48 8b d1 45 33 c9 41 8b c9 c1 e1 03 45 8d 14 08 4d 63 d2 4c 03 d0 4c 8b da 49 d3 eb 41 0f b6 cb c1 e1 03 48 63 c9 49 bb 91 02 5e 6f 4d 02 00 00 49 03 cb 48 8b 09 49 89 0a 41 ff c1 41 83 f9 08 7c c4 c3}
; TermCode = CTC_RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
...
002eh mov r11,24d6f5e0291h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 91 02 5e 6f 4d 02 00 00}
