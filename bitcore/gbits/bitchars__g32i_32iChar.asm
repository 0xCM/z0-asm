...
; bitchars__g32i_32iChar[7ff7c6e91c00h, 7ff7c6e91d61h][353] = {41 57 41 56 41 55 41 54 57 56 55 53 48 83 ec 28 c5 f8 77 4c 89 84 24 80 00 00 00 48 8b f1 48 8b 3a 8b 5a 08 48 8d 94 24 80 00 00 00 40 0f b6 2a 44 8b 72 04 8b d3 c1 e2 05 48 63 d2 48 b9 d0 7f 4f c6 f7 7f 00 00 e8 95 51 01 5f 4c 8d 78 10 44 8b 60 08 45 33 ed 85 db 0f 8e a5 00 00 00 48 b9 d0 7f 4f c6 f7 7f 00 00 ba 20 00 00 00 e8 6e 51 01 5f 49 63 cd 44 8b 04 8f 48 8d 50 10 45 33 c9 41 8b c9 c1 e1 03 45 8b d0 41 d3 ea 41 0f b6 ca c1 e1 04 48 63 c9 49 ba 51 1c 45 ba cf 01 00 00 49 03 ca 45 8b d1 41 c1 e2 03 4d 63 d2 4e 8d 14 52 c5 fa 6f 01 c4 c1 7a 7f 02 41 ff c1 41 83 f9 04 7c bd 48 83 c0 10 41 b8 20 00 00 00 48 8b d0 41 8b cd c1 e1 05 41 3b cc 77 6e 41 8b c4 2b c1 48 63 c9 49 8d 0c 4f 44 3b c0 77 63 4d 63 c0 49 d1 e0 e8 59 72 03 4f 41 ff c5 44 3b eb 0f 8c 5b ff ff ff 40 84 ed 74 11 45 3b e6 0f 9d c0 0f b6 c0 40 0f b6 d5 85 c2 75 02 eb 13 40 84 ed 74 35 41 8b c6 41 8b d4 48 3b c2 77 30 45 8b e6 4c 89 3e 44 89 66 08 48 8b c6 48 83 c4 28 5b 5d 5e 5f 41 5c 41 5d 41 5e 41 5f c3 e8 ea 0c 51 ff cc e8 ec 0c 51 ff cc e8 0e 0e 51 ff cc e8 d8 0c 51 ff cc}
; Capture completion code, INTRx2
; 2020-01-25 02:10:53:499
...
0046h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 95 51 01 5f}
...
006dh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6e 51 01 5f}
...
00f2h call 7ff815ec8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 59 72 03 4f}
...
0149h call 7ff7c63a2a38h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ea 0c 51 ff}
014eh int 3                                   ; INT3 || CC || encoded[1]{cc}
014fh call 7ff7c63a2a40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec 0c 51 ff}
0154h int 3                                   ; INT3 || CC || encoded[1]{cc}
0155h call 7ff7c63a2b68h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0e 0e 51 ff}
015ah int 3                                   ; INT3 || CC || encoded[1]{cc}
015bh call 7ff7c63a2a38h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d8 0c 51 ff}
