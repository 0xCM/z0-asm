...
; bitchars__g8u_32iChar[7ff7c6e7ca60h, 7ff7c6e7cb99h][313] = {41 57 41 56 41 55 41 54 57 56 55 53 48 83 ec 28 c5 f8 77 4c 89 84 24 80 00 00 00 48 8b f1 48 8b 3a 8b 5a 08 48 8d 94 24 80 00 00 00 40 0f b6 2a 44 8b 72 04 8b d3 c1 e2 03 48 63 d2 48 b9 60 e0 4d c6 f7 7f 00 00 e8 35 a3 02 5f 4c 8d 78 10 44 8b 60 08 45 33 ed 85 db 0f 8e 7d 00 00 00 48 b9 60 e0 4d c6 f7 7f 00 00 ba 08 00 00 00 e8 0e a3 02 5f 4d 63 c5 46 0f b6 04 07 48 8d 48 10 45 0f b6 c0 41 c1 e0 04 4d 63 c0 48 ba ad 24 dc ed c8 01 00 00 4c 03 c2 c4 c1 7a 6f 00 c5 fa 7f 01 48 83 c0 10 41 b8 08 00 00 00 48 8b d0 41 8b cd c1 e1 03 41 3b cc 77 6a 41 8b c4 2b c1 48 63 c9 49 8d 0c 4f 44 3b c0 77 5f 4d 63 c0 49 d1 e0 e8 1d c4 04 4f 41 ff c5 44 3b eb 7c 83 40 84 ed 74 11 45 3b e6 0f 9d c0 0f b6 c0 40 0f b6 d5 85 c2 75 02 eb 13 40 84 ed 74 35 41 8b c6 41 8b d4 48 3b c2 77 30 45 8b e6 4c 89 3e 44 89 66 08 48 8b c6 48 83 c4 28 5b 5d 5e 5f 41 5c 41 5d 41 5e 41 5f c3 e8 b2 5e 51 ff cc e8 b4 5e 51 ff cc e8 d6 5f 51 ff cc e8 a0 5e 51 ff cc}
; Capture completion code, INTRx2
; 2020-01-24 01:44:33:957
...
0046h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 35 a3 02 5f}
...
006dh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0e a3 02 5f}
...
0089h mov rdx,1c8eddc24adh                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba ad 24 dc ed c8 01 00 00}
...
00ceh call 7ff815ec8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d c4 04 4f}
...
0121h call 7ff7c6392a38h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 5e 51 ff}
0126h int 3                                   ; INT3 || CC || encoded[1]{cc}
0127h call 7ff7c6392a40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b4 5e 51 ff}
012ch int 3                                   ; INT3 || CC || encoded[1]{cc}
012dh call 7ff7c6392b68h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d6 5f 51 ff}
0132h int 3                                   ; INT3 || CC || encoded[1]{cc}
0133h call 7ff7c6392a38h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a0 5e 51 ff}
