...
; bitslice_8i[7ff7c6e6fe50h, 7ff7c6e6fe72h][34] = {0f 1f 44 00 00 0f b6 c2 41 0f b6 d0 c1 e2 08 0b c2 0f b7 c0 48 0f be d1 c4 e2 78 f7 c2 48 0f be c0 c3}
; Capture completion code, RET_ZEDx3
; 2020-01-24 01:44:32:698
