...
; unpack8x1__0o8uVoid[7ff7c6e67610h, 7ff7c6e67641h][49] = {48 83 ec 28 90 48 8b 02 0f b6 d1 48 b9 01 01 01 01 01 01 01 01 c4 e2 eb f5 d1 48 89 10 48 83 c4 28 c3 e8 e9 85 16 5f cc 19 04 01 00 04 42 00 00 40}
; Capture completion code, ZEDx6
; 2020-01-24 01:44:31:598
...
0022h call 7ff825fcfc20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e9 85 16 5f}
