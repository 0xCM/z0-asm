...
; vcmpexpr256~eval_gVector256`1[227] = {57 56 48 81 ec a8 00 00 00 c5 f8 77 c5 f8 29 b4 24 90 00 00 00 c5 f8 29 bc 24 80 00 00 00 48 8b f1 48 8b ce 49 bb 10 11 28 c6 f7 7f 00 00 39 09 ff 15 0a 90 3d ff 8b f8 48 8b ce 49 bb 18 11 28 c6 f7 7f 00 00 39 09 ff 15 fb 8f 3d ff 48 8b c8 e8 1b c4 ff ff c5 fd 10 70 08 48 8b ce 49 bb 20 11 28 c6 f7 7f 00 00 c4 e3 7d 19 f7 01 39 09 ff 15 db 8f 3d ff 48 8b c8 e8 f3 c3 ff ff c5 fd 10 40 08 48 8d 4c 24 60 8b d7 c4 e3 4d 18 f7 01 c5 fd 11 74 24 40 c5 fd 11 44 24 20 4c 8d 44 24 40 4c 8d 4c 24 20 e8 d6 d9 e4 ff 48 b9 68 67 e9 c6 f7 7f 00 00 e8 27 eb ff 5e c5 fd 10 44 24 60 c5 fd 11 40 08 c5 f8 28 b4 24 90 00 00 00 c5 f8 28 bc 24 80 00 00 00 c5 f8 77 48 81 c4 a8 00 00 00 5e 5f c3}
...
0024h mov r11,7ff7c6281110h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 10 11 28 c6 f7 7f 00 00}
002eh cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0030h call qword ptr [rip-0c26ff6h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 0a 90 3d ff}
0036h mov edi,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f8}
0038h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003bh mov r11,7ff7c6281118h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 18 11 28 c6 f7 7f 00 00}
0045h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0047h call qword ptr [rip-0c27005h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 fb 8f 3d ff}
004dh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0050h call 7ff7c6ea4540h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1b c4 ff ff}
...
005dh mov r11,7ff7c6281120h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 20 11 28 c6 f7 7f 00 00}
...
006fh call qword ptr [rip-0c27025h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 db 8f 3d ff}
0075h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0078h call 7ff7c6ea4540h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f3 c3 ff ff}
...
00a5h call 7ff7c6cf5b50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d6 d9 e4 ff}
00aah mov rcx,7ff7c6e96768h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 68 67 e9 c6 f7 7f 00 00}
00b4h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 27 eb ff 5e}
