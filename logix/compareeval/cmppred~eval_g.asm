...
; cmppred~eval_g[137] = {57 56 53 48 83 ec 20 48 8b f1 48 8b ce 49 bb 48 12 25 c6 f7 7f 00 00 39 09 ff 15 99 df ed fe 8b f8 48 8b ce 49 bb 50 12 25 c6 f7 7f 00 00 39 09 ff 15 8a df ed fe 48 8b c8 e8 b2 cf ff ff 48 8b 58 08 48 8b ce 49 bb 58 12 25 c6 f7 7f 00 00 39 09 ff 15 71 df ed fe 48 8b c8 e8 91 cf ff ff 4c 8b 40 08 8b cf 48 8b d3 48 b8 a0 da 36 c7 f7 7f 00 00 48 83 c4 20 5b 5e 5f 48 ff e0 19 07 04 00 07 32 03 30 02 60 01 70 40}
...
000dh mov r11,7ff7c6251248h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 48 12 25 c6 f7 7f 00 00}
0017h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0019h call qword ptr [rip-1122067h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 99 df ed fe}
001fh mov edi,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f8}
0021h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
0024h mov r11,7ff7c6251250h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 50 12 25 c6 f7 7f 00 00}
002eh cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0030h call qword ptr [rip-1122076h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 8a df ed fe}
0036h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0039h call 7ff7c7370280h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 cf ff ff}
...
0045h mov r11,7ff7c6251258h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 58 12 25 c6 f7 7f 00 00}
004fh cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0051h call qword ptr [rip-112208fh]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 71 df ed fe}
0057h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
005ah call 7ff7c7370280h                      ; CALL rel32 || E8 cd || encoded[5]{e8 91 cf ff ff}
...
0068h mov rax,7ff7c736daa0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 a0 da 36 c7 f7 7f 00 00}
