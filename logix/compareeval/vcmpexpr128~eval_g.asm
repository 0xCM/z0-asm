...
; vcmpexpr128~eval_gVector128`1[182] = {57 56 48 83 ec 68 c5 f8 77 c5 f8 29 74 24 50 48 8b f1 48 8b ce 49 bb 60 12 25 c6 f7 7f 00 00 39 09 ff 15 09 df ed fe 8b f8 48 8b ce 49 bb 68 12 25 c6 f7 7f 00 00 39 09 ff 15 fa de ed fe 48 8b c8 e8 ba c4 ff ff c5 f9 10 70 08 48 8b ce 49 bb 70 12 25 c6 f7 7f 00 00 39 09 ff 15 e0 de ed fe 48 8b c8 e8 98 c4 ff ff c5 f9 10 40 08 48 8d 4c 24 40 8b d7 c5 f9 29 74 24 30 c5 f9 29 44 24 20 4c 8d 44 24 30 4c 8d 4c 24 20 e8 41 55 fc ff 48 b9 18 ec 7e c7 f7 7f 00 00 e8 e2 38 b3 5e c5 f9 28 44 24 40 c5 f9 11 40 08 c5 f8 28 74 24 50 48 83 c4 68 5e 5f c3}
...
0015h mov r11,7ff7c6251260h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 60 12 25 c6 f7 7f 00 00}
001fh cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0021h call qword ptr [rip-11220f7h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 09 df ed fe}
0027h mov edi,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f8}
0029h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
002ch mov r11,7ff7c6251268h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 68 12 25 c6 f7 7f 00 00}
0036h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0038h call qword ptr [rip-1122106h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 fa de ed fe}
003eh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0041h call 7ff7c736f830h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ba c4 ff ff}
...
004eh mov r11,7ff7c6251270h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 bb 70 12 25 c6 f7 7f 00 00}
0058h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
005ah call qword ptr [rip-1122120h]           ; CALL r/m64 || FF /2 || encoded[6]{ff 15 e0 de ed fe}
0060h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0063h call 7ff7c736f830h                      ; CALL rel32 || E8 cd || encoded[5]{e8 98 c4 ff ff}
...
008ah call 7ff7c7338900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 41 55 fc ff}
008fh mov rcx,7ff7c77eec18h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 18 ec 7e c7 f7 7f 00 00}
0099h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e2 38 b3 5e}
