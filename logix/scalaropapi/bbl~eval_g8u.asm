...
; bbl~eval_g8u[7ff7c6b7a660h, 7ff7c6b7a7feh][414] = {57 56 55 53 48 83 ec 28 8b f1 40 0f b6 c6 83 f8 0f 0f 87 c7 00 00 00 8b c0 48 8d 0d 40 01 00 00 8b 0c 81 4c 8d 0d e0 ff ff ff 49 03 c9 ff e1 48 b8 ff ff ff ff ff ff ff ff e9 97 00 00 00 33 c0 e9 90 00 00 00 49 23 d0 48 8b c2 e9 85 00 00 00 48 8b c2 49 23 c0 48 f7 d0 eb 7a 48 8b c2 49 0b c0 eb 72 48 8b c2 49 8b d0 48 0b c2 48 f7 d0 eb 64 48 8b c2 49 8b d0 48 33 c2 eb 59 48 8b c2 49 8b d0 48 33 c2 48 f7 d0 eb 4b 48 8b c2 eb 46 49 8b c0 eb 41 48 8b c2 48 f7 d0 eb 39 49 8b c0 48 f7 d0 eb 31 48 8b c2 49 8b d0 4c 8b c2 49 f7 d0 49 0b c0 eb 20 c4 c2 e8 f2 c0 eb 19 48 8b c2 49 8b d0 48 f7 d0 48 0b c2 eb 0b 48 8b c2 49 8b c8 c4 e2 f0 f2 c0 48 83 c4 28 5b 5d 5e 5f c3 48 b9 b0 c7 91 c6 f7 7f 00 00 e8 63 c5 32 5f 48 8b f8 40 88 77 08 48 b9 a8 9e 36 c6 f7 7f 00 00 e8 8d 48 2d 5f 48 8b c8 e8 f5 1d ea ff 8b f0 48 b9 38 2a 5b c6 f7 7f 00 00 e8 34 c5 32 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 1d 5e 45 5f 48 8b e8 8b ce e8 bb 19 ea ff 4c 8b c0 48 8b cd 48 8b d7 e8 8d 99 81 ff 48 8b d0 48 8b cb e8 aa 30 83 ff 48 8b cb e8 42 11 2a 5f cc 00 34 00 00 00 3b 00 00 00 c0 00 00 00 80 00 00 00 ab 00 00 00 85 00 00 00 67 00 00 00 51 00 00 00 59 00 00 00 72 00 00 00 92 00 00 00 9a 00 00 00 8a 00 00 00 b2 00 00 00 46 00 00 00 25 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-25 02:10:39:464
...
0019h lea rcx,[7ff7c6b7a7c0h]                 ; LEA r64, m || REX.W 8D /r || encoded[7]{48 8d 0d 40 01 00 00}
0020h mov ecx,[rcx+rax*4]                     ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 0c 81}
0023h lea r9,[7ff7c6b7a66ah]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d e0 ff ff ff}
...
00deh mov rcx,7ff7c691c7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 c7 91 c6 f7 7f 00 00}
00e8h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 63 c5 32 5f}
00edh mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
00f0h mov [rdi+8],sil                         ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 77 08}
00f4h mov rcx,7ff7c6369ea8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a8 9e 36 c6 f7 7f 00 00}
00feh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8d 48 2d 5f}
0103h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0106h call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f5 1d ea ff}
010bh mov esi,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f0}
010dh mov rcx,7ff7c65b2a38h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 38 2a 5b c6 f7 7f 00 00}
0117h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 34 c5 32 5f}
...
0124h mov rdx,7ff7c68117f0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba f0 17 81 c6 f7 7f 00 00}
012eh call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d 5e 45 5f}
0133h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
0136h mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
0138h call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bb 19 ea ff}
...
0146h call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8d 99 81 ff}
...
0151h call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 aa 30 83 ff}
0156h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0159h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 42 11 2a 5f}
