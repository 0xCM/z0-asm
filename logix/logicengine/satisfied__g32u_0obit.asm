...
; satisfied__g32u_0obit[7ff7c6cf2ac0h, 7ff7c6cf2b12h][82] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 b8 ca 90 c6 f7 7f 00 00 ba 02 00 00 00 e8 fd 42 1b 5f 89 78 10 89 58 14 48 8b ce 48 8b d0 39 09 e8 a2 f8 ff ff 48 8b ce e8 fa de ff ff 8b 40 08 83 f8 ff 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; Capture completion code, RET_ZEDx3
; 2020-01-24 02:54:57:164
...
000fh mov rcx,7ff7c690cab8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b8 ca 90 c6 f7 7f 00 00}
0019h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fd 42 1b 5f}
...
0031h call 7ff7c6cf2398h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a2 f8 ff ff}
0036h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
0039h call 7ff7c6cf09f8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fa de ff ff}
