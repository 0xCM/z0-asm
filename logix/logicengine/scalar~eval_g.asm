...
; scalar~eval_g64u[25] = {0f 1f 44 00 00 48 b8 b0 28 ea c6 f7 7f 00 00 48 ff e0 00 00 19 00 00 00 40}
; Capture completion code = ZEDx6_000
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,7ff7c6ea28b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 b0 28 ea c6 f7 7f 00 00}
