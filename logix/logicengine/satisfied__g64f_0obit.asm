...
; satisfied__g64f_0obit[7ff7c6e70420h, 7ff7c6e70494h][116] = {56 48 83 ec 20 c5 f8 77 48 8b f1 c5 fb 11 4c 24 38 c5 fb 11 54 24 40 48 b9 60 51 aa c6 f7 7f 00 00 ba 02 00 00 00 e8 95 69 03 5f c5 fb 10 4c 24 38 c5 fb 11 48 10 c5 fb 10 54 24 40 c5 fb 11 50 18 48 8b ce 48 8b d0 39 09 e8 9a 14 ea ff 48 8b ce e8 6a f7 e9 ff c5 fb 10 40 08 c5 f9 2e 05 1d 00 00 00 0f 9b c0 7a 03 0f 94 c0 0f b6 c0 48 83 c4 20 5e c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:10:51:437
...
0017h mov rcx,7ff7c6aa5160h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 60 51 aa c6 f7 7f 00 00}
0021h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
0026h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 95 69 03 5f}
...
0049h call 7ff7c6d11908h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9a 14 ea ff}
004eh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
0051h call 7ff7c6d0fbe0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6a f7 e9 ff}
0056h vmovsd xmm0,qword ptr [rax+8]           ; VMOVSD xmm1, m64 || VEX.LIG.F2.0F.WIG 10 /r || encoded[5]{c5 fb 10 40 08}
005bh vucomisd xmm0,qword ptr [7ff7c6e704a0h] ; VUCOMISD xmm1, xmm2/m64 || VEX.LIG.66.0F.WIG 2E /r || encoded[8]{c5 f9 2e 05 1d 00 00 00}
