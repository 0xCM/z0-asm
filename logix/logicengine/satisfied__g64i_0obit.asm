...
; satisfied__g64i_0obit[7ff7c63a97b0h, 7ff7c63a9810h][96] = {57 56 53 48 83 ec 20 48 8b f1 48 8b fa 49 8b d8 48 b9 70 75 e5 c6 f7 7f 00 00 ba 02 00 00 00 e8 0c d6 af 5f 48 89 78 10 48 89 58 18 48 8b ce 48 8b d0 39 09 e8 ff 8d 94 00 48 8b ce e8 27 72 94 00 48 8b 40 08 48 ba ff ff ff ff ff ff ff 7f 48 3b c2 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; Capture completion code, RET_SBB
; 2020-01-24 02:54:57:167
...
0010h mov rcx,7ff7c6e57570h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 70 75 e5 c6 f7 7f 00 00}
001ah mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001fh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0c d6 af 5f}
...
0034h call 7ff7c6cf25e8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ff 8d 94 00}
0039h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003ch call 7ff7c6cf0a18h                      ; CALL rel32 || E8 cd || encoded[5]{e8 27 72 94 00}
