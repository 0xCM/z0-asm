...
; satisfied_g64u_0o_0o[87] = {57 56 53 48 83 ec 20 48 8b f1 48 8b fa 49 8b d8 48 b9 78 6d 73 c6 f7 7f 00 00 ba 02 00 00 00 e8 ec 22 00 5f 48 89 78 10 48 89 58 18 48 8b ce 48 8b d0 39 09 e8 ef fb ff ff 48 8b ce e8 67 de ff ff 48 8b 40 08 48 83 f8 ff 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
...
0010h mov rcx,7ff7c6736d78h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 78 6d 73 c6 f7 7f 00 00}
001ah mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001fh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec 22 00 5f}
...
0034h call 7ff7c6ea46f8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ef fb ff ff}
0039h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003ch call 7ff7c6ea2978h                      ; CALL rel32 || E8 cd || encoded[5]{e8 67 de ff ff}
