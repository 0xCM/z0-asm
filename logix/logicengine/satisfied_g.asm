...
; satisfied_g8u_0o_0o[86] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 10 ea 34 c6 f7 7f 00 00 ba 02 00 00 00 e8 9d b9 af 5e 40 88 78 10 88 58 11 48 8b ce 48 8b d0 39 09 e8 51 fd ff ff 48 8b ce e8 99 dc ff ff 0f b6 40 08 0f b6 c0 3c ff 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_ZEDx3
...
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9d b9 af 5e}
...
0032h call 7ff7c73ab1a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 51 fd ff ff}
0037h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003ah call 7ff7c73a90f8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 99 dc ff ff}
...
; satisfied_g8i_0o_0o[93] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 98 f0 34 c6 f7 7f 00 00 ba 02 00 00 00 e8 1d b5 af 5e 40 88 78 10 88 58 11 48 8b ce 48 8b d0 39 09 e8 e9 fb ff ff 48 8b ce e8 71 d8 ff ff 48 0f be 40 08 48 0f be c0 48 0f be c0 83 f8 7f 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0019h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d b5 af 5e}
0023h mov [rax+10h],dil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 78 10}
0027h mov [rax+11h],bl                        ; MOV r/m8, r8 || 88 /r || encoded[3]{88 58 11}
002ah mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
002dh mov rdx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d0}
0030h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0032h call 7ff7c73ab4c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e9 fb ff ff}
0037h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003ah call 7ff7c73a9150h                      ; CALL rel32 || E8 cd || encoded[5]{e8 71 d8 ff ff}
...
; satisfied_g16u_0o_0o[93] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 68 28 ce c6 f7 7f 00 00 ba 02 00 00 00 e8 9d b4 af 5e 66 89 78 10 66 89 58 12 48 8b ce 48 8b d0 39 09 e8 c0 fb ff ff 48 8b ce e8 90 d9 ff ff 0f b7 40 08 0f b7 c0 0f b7 c0 3d ff ff 00 00 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
000ah mov edi,edx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b fa}
000ch mov ebx,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b d8}
000fh mov rcx,7ff7c6ce2868h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 68 28 ce c6 f7 7f 00 00}
0019h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9d b4 af 5e}
...
0033h call 7ff7c73ab518h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c0 fb ff ff}
0038h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003bh call 7ff7c73a92f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 d9 ff ff}
...
; satisfied_g16i_0o_0o[96] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 c8 32 e3 c6 f7 7f 00 00 ba 02 00 00 00 e8 1d b4 af 5e 66 89 78 10 66 89 58 12 48 8b ce 48 8b d0 39 09 e8 a8 fb ff ff 48 8b ce e8 58 d9 ff ff 48 0f bf 40 08 48 0f bf c0 48 0f bf c0 3d ff 7f 00 00 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
000ah mov edi,edx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b fa}
000ch mov ebx,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b d8}
000fh mov rcx,7ff7c6e332c8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 c8 32 e3 c6 f7 7f 00 00}
0019h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d b4 af 5e}
0023h mov [rax+10h],di                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 78 10}
0027h mov [rax+12h],bx                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 58 12}
002bh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
002eh mov rdx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d0}
0031h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0033h call 7ff7c73ab580h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a8 fb ff ff}
0038h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003bh call 7ff7c73a9338h                      ; CALL rel32 || E8 cd || encoded[5]{e8 58 d9 ff ff}
...
; satisfied_g32u_0o_0o[82] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 e8 7e c2 c6 f7 7f 00 00 ba 02 00 00 00 e8 9d b3 af 5e 89 78 10 89 58 14 48 8b ce 48 8b d0 39 09 e8 92 fb ff ff 48 8b ce e8 22 d9 ff ff 8b 40 08 83 f8 ff 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
000ah mov edi,edx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b fa}
000ch mov ebx,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b d8}
000fh mov rcx,7ff7c6c27ee8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e8 7e c2 c6 f7 7f 00 00}
0019h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9d b3 af 5e}
...
0031h call 7ff7c73ab5e8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 92 fb ff ff}
0036h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
0039h call 7ff7c73a9380h                      ; CALL rel32 || E8 cd || encoded[5]{e8 22 d9 ff ff}
...
; satisfied_g32i_0o_0o[84] = {57 56 53 48 83 ec 20 48 8b f1 8b fa 41 8b d8 48 b9 48 5f 41 c6 f7 7f 00 00 ba 02 00 00 00 e8 2d b3 af 5e 89 78 10 89 58 14 48 8b ce 48 8b d0 39 09 e8 8a fb ff ff 48 8b ce e8 fa d8 ff ff 8b 40 08 3d ff ff ff 7f 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0019h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2d b3 af 5e}
0023h mov [rax+10h],edi                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 78 10}
0026h mov [rax+14h],ebx                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 58 14}
0029h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
002ch mov rdx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d0}
002fh cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0031h call 7ff7c73ab650h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8a fb ff ff}
0036h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
0039h call 7ff7c73a93c8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fa d8 ff ff}
003eh mov eax,[rax+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 40 08}
...
; satisfied_g64u_0o_0o[87] = {57 56 53 48 83 ec 20 48 8b f1 48 8b fa 49 8b d8 48 b9 18 83 51 c6 f7 7f 00 00 ba 02 00 00 00 e8 bc b2 af 5e 48 89 78 10 48 89 58 18 48 8b ce 48 8b d0 39 09 e8 7f fb ff ff 48 8b ce e8 d7 fb ff ff 48 8b 40 08 48 83 f8 ff 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
...
0010h mov rcx,7ff7c6518318h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 18 83 51 c6 f7 7f 00 00}
001ah mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001fh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bc b2 af 5e}
...
0034h call 7ff7c73ab6b8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7f fb ff ff}
0039h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003ch call 7ff7c73ab718h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d7 fb ff ff}
...
; satisfied_g64i_0o_0o[96] = {57 56 53 48 83 ec 20 48 8b f1 48 8b fa 49 8b d8 48 b9 10 c3 87 c7 f7 7f 00 00 ba 02 00 00 00 e8 4c b2 af 5e 48 89 78 10 48 89 58 18 48 8b ce 48 8b d0 39 09 e8 bf fb ff ff 48 8b ce e8 5f d8 ff ff 48 8b 40 08 48 ba ff ff ff ff ff ff ff 7f 48 3b c2 0f 94 c0 0f b6 c0 48 83 c4 20 5b 5e 5f c3}
; TermCode = RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
000ah mov rdi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fa}
000dh mov rbx,r8                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{49 8b d8}
0010h mov rcx,7ff7c787c310h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 c3 87 c7 f7 7f 00 00}
001ah mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001fh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4c b2 af 5e}
0024h mov [rax+10h],rdi                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 78 10}
0028h mov [rax+18h],rbx                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 58 18}
002ch mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
002fh mov rdx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d0}
0032h cmp [rcx],ecx                           ; CMP r/m32, r32 || o32 39 /r || encoded[2]{39 09}
0034h call 7ff7c73ab768h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bf fb ff ff}
0039h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
003ch call 7ff7c73a9410h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5f d8 ff ff}
0041h mov rax,[rax+8]                         ; MOV r64, r/m64 || REX.W 8B /r || encoded[4]{48 8b 40 08}
