...
; ubl~lookup[113] = {57 56 48 83 ec 28 8b f1 40 0f b6 ce 83 f9 03 0f 87 28 01 00 00 8b c9 48 8d 05 7a 01 00 00 8b 04 88 48 8d 15 e0 ff ff ff 48 03 c2 ff e0 48 b9 20 84 ae c6 f7 7f 00 00 e8 a4 d1 46 5f 48 8b f0 48 8d 4e 08 48 8b d6 e8 d5 c2 46 5f 48 b8 90 d8 27 c6 f7 7f 00 00 48 89 46 18 48 b8 30 6b 80 c6 f7 7f 00 00 48 89 46 20 48 8b c6 48 83 c4 28 5e 5f c3}
...
002dh mov rcx,7ff7c6ae8420h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 20 84 ae c6 f7 7f 00 00}
0037h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a4 d1 46 5f}
...
0046h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d5 c2 46 5f}
004bh mov rax,7ff7c627d890h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 90 d8 27 c6 f7 7f 00 00}
0055h mov [rsi+18h],rax                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 46 18}
0059h mov rax,7ff7c6806b30h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 30 6b 80 c6 f7 7f 00 00}
