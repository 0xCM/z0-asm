...
; bbl~eval[7ff7c6a13060h, 7ff7c6a13183h][291] = {57 56 48 83 ec 28 8b f1 40 0f b6 c6 83 f8 0f 0f 87 b3 00 00 00 8b c0 48 8d 0d 0a 01 00 00 8b 0c 81 4c 8d 0d e0 ff ff ff 49 03 c9 ff e1 b8 01 00 00 00 e9 8a 00 00 00 33 c0 e9 83 00 00 00 41 23 d0 8b c2 eb 7c 8b c2 41 23 c0 f7 d0 83 e0 01 eb 70 8b c2 41 0b c0 eb 69 8b c2 41 0b c0 f7 d0 83 e0 01 eb 5d 8b c2 41 33 c0 eb 56 8b c2 41 33 c0 f7 d0 83 e0 01 eb 4a 41 8b c0 f7 d0 83 e0 01 0b c2 eb 3e 8b c2 f7 d0 83 e0 01 41 23 c0 eb 32 8b c2 eb 2e 41 8b c0 eb 29 8b c2 f7 d0 83 e0 01 eb 20 41 8b c0 f7 d0 83 e0 01 eb 16 8b c2 f7 d0 83 e0 01 41 0b c0 eb 0a 41 8b c0 f7 d0 83 e0 01 23 c2 48 83 c4 28 5e 5f c3 48 b9 b0 c7 91 c6 f7 7f 00 00 e8 79 3b 49 5f 48 8b f8 40 88 77 08 48 b9 38 2a 5b c6 f7 7f 00 00 e8 63 3b 49 5f 48 8b f0 b9 58 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 4c d4 5b 5f 48 8b c8 48 8b d7 e8 c1 0f 98 ff 48 8b d0 48 8b ce e8 e6 a6 99 ff 48 8b ce e8 7e 87 40 5f cc}
; Capture completion code, ZEDx6
; 2020-01-25 02:10:36:114
...
0017h lea rcx,[7ff7c6a13188h]                 ; LEA r64, m || REX.W 8D /r || encoded[7]{48 8d 0d 0a 01 00 00}
001eh mov ecx,[rcx+rax*4]                     ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 0c 81}
0021h lea r9,[7ff7c6a13068h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d e0 ff ff ff}
...
00c8h mov rcx,7ff7c691c7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 c7 91 c6 f7 7f 00 00}
00d2h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 79 3b 49 5f}
00d7h mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
00dah mov [rdi+8],sil                         ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 77 08}
00deh mov rcx,7ff7c65b2a38h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 38 2a 5b c6 f7 7f 00 00}
00e8h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 63 3b 49 5f}
...
00f5h mov rdx,7ff7c68117f0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba f0 17 81 c6 f7 7f 00 00}
00ffh call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4c d4 5b 5f}
...
010ah call 7ff7c6394130h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c1 0f 98 ff}
...
0115h call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e6 a6 99 ff}
011ah mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
011dh call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7e 87 40 5f}
