...
; ubl~eval[7ff7c67e0ab0h, 7ff7c67e0b6eh][190] = {57 56 48 83 ec 28 8b f1 40 0f b6 c6 83 f8 03 77 44 8b c0 48 8d 0d 96 00 00 00 8b 0c 81 4c 8d 05 e4 ff ff ff 49 03 c8 ff e1 33 c0 48 83 c4 28 5e 5f c3 8b c2 f7 d0 83 e0 01 48 83 c4 28 5e 5f c3 8b c2 48 83 c4 28 5e 5f c3 b8 01 00 00 00 48 83 c4 28 5e 5f c3 48 b9 00 6a 88 c6 f7 7f 00 00 e8 9c 61 6c 5f 48 8b f8 40 88 77 08 48 b9 50 58 58 c6 f7 7f 00 00 e8 86 61 6c 5f 48 8b f0 b9 58 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 6f fa 7e 5f 48 8b c8 48 8b d7 e8 e4 35 b9 ff 48 8b d0 48 8b ce e8 b9 e2 ba ff 48 8b ce e8 a1 ad 63 5f cc 21 00 00 00 2a 00 00 00 38 00 00 00 41 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-24 02:54:42:412
...
0013h lea rcx,[7ff7c67e0b60h]                 ; LEA r64, m || REX.W 8D /r || encoded[7]{48 8d 0d 96 00 00 00}
001ah mov ecx,[rcx+rax*4]                     ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 0c 81}
001dh lea r8,[7ff7c67e0ab8h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 05 e4 ff ff ff}
...
0055h mov rcx,7ff7c6886a00h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 00 6a 88 c6 f7 7f 00 00}
005fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9c 61 6c 5f}
0064h mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
0067h mov [rdi+8],sil                         ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 77 08}
006bh mov rcx,7ff7c6585850h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 50 58 58 c6 f7 7f 00 00}
0075h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 86 61 6c 5f}
...
0082h mov rdx,7ff7c65ad200h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 00 d2 5a c6 f7 7f 00 00}
008ch call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6f fa 7e 5f}
...
0097h call 7ff7c6374130h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e4 35 b9 ff}
...
00a2h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b9 e2 ba ff}
00a7h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
00aah call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a1 ad 63 5f}
