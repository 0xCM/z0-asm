...
; evalspec_g8u[191] = {57 56 55 53 48 83 ec 28 8b f1 8b c2 41 8b d0 40 0f b6 ce 83 f9 0f 0f 87 a3 00 00 00 8b c9 4c 8d 05 1b 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 b8 ff 00 00 00 eb 78 33 c0 eb 74 8b c8 e8 08 fc ff ff eb 6b 8b c8 e8 b7 f8 ff ff eb 62 8b c8 e8 8e f9 ff ff eb 59 8b c8 e8 65 f9 ff ff eb 50 8b c8 e8 84 fb ff ff eb 47 8b c8 e8 33 f9 ff ff eb 3e 0f b6 c0 eb 39 0f b6 c2 eb 34 8b c8 e8 c0 f8 ff ff eb 2b 8b c8 e8 f7 f8 ff ff eb 22 8b c8 e8 ce f8 ff ff eb 19 8b c8 e8 6d fb ff ff eb 10 8b c8 e8 7c f8 ff ff eb 07 8b c8 e8 7b fb ff ff 90 48 83 c4 28 5b 5d 5e 5f c3}
; TermCode = ZEDx7_RET
...
003fh jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 74}
0041h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0043h call 7ff7c7383050h                      ; CALL rel32 || E8 cd || encoded[5]{e8 58 fb ff ff}
0048h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 6b}
004ah mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
004ch call 7ff7c7382fa0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9f fa ff ff}
0051h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 62}
0053h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0055h call 7ff7c7383010h                      ; CALL rel32 || E8 cd || encoded[5]{e8 06 fb ff ff}
005ah jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 59}
005ch mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
005eh call 7ff7c7383000h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ed fa ff ff}
0063h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 50}
0065h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0067h call 7ff7c7383020h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 fb ff ff}
006ch jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 47}
006eh mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0070h call 7ff7c7382ff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cb fa ff ff}
0075h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 3e}
...
007fh jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 34}
0081h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0083h call 7ff7c7382fc0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 88 fa ff ff}
0088h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 2b}
008ah mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
008ch call 7ff7c7382fe0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9f fa ff ff}
0091h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 22}
0093h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0095h call 7ff7c7382fd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 86 fa ff ff}
009ah jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 19}
009ch mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
009eh call 7ff7c7383030h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd fa ff ff}
00a3h jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 10}
00a5h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
00a7h call 7ff7c7382fb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 54 fa ff ff}
00ach jmp short 00b5h                         ; JMP rel8 || EB cb || encoded[2]{eb 07}
00aeh mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
00b0h call 7ff7c7383040h                      ; CALL rel32 || E8 cd || encoded[5]{e8 db fa ff ff}
00b5h nop                                     ; NOP || o32 90 || encoded[1]{90}
00b6h add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
00bah pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
00bbh pop rbp                                 ; POP r64 || 58+ro || encoded[1]{5d}
...
; evalspec_g8u[187] = {57 56 55 53 48 83 ec 28 8b f1 8b c2 41 8b d0 40 0f b6 ce 83 f9 0f 0f 87 9f 00 00 00 8b c9 4c 8d 05 1b 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 b8 ff ff ff ff eb 74 33 c0 eb 70 8b c8 e8 88 fa ff ff eb 67 8b c8 e8 cf f9 ff ff eb 5e 8b c8 e8 36 fa ff ff eb 55 8b c8 e8 1d fa ff ff eb 4c 8b c8 e8 34 fa ff ff eb 43 8b c8 e8 fb f9 ff ff eb 3a eb 38 8b c2 eb 34 8b c8 e8 bc f9 ff ff eb 2b 8b c8 e8 d3 f9 ff ff eb 22 8b c8 e8 ba f9 ff ff eb 19 8b c8 e8 11 fa ff ff eb 10 8b c8 e8 88 f9 ff ff eb 07 8b c8 e8 0f fa ff ff 90 48 83 c4 28 5b 5d 5e 5f c3}
; TermCode = ZEDx7_RET
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbp                                ; PUSH r64 || 50+ro || encoded[1]{55}
...
0041h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0043h call 7ff7c7383120h                      ; CALL rel32 || E8 cd || encoded[5]{e8 88 fa ff ff}
0048h jmp short 00b1h                         ; JMP rel8 || EB cb || encoded[2]{eb 67}
004ah mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
004ch call 7ff7c7383070h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cf f9 ff ff}
0051h jmp short 00b1h                         ; JMP rel8 || EB cb || encoded[2]{eb 5e}
0053h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0055h call 7ff7c73830e0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 36 fa ff ff}
005ah jmp short 00b1h                         ; JMP rel8 || EB cb || encoded[2]{eb 55}
005ch mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
005eh call 7ff7c73830d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d fa ff ff}
0063h jmp short 00b1h                         ; JMP rel8 || EB cb || encoded[2]{eb 4c}
0065h mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0067h call 7ff7c73830f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 34 fa ff ff}
006ch jmp short 00b1h                         ; JMP rel8 || EB cb || encoded[2]{eb 43}
006eh mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
0070h call 7ff7c73830c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fb f9 ff ff}
...
; evalspec_g8u[212] = {57 56 55 53 48 83 ec 28 8b f1 48 8b c2 49 8b d0 40 0f b6 ce 83 f9 0f 0f 87 b7 00 00 00 8b c9 4c 8d 05 32 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 48 b8 ff ff ff ff ff ff ff ff e9 84 00 00 00 33 c0 e9 7d 00 00 00 48 8b c8 e8 ab f9 ff ff eb 73 48 8b c8 e8 f1 f8 ff ff eb 69 48 8b c8 e8 57 f9 ff ff eb 5f 48 8b c8 e8 3d f9 ff ff eb 55 48 8b c8 e8 53 f9 ff ff eb 4b 48 8b c8 e8 19 f9 ff ff eb 41 eb 3f 48 8b c2 eb 3a 48 8b c8 e8 d8 f8 ff ff eb 30 48 8b c8 e8 ee f8 ff ff eb 26 48 8b c8 e8 d4 f8 ff ff eb 1c 48 8b c8 e8 2a f9 ff ff eb 12 48 8b c8 e8 a0 f8 ff ff eb 08 48 8b c8 e8 26 f9 ff ff 90 48 83 c4 28 5b 5d 5e 5f c3}
; TermCode = ZEDx7_RET
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbp                                ; PUSH r64 || 50+ro || encoded[1]{55}
