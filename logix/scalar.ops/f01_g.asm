...
; f01_g[8u](8u,8u,8u)[28] = {0f 1f 44 00 00 0f b6 c2 41 0f b6 d0 0b c2 0f b6 c0 0f b6 d1 0b c2 f7 d0 0f b6 c0 c3}
...
------------------------------------------------------------------------------------------------------------------------
; sbyte f01<sbyte>(sbyte a, sbyte b, sbyte c)
; f01_g[8i](8i,8i,8i)[32] = {0f 1f 44 00 00 48 0f be c2 49 0f be d0 0b c2 48 0f be c0 48 0f be d1 0b c2 f7 d0 48 0f be c0 c3}
; TermCode = CTC_RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; f01_g[16u](16u,16u,16u)[28] = {0f 1f 44 00 00 0f b7 c2 41 0f b7 d0 0b c2 0f b7 c0 0f b7 d1 0b c2 f7 d0 0f b7 c0 c3}
; TermCode = CTC_RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
001bh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; short f01<short>(short a, short b, short c)
; f01_g[16i](16i,16i,16i)[32] = {0f 1f 44 00 00 48 0f bf c2 49 0f bf d0 0b c2 48 0f bf c0 48 0f bf d1 0b c2 f7 d0 48 0f bf c0 c3}
; TermCode = CTC_RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; f01_g[32u](32u,32u,32u)[15] = {0f 1f 44 00 00 41 0b d0 0b d1 8b c2 f7 d0 c3}
...
------------------------------------------------------------------------------------------------------------------------
; int f01<int>(int a, int b, int c)
; f01_g[32i](32i,32i,32i)[15] = {0f 1f 44 00 00 41 0b d0 0b d1 8b c2 f7 d0 c3}
; TermCode = CTC_RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h or edx,r8d                              ; OR r32, r/m32 || o32 0B /r || encoded[3]{41 0b d0}
0008h or edx,ecx                              ; OR r32, r/m32 || o32 0B /r || encoded[2]{0b d1}
...
; f01_g[64u](64u,64u,64u)[18] = {0f 1f 44 00 00 49 0b d0 48 0b d1 48 8b c2 48 f7 d0 c3}
...
------------------------------------------------------------------------------------------------------------------------
; long f01<long>(long a, long b, long c)
; f01_g[64i](64i,64i,64i)[18] = {0f 1f 44 00 00 49 0b d0 48 0b d1 48 8b c2 48 f7 d0 c3}
; TermCode = CTC_RET_Zx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h or rdx,r8                               ; OR r64, r/m64 || REX.W 0B /r || encoded[3]{49 0b d0}
0008h or rdx,rcx                              ; OR r64, r/m64 || REX.W 0B /r || encoded[3]{48 0b d1}
