...
; f3b_g[8i](8i,8i,8i)[54] = {56 48 83 ec 20 48 0f be c9 f7 d1 48 0f be c9 49 0f be c0 23 c8 48 0f be f1 48 0f be ca e8 fe bb fe ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 83 c4 20 5e c3}
...
001dh call 7ff7c8695ee0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fe bb fe ff}
...
; f3b_g[16i](16i,16i,16i)[54] = {56 48 83 ec 20 48 0f bf c9 f7 d1 48 0f bf c9 49 0f bf c0 23 c8 48 0f bf f1 48 0f bf ca e8 ce dc fe ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 83 c4 20 5e c3}
; TermCode = CTC_RET_Zx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
...
001dh call 7ff7c8698050h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ce dc fe ff}
...
; f3b_g[32i](32i,32i,32i)[27] = {56 48 83 ec 20 8b f1 f7 d6 41 23 f0 8b ca e8 1d fd fe ff 0b c6 48 83 c4 20 5e c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
...
000eh call 7ff7c869a110h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d fd fe ff}
...
; f3b_g[64i](64i,64i,64i)[31] = {56 48 83 ec 20 48 8b f1 48 f7 d6 49 23 f0 48 8b ca e8 62 19 ff ff 48 0b c6 48 83 c4 20 5e c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
...
0011h call 7ff7c869bdb8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 62 19 ff ff}
