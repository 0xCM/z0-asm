...
; f0d_g8u[43] = {0f 1f 44 00 00 0f b6 c1 f7 d0 0f b6 c0 41 0f b6 c8 81 f1 ff 00 00 00 0f b6 c9 0f b6 d2 0b d1 0f b6 d2 0f b6 c0 23 c2 0f b6 c0 c3}
...
; f0d_g8i[58] = {57 56 48 83 ec 28 8b f2 48 0f be c9 f7 d1 48 0f be f9 49 0f be c8 e8 3d 26 fe ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
...
0016h call 7ff7c71d5778h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3d 26 fe ff}
...
; f0d_g16u[53] = {50 0f 1f 40 00 0f b7 c1 f7 d0 0f b7 c0 41 0f b7 c8 81 f1 ff ff 00 00 89 4c 24 04 0f b7 4c 24 04 0f b7 d2 0b d1 0f b7 d2 0f b7 c0 23 c2 0f b7 c0 48 83 c4 08 c3}
; TermCode = RET_ZEDx3
...
; f0d_g16i[58] = {57 56 48 83 ec 28 8b f2 48 0f bf c9 f7 d1 48 0f bf f9 49 0f bf c8 e8 15 47 fe ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0016h call 7ff7c71d7900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 15 47 fe ff}
...
; f0d_g32u[19] = {0f 1f 44 00 00 8b c1 f7 d0 41 8b c8 f7 d1 0b d1 23 c2 c3}
; TermCode = RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; f0d_g32i[31] = {57 56 48 83 ec 28 8b f2 8b f9 f7 d7 41 8b c8 e8 54 67 fe ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c71d99c8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 54 67 fe ff}
...
; f0d_g64u[24] = {0f 1f 44 00 00 48 8b c1 48 f7 d0 49 8b c8 48 f7 d1 48 0b d1 48 23 c2 c3}
; TermCode = RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; f0d_g64i[36] = {57 56 48 83 ec 28 48 8b f2 48 8b f9 48 f7 d7 49 8b c8 e8 89 83 fe ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0012h call 7ff7c71db670h                      ; CALL rel32 || E8 cd || encoded[5]{e8 89 83 fe ff}
