...
; f0d_g8i_8i_8i[58] = {57 56 48 83 ec 28 8b f2 48 0f be c9 f7 d1 48 0f be f9 49 0f be c8 e8 a5 40 fe ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
...
0016h call 7ff7c872d3f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a5 40 fe ff}
...
; f0d_g16i_16i_16i[58] = {57 56 48 83 ec 28 8b f2 48 0f bf c9 f7 d1 48 0f bf f9 49 0f bf c8 e8 75 61 fe ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0016h call 7ff7c872f570h                      ; CALL rel32 || E8 cd || encoded[5]{e8 75 61 fe ff}
...
; f0d_g32i_32i_32i[31] = {57 56 48 83 ec 28 8b f2 8b f9 f7 d7 41 8b c8 e8 ac 81 fe ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c8731630h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ac 81 fe ff}
...
; f0d_g64i_64i_64i[36] = {57 56 48 83 ec 28 48 8b f2 48 8b f9 48 f7 d7 49 8b c8 e8 e9 9d fe ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0012h call 7ff7c87332e0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e9 9d fe ff}
