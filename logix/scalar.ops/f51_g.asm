...
; f51_g8i_8i_8i[58] = {57 56 48 83 ec 28 8b f1 49 0f be c8 f7 d1 48 0f be f9 48 0f be ca e8 55 26 ff ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
...
0016h call 7ff7c733cd50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 55 26 ff ff}
...
; f51_g16i_16i_16i[58] = {57 56 48 83 ec 28 8b f1 49 0f bf c8 f7 d1 48 0f bf f9 48 0f bf ca e8 25 47 ff ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0016h call 7ff7c733eed0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 25 47 ff ff}
...
; f51_g32i_32i_32i[31] = {57 56 48 83 ec 28 8b f1 41 8b f8 f7 d7 8b ca e8 5c 67 ff ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c7340f90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c 67 ff ff}
...
; f51_g64i_64i_64i[36] = {57 56 48 83 ec 28 48 8b f1 49 8b f8 48 f7 d7 48 8b ca e8 99 83 ff ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0012h call 7ff7c7342c40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 99 83 ff ff}
