...
; f51_g[8u](8u,8u,8u)[43] = {0f 1f 44 00 00 41 0f b6 c0 f7 d0 0f b6 c0 0f b6 d2 81 f2 ff 00 00 00 0f b6 d2 0f b6 c9 0b d1 0f b6 d2 0f b6 c0 23 c2 0f b6 c0 c3}
...
; f51_g[8i](8i,8i,8i)[58] = {57 56 48 83 ec 28 8b f1 49 0f be c8 f7 d1 48 0f be f9 48 0f be ca e8 c5 24 ff ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
...
0016h call 7ff7c86ce9b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c5 24 ff ff}
...
; f51_g[16u](16u,16u,16u)[53] = {50 0f 1f 40 00 41 0f b7 c0 f7 d0 0f b7 c0 0f b7 d2 81 f2 ff ff 00 00 89 54 24 04 0f b7 54 24 04 0f b7 c9 0b d1 0f b7 d2 0f b7 c0 23 c2 0f b7 c0 48 83 c4 08 c3}
; TermCode = CTC_RET_Zx3
...
; f51_g[16i](16i,16i,16i)[58] = {57 56 48 83 ec 28 8b f1 49 0f bf c8 f7 d1 48 0f bf f9 48 0f bf ca e8 85 45 ff ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0016h call 7ff7c86d0b20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 85 45 ff ff}
...
; f51_g[32u](32u,32u,32u)[17] = {0f 1f 44 00 00 41 8b c0 f7 d0 f7 d2 0b d1 23 c2 c3}
; TermCode = CTC_RET_Zx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; f51_g[32i](32i,32i,32i)[31] = {57 56 48 83 ec 28 8b f1 41 8b f8 f7 d7 8b ca e8 bc 65 ff ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c86d2be0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bc 65 ff ff}
...
; f51_g[64u](64u,64u,64u)[21] = {0f 1f 44 00 00 49 8b c0 48 f7 d0 48 f7 d2 48 0b d1 48 23 c2 c3}
; TermCode = CTC_RET_Zx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; f51_g[64i](64i,64i,64i)[36] = {57 56 48 83 ec 28 48 8b f1 49 8b f8 48 f7 d7 48 8b ca e8 f1 81 ff ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
...
0012h call 7ff7c86d4888h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f1 81 ff ff}
