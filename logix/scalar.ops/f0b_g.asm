...
; f0b_g8i_8i_8i[59] = {57 56 48 83 ec 28 41 8b f0 48 0f be c9 f7 d1 48 0f be f9 48 0f be ca e8 44 45 fe ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZED_SBB
...
0017h call 7ff7c737a0f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 44 45 fe ff}
...
; f0b_g16i_16i_16i[59] = {57 56 48 83 ec 28 41 8b f0 48 0f bf c9 f7 d1 48 0f bf f9 48 0f bf ca e8 14 66 fe ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0017h call 7ff7c737c270h                      ; CALL rel32 || E8 cd || encoded[5]{e8 14 66 fe ff}
...
; f0b_g32i_32i_32i[31] = {57 56 48 83 ec 28 41 8b f0 8b f9 f7 d7 8b ca e8 4c 86 fe ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c737e330h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4c 86 fe ff}
...
; f0b_g64i_64i_64i[36] = {57 56 48 83 ec 28 49 8b f0 48 8b f9 48 f7 d7 48 8b ca e8 81 a2 fe ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0012h call 7ff7c737ffd8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 81 a2 fe ff}
