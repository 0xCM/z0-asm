...
; f43_g8i_8i_8i[68] = {57 56 48 83 ec 28 8b f1 48 0f be ce 49 0f be c0 23 c8 48 0f be c9 f7 d1 48 0f be f9 48 0f be ca e8 6b af fe ff 48 0f be c0 48 0f be d6 33 c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_SBB
...
0020h call 7ff7c734c710h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6b af fe ff}
...
; f43_g16i_16i_16i[68] = {57 56 48 83 ec 28 8b f1 48 0f bf ce 49 0f bf c0 23 c8 48 0f bf c9 f7 d1 48 0f bf f9 48 0f bf ca e8 2b d0 fe ff 48 0f bf c0 48 0f bf d6 33 c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0020h call 7ff7c734e890h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2b d0 fe ff}
...
; f43_g32i_32i_32i[34] = {57 56 48 83 ec 28 8b f1 44 23 c6 41 8b f8 f7 d7 8b ca e8 69 f0 fe ff 33 c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0012h call 7ff7c7350950h                      ; CALL rel32 || E8 cd || encoded[5]{e8 69 f0 fe ff}
...
; f43_g64i_64i_64i[39] = {57 56 48 83 ec 28 48 8b f1 4c 23 c6 49 8b f8 48 f7 d7 48 8b ca e8 a6 0c ff ff 48 33 c6 48 23 c7 48 83 c4 28 5e 5f c3}
...
0015h call 7ff7c7352600h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a6 0c ff ff}
