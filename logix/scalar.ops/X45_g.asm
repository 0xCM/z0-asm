...
; X45_g8u_8u_8u[43] = {0f 1f 44 00 00 41 0f b6 c0 f7 d0 0f b6 c0 0f b6 c9 81 f1 ff 00 00 00 0f b6 c9 0f b6 d2 0b d1 0f b6 d2 0f b6 c0 23 c2 0f b6 c0 c3}
...
; X45_g8i_8i_8i[58] = {57 56 48 83 ec 28 8b f2 49 0f be c0 f7 d0 48 0f be f8 48 0f be c9 e8 85 ad fe ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
...
0016h call 7ff7c73a5320h                      ; CALL rel32 || E8 cd || encoded[5]{e8 85 ad fe ff}
...
; X45_g16u_16u_16u[53] = {50 0f 1f 40 00 41 0f b7 c0 f7 d0 0f b7 c0 0f b7 c9 81 f1 ff ff 00 00 89 4c 24 04 0f b7 4c 24 04 0f b7 d2 0b d1 0f b7 d2 0f b7 c0 23 c2 0f b7 c0 48 83 c4 08 c3}
; TermCode = RET_ZEDx3
...
; X45_g16i_16i_16i[58] = {57 56 48 83 ec 28 8b f2 49 0f bf c0 f7 d0 48 0f bf f8 48 0f bf c9 e8 55 ce fe ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0016h call 7ff7c73a74a0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 55 ce fe ff}
...
; X45_g32u_32u_32u[17] = {0f 1f 44 00 00 41 8b c0 f7 d0 f7 d1 0b d1 23 c2 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; X45_g32i_32i_32i[29] = {57 56 48 83 ec 28 8b f2 41 8b f8 f7 d7 e8 8e ee fe ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000dh call 7ff7c73a9560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8e ee fe ff}
...
; X45_g64u_64u_64u[21] = {0f 1f 44 00 00 49 8b c0 48 f7 d0 48 f7 d1 48 0b d1 48 23 c2 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; X45_g64i_64i_64i[33] = {57 56 48 83 ec 28 48 8b f2 49 8b f8 48 f7 d7 e8 cc 0a ff ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c73ab210h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cc 0a ff ff}
