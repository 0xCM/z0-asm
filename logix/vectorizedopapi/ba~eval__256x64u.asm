...
; ba~eval__256x64u[7ff7c6cb9400h, 7ff7c6cb94d9h][217] = {57 56 55 53 48 83 ec 28 c5 f8 77 48 8b c1 8b f2 40 80 fe 01 74 24 40 80 fe 02 75 3c c4 c1 7d 10 00 c4 c1 7d 10 09 c5 fd fb c1 c5 fd 11 00 c5 f8 77 48 83 c4 28 5b 5d 5e 5f c3 c4 c1 7d 10 00 c4 c1 7d 10 09 c5 fd d4 c1 c5 fd 11 00 c5 f8 77 48 83 c4 28 5b 5d 5e 5f c3 48 b9 88 2f 88 c6 f7 7f 00 00 e8 49 d8 1e 5f 48 8b f8 40 88 77 08 48 b9 78 a6 34 c6 f7 7f 00 00 e8 73 5b 19 5f 48 8b c8 e8 fb 52 d6 ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 1a d8 1e 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 03 71 31 5f 48 8b e8 8b ce e8 d9 2a 6e ff 4c 8b c0 48 8b cd 48 8b d7 e8 73 ac 6b ff 48 8b d0 48 8b cb e8 40 59 6d ff 48 8b cb e8 28 24 16 5f cc}
; Capture completion code, INTRx2
; 2020-01-24 02:54:51:889
...
0062h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 49 d8 1e 5f}
...
0078h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 73 5b 19 5f}
007dh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0080h call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fb 52 d6 ff}
...
0091h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1a d8 1e 5f}
...
00a8h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 03 71 31 5f}
00adh mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
00b0h mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
00b2h call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d9 2a 6e ff}
...
00c0h call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 73 ac 6b ff}
...
00cbh call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 40 59 6d ff}
00d0h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
00d3h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 28 24 16 5f}
