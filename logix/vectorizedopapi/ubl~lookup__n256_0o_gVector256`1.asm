...
; ubl~lookup__n256_0o_gVector256`1[7ff7c6cdac00h, 7ff7c6cdad39h][313] = {57 56 55 53 48 83 ec 28 8b f2 40 80 fe 01 74 50 40 80 fe 02 0f 85 8c 00 00 00 48 b9 a8 a4 d9 c6 f7 7f 00 00 e8 87 c0 1c 5f 48 8b f0 48 8d 4e 08 48 8b d6 e8 b8 b1 1c 5f 48 b8 a0 e3 26 c6 f7 7f 00 00 48 89 46 18 48 b8 c8 91 cc c6 f7 7f 00 00 48 89 46 20 48 8b c6 48 83 c4 28 5b 5d 5e 5f c3 48 b9 a8 a4 d9 c6 f7 7f 00 00 e8 41 c0 1c 5f 48 8b f0 48 8d 4e 08 48 8b d6 e8 72 b1 1c 5f 48 b8 a0 e3 26 c6 f7 7f 00 00 48 89 46 18 48 b8 d8 91 cc c6 f7 7f 00 00 48 89 46 20 48 8b c6 48 83 c4 28 5b 5d 5e 5f c3 48 b9 e8 f9 91 c6 f7 7f 00 00 e8 fb bf 1c 5f 48 8b f8 40 88 77 08 48 b9 a8 9e 36 c6 f7 7f 00 00 e8 25 43 17 5f 48 8b c8 e8 8d 18 d4 ff 8b f0 48 b9 38 2a 5b c6 f7 7f 00 00 e8 cc bf 1c 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 b5 58 2f 5f 48 8b e8 8b ce e8 53 14 d4 ff 4c 8b c0 48 8b cd 48 8b d7 e8 25 94 6b ff 48 8b d0 48 8b cb e8 42 2b 6d ff 48 8b cb e8 da 0b 14 5f cc 00 19 08 05 00 08 42 04 30 03 50 02 60 01 70 00 00 40}
; Capture completion code, ZEDx6
; 2020-01-25 02:10:44:370
...
001ah mov rcx,7ff7c6d9a4a8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a8 a4 d9 c6 f7 7f 00 00}
0024h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 87 c0 1c 5f}
...
0033h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b8 b1 1c 5f}
...
0046h mov rax,7ff7c6cc91c8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 c8 91 cc c6 f7 7f 00 00}
...
0060h mov rcx,7ff7c6d9a4a8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a8 a4 d9 c6 f7 7f 00 00}
006ah call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 41 c0 1c 5f}
...
0079h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 72 b1 1c 5f}
...
008ch mov rax,7ff7c6cc91d8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 d8 91 cc c6 f7 7f 00 00}
...
00b0h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fb bf 1c 5f}
...
00c6h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 25 43 17 5f}
00cbh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00ceh call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8d 18 d4 ff}
...
00dfh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cc bf 1c 5f}
...
00f6h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b5 58 2f 5f}
00fbh mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
00feh mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
0100h call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 53 14 d4 ff}
...
010eh call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 25 94 6b ff}
...
0119h call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 42 2b 6d ff}
011eh mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0121h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 da 0b 14 5f}
0126h int 3                                   ; INT3 || CC || encoded[1]{cc}
0127h add [rcx],bl                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 19}
0129h or [7ff7cb0fb52fh],al                   ; OR r/m8, r8 || 08 /r || encoded[6]{08 05 00 08 42 04}
