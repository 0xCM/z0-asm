...
; ubl~lookup__n256_0o_gVector256`1[7ff7c6cbbf50h, 7ff7c6cbc089h][313] = {57 56 55 53 48 83 ec 28 8b f2 40 80 fe 01 74 50 40 80 fe 02 0f 85 8c 00 00 00 48 b9 38 92 d8 c6 f7 7f 00 00 e8 37 ad 1e 5f 48 8b f0 48 8d 4e 08 48 8b d6 e8 68 9e 1e 5f 48 b8 d0 e3 24 c6 f7 7f 00 00 48 89 46 18 48 b8 78 a3 ca c6 f7 7f 00 00 48 89 46 20 48 8b c6 48 83 c4 28 5b 5d 5e 5f c3 48 b9 38 92 d8 c6 f7 7f 00 00 e8 f1 ac 1e 5f 48 8b f0 48 8d 4e 08 48 8b d6 e8 22 9e 1e 5f 48 b8 d0 e3 24 c6 f7 7f 00 00 48 89 46 18 48 b8 88 a3 ca c6 f7 7f 00 00 48 89 46 20 48 8b c6 48 83 c4 28 5b 5d 5e 5f c3 48 b9 00 6a 88 c6 f7 7f 00 00 e8 ab ac 1e 5f 48 8b f8 40 88 77 08 48 b9 a8 9e 34 c6 f7 7f 00 00 e8 d5 2f 19 5f 48 8b c8 e8 5d 27 d6 ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 7c ac 1e 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 65 45 31 5f 48 8b e8 8b ce e8 3b ff 6d ff 4c 8b c0 48 8b cd 48 8b d7 e8 d5 80 6b ff 48 8b d0 48 8b cb e8 a2 2d 6d ff 48 8b cb e8 8a f8 15 5f cc 00 19 08 05 00 08 42 04 30 03 50 02 60 01 70 00 00 40}
; Capture completion code, ZEDx6
; 2020-01-24 02:54:51:955
...
001ah mov rcx,7ff7c6d89238h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 38 92 d8 c6 f7 7f 00 00}
0024h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 37 ad 1e 5f}
...
0033h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 68 9e 1e 5f}
...
0046h mov rax,7ff7c6caa378h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 78 a3 ca c6 f7 7f 00 00}
...
0060h mov rcx,7ff7c6d89238h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 38 92 d8 c6 f7 7f 00 00}
006ah call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f1 ac 1e 5f}
...
0079h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 22 9e 1e 5f}
...
008ch mov rax,7ff7c6caa388h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 88 a3 ca c6 f7 7f 00 00}
...
00b0h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ab ac 1e 5f}
...
00c6h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d5 2f 19 5f}
00cbh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00ceh call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5d 27 d6 ff}
...
00dfh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7c ac 1e 5f}
...
00f6h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 65 45 31 5f}
00fbh mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
00feh mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
0100h call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3b ff 6d ff}
...
010eh call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d5 80 6b ff}
...
0119h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a2 2d 6d ff}
011eh mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0121h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8a f8 15 5f}
0126h int 3                                   ; INT3 || CC || encoded[1]{cc}
0127h add [rcx],bl                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 19}
0129h or [7ff7cb0dc87fh],al                   ; OR r/m8, r8 || 08 /r || encoded[6]{08 05 00 08 42 04}
