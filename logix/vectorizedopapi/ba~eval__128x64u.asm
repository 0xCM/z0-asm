...
; ba~eval__128x64u[7ff7c6cb79f0h, 7ff7c6cb7ac3h][211] = {57 56 55 53 48 83 ec 28 c5 f8 77 48 8b c1 8b f2 40 80 fe 01 74 21 40 80 fe 02 75 36 c4 c1 79 10 00 c4 c1 79 10 09 c5 f9 fb c1 c5 f9 11 00 48 83 c4 28 5b 5d 5e 5f c3 c4 c1 79 10 00 c4 c1 79 10 09 c5 f9 d4 c1 c5 f9 11 00 48 83 c4 28 5b 5d 5e 5f c3 48 b9 88 2f 88 c6 f7 7f 00 00 e8 5f f2 1e 5f 48 8b f8 40 88 77 08 48 b9 78 a6 34 c6 f7 7f 00 00 e8 89 75 19 5f 48 8b c8 e8 11 6d d6 ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 30 f2 1e 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 19 8b 31 5f 48 8b e8 8b ce e8 ef 44 6e ff 4c 8b c0 48 8b cd 48 8b d7 e8 89 c6 6b ff 48 8b d0 48 8b cb e8 56 73 6d ff 48 8b cb e8 3e 3e 16 5f cc}
; Capture completion code, INTRx2
; 2020-01-24 02:54:51:864
...
005ch call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5f f2 1e 5f}
...
0072h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 89 75 19 5f}
0077h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
007ah call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 11 6d d6 ff}
...
008bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 30 f2 1e 5f}
...
00a2h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 19 8b 31 5f}
00a7h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
00aah mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
00ach call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ef 44 6e ff}
...
00bah call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 89 c6 6b ff}
...
00c5h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 56 73 6d ff}
00cah mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
00cdh call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3e 3e 16 5f}
