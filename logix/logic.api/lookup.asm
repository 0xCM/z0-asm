...
; lookup_(UnaryBitLogicKind~8u)[113] = {57 56 48 83 ec 28 8b f1 40 0f b6 ce 83 f9 03 0f 87 28 01 00 00 8b c9 48 8d 05 7a 01 00 00 8b 04 88 48 8d 15 e0 ff ff ff 48 03 c2 ff e0 48 b9 d0 f5 b4 c8 f7 7f 00 00 e8 84 c5 bb 5e 48 8b f0 48 8d 4e 08 48 8b d6 e8 b5 b6 bb 5e 48 b8 50 e4 63 c7 f7 7f 00 00 48 89 46 18 48 b8 10 69 6a c8 f7 7f 00 00 48 89 46 20 48 8b c6 48 83 c4 28 5e 5f c3}
...
002dh mov rcx,7ff7c8b4f5d0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 d0 f5 b4 c8 f7 7f 00 00}
0037h call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 84 c5 bb 5e}
...
0046h call 7ff827265df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b5 b6 bb 5e}
004bh mov rax,7ff7c763e450h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 50 e4 63 c7 f7 7f 00 00}
0055h mov [rsi+18h],rax                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 46 18}
0059h mov rax,7ff7c86a6910h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 10 69 6a c8 f7 7f 00 00}
...
; lookup_(BinaryBitLogicKind~8u)[58] = {57 56 48 83 ec 28 8b f1 40 0f b6 ce 83 f9 0f 0f 87 07 04 00 00 8b c9 48 8d 05 5a 04 00 00 8b 04 88 48 8d 15 e0 ff ff ff 48 03 c2 ff e0 48 b9 80 f7 b4 c8 f7 7f 00 00 e8 c4 c3}
; TermCode = CTC_RET_Zx7
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0028h add rax,rdx                             ; ADD r64, r/m64 || REX.W 03 /r || encoded[3]{48 03 c2}
002bh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[2]{ff e0}
002dh mov rcx,7ff7c8b4f780h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 80 f7 b4 c8 f7 7f 00 00}
0037h (bad)                                   ; <invalid> || <invalid> || encoded[3]{e8 c4 c3}
