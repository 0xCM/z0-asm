...
; shift~sig_g8u[7ff7c6e730b0h, 7ff7c6e7314ah][154] = {57 56 48 83 ec 48 33 c0 48 89 44 24 28 48 89 44 24 30 48 89 44 24 38 48 89 44 24 40 8b f1 48 b9 00 e9 91 c6 f7 7f 00 00 e8 d3 3b 03 5f 48 8b f8 40 88 77 08 48 b9 a8 9e 36 c6 f7 7f 00 00 e8 fd be fd 5e 48 8b c8 e8 65 94 ba ff 8b c8 e8 56 90 ba ff 45 33 c0 48 ba 90 13 fe b1 cf 01 00 00 48 8b 12 48 b9 c0 48 ff b1 cf 01 00 00 48 8b 09 4c 8d 4c 24 28 49 89 39 49 89 41 08 4d 89 41 10 49 89 51 18 4c 8d 44 24 28 48 8b d1 33 c9 e8 fe 2a 06 4f 90 48 83 c4 48 5e 5f c3}
; Capture completion code, RET_ZEDx3
; 2020-01-25 02:10:51:531
...
001eh mov rcx,7ff7c691e900h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 00 e9 91 c6 f7 7f 00 00}
0028h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d3 3b 03 5f}
...
003eh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fd be fd 5e}
0043h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0046h call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 65 94 ba ff}
004bh mov ecx,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c8}
004dh call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 56 90 ba ff}
...
008dh call 7ff815ed5c40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fe 2a 06 4f}
