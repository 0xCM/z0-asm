...
; promote_gbit[18] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 b8 ff 00 00 00 c3}
...
; promote_gbit[18] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 b8 7f 00 00 00 c3}
; Capture completion code = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h test ecx,ecx                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c9}
0007h jne short 000ch                         ; JNE rel8 || 75 cb || encoded[2]{75 03}
...
; promote_gbit[18] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 b8 ff ff 00 00 c3}
; Capture completion code = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h test ecx,ecx                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c9}
0007h jne short 000ch                         ; JNE rel8 || 75 cb || encoded[2]{75 03}
...
; promote_gbit[18] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 b8 ff ff ff ff c3}
; Capture completion code = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h test ecx,ecx                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c9}
0007h jne short 000ch                         ; JNE rel8 || 75 cb || encoded[2]{75 03}
...
; promote_gbit[18] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 b8 ff ff ff 7f c3}
; Capture completion code = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h test ecx,ecx                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c9}
0007h jne short 000ch                         ; JNE rel8 || 75 cb || encoded[2]{75 03}
...
; promote_gbit[23] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 48 b8 ff ff ff ff ff ff ff ff c3}
...
; promote_gbit[23] = {0f 1f 44 00 00 85 c9 75 03 33 c0 c3 48 b8 ff ff ff ff ff ff ff 7f c3}
; Capture completion code = RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h test ecx,ecx                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c9}
0007h jne short 000ch                         ; JNE rel8 || 75 cb || encoded[2]{75 03}
