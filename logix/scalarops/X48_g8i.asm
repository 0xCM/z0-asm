...
; X48_g8i[7ff7c6ba3ee0h, 7ff7c6ba3efeh][30] = {0f 1f 44 00 00 48 0f be c1 49 0f be c8 33 c1 48 0f be c0 48 0f be d2 23 c2 48 0f be c0 c3}
; Capture completion code, RET_ZEDx3
; 2020-01-25 02:10:41:746
