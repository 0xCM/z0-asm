...
; X13_g8i[7ff7c6b9dec0h, 7ff7c6b9dee0h][32] = {0f 1f 44 00 00 48 0f be c1 49 0f be c8 23 c1 48 0f be c0 48 0f be d2 0b c2 f7 d0 48 0f be c0 c3}
; Capture completion code, RET_SBB
; 2020-01-25 02:10:40:745
