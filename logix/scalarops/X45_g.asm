...
; X45_g8i[58] = {57 56 48 83 ec 28 8b f2 49 0f be c0 f7 d0 48 0f be f8 48 0f be c9 e8 7d fe eb ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
...
0016h call 7ff7c6ba3868h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7d fe eb ff}
...
; X45_g16i[58] = {57 56 48 83 ec 28 8b f2 49 0f bf c0 f7 d0 48 0f bf f8 48 0f bf c9 e8 6d 20 ec ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; Capture completion code = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0016h call 7ff7c6ba5b08h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6d 20 ec ff}
...
; X45_g32i[29] = {57 56 48 83 ec 28 8b f2 41 8b f8 f7 d7 e8 9e 40 ec ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; Capture completion code = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000dh call 7ff7c6ba7bc0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9e 40 ec ff}
...
; X45_g64i[33] = {57 56 48 83 ec 28 48 8b f2 49 8b f8 48 f7 d7 e8 cc 5c ec ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
; Capture completion code = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c6ba9860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cc 5c ec ff}
