...
; X06_g8i[7ff7c6ca5cb0h, 7ff7c6ca5cd8h][40] = {0f 1f 44 00 00 48 0f be c1 f7 d0 48 0f be c0 48 0f be d2 49 0f be c8 33 d1 48 0f be d2 48 0f be c0 23 c2 48 0f be c0 c3}
; Capture completion code, RET_SBB
; 2020-01-24 02:54:50:193
