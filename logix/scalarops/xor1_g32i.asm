; int xor1<int>(int a)
; xor1_g32i[7ff7c6ba6490h, 7ff7c6ba64fdh][109] = {57 56 53 48 83 ec 30 be 57 00 00 00 bf 01 00 00 00 b9 78 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 fb a0 42 5f 48 8b d8 b9 82 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 e4 a0 42 5f 48 8b d0 48 8d 4c 24 28 40 88 39 89 71 04 48 8b cb 4c 8b 44 24 28 e8 39 d0 fd ff 48 8b c8 e8 11 54 27 5f cc 19 07 04 00 07 52 03 30 02 60 01 70 40}
; Capture completion code, ZEDx6
; 2020-01-25 02:10:42:149
...
0020h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fb a0 42 5f}
...
0037h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e4 a0 42 5f}
...
0052h call 7ff7c6b83520h                      ; CALL rel32 || E8 cd || encoded[5]{e8 39 d0 fd ff}
0057h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
005ah call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 11 54 27 5f}
