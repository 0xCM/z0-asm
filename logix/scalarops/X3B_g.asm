...
; X3B_g8u[43] = {0f 1f 44 00 00 0f b6 c1 f7 d0 0f b6 c0 41 0f b6 c8 23 c1 0f b6 c0 0f b6 d2 81 f2 ff 00 00 00 0f b6 d2 0f b6 c0 0b c2 0f b6 c0 c3}
...
; X3B_g8i[54] = {56 48 83 ec 20 48 0f be c9 f7 d1 48 0f be c9 49 0f be c0 23 c8 48 0f be f1 48 0f be ca e8 ce e5 fd ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
...
001dh call 7ff7c73464c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ce e5 fd ff}
...
; X3B_g16u[53] = {50 0f 1f 40 00 0f b7 c1 f7 d0 0f b7 c0 41 0f b7 c8 23 c1 0f b7 c0 0f b7 d2 81 f2 ff ff 00 00 89 54 24 04 0f b7 54 24 04 0f b7 c0 0b c2 0f b7 c0 48 83 c4 08 c3}
; TermCode = RET_ZEDx3
...
; X3B_g16i[54] = {56 48 83 ec 20 48 0f bf c9 f7 d1 48 0f bf c9 49 0f bf c0 23 c8 48 0f bf f1 48 0f bf ca e8 a6 06 fe ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
...
001dh call 7ff7c7348638h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a6 06 fe ff}
...
; X3B_g32u[17] = {0f 1f 44 00 00 8b c1 f7 d0 41 23 c0 f7 d2 0b c2 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; X3B_g32i[27] = {56 48 83 ec 20 8b f1 f7 d6 41 23 f0 8b ca e8 fd 26 fe ff 0b c6 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
...
000eh call 7ff7c734a700h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fd 26 fe ff}
...
; X3B_g64u[21] = {0f 1f 44 00 00 48 8b c1 48 f7 d0 49 23 c0 48 f7 d2 48 0b c2 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; X3B_g64i[31] = {56 48 83 ec 20 48 8b f1 48 f7 d6 49 23 f0 48 8b ca e8 42 43 fe ff 48 0b c6 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
...
0011h call 7ff7c734c3a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 42 43 fe ff}
