...
; X39_g8i[7ff7c6b92560h, 7ff7c6b92584h][36] = {0f 1f 44 00 00 49 0f be c0 f7 d0 48 0f be c0 48 0f be c9 0b c1 48 0f be c0 48 0f be d2 33 c2 48 0f be c0 c3}
; Capture completion code, RET_SBB
; 2020-01-24 02:54:48:906
