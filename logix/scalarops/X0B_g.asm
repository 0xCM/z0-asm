...
; X0B_g8i[59] = {57 56 48 83 ec 28 41 8b f0 48 0f be c9 f7 d1 48 0f be f9 48 0f be ca e8 04 b5 ff ff 48 0f be c0 48 0f be d6 0b c2 48 0f be c0 48 0f be d7 23 c2 48 0f be c0 48 83 c4 28 5e 5f c3}
; Capture completion code = RET_ZED_SBB
...
0017h call 7ff7c7331020h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 b5 ff ff}
...
; X0B_g16i[59] = {57 56 48 83 ec 28 41 8b f0 48 0f bf c9 f7 d1 48 0f bf f9 48 0f bf ca e8 04 b5 ff ff 48 0f bf c0 48 0f bf d6 0b c2 48 0f bf c0 48 0f bf d7 23 c2 48 0f bf c0 48 83 c4 28 5e 5f c3}
; Capture completion code = RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
0017h call 7ff7c73310d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 b5 ff ff}
...
; X0B_g32i[31] = {57 56 48 83 ec 28 41 8b f0 8b f9 f7 d7 8b ca e8 1c b5 ff ff 0b c6 23 c7 48 83 c4 28 5e 5f c3}
; Capture completion code = RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff7c7331170h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1c b5 ff ff}
...
; X0B_g64i[36] = {57 56 48 83 ec 28 49 8b f0 48 8b f9 48 f7 d7 48 8b ca e8 49 b5 ff ff 48 0b c6 48 23 c7 48 83 c4 28 5e 5f c3}
...
0012h call 7ff7c7331210h                      ; CALL rel32 || E8 cd || encoded[5]{e8 49 b5 ff ff}
