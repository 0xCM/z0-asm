...
; X1F_g8i[7ff7c6b9f3c0h, 7ff7c6b9f3e0h][32] = {0f 1f 44 00 00 48 0f be c2 49 0f be d0 0b c2 48 0f be c0 48 0f be d1 23 c2 f7 d0 48 0f be c0 c3}
; Capture completion code, RET_SBB
; 2020-01-25 02:10:41:014
