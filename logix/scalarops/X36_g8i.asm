...
; X36_g8i[7ff7c6ba1d10h, 7ff7c6ba1d2eh][30] = {0f 1f 44 00 00 48 0f be c1 49 0f be c8 0b c1 48 0f be c0 48 0f be d2 33 c2 48 0f be c0 c3}
; Capture completion code, RET_ZEDx3
; 2020-01-25 02:10:41:427
