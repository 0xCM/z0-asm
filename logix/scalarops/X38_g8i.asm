...
; X38_g8i[7ff7c6b923d0h, 7ff7c6b923fdh][45] = {0f 1f 44 00 00 48 0f be c1 4d 0f be c0 41 0b c0 48 0f be c0 48 0f be c9 48 0f be d2 33 d1 48 0f be d2 48 0f be c0 23 c2 48 0f be c0 c3}
; Capture completion code, RET_ZEDx3
; 2020-01-24 02:54:48:672
