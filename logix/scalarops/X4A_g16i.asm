; Int16 f4a<Int16>(Int16 a, Int16 b, Int16 c)
; X4A_g16i[7ff7c6ba42d0h, 7ff7c6ba42fch][44] = {0f 1f 44 00 00 48 0f bf c2 49 0f bf d0 0b c2 48 0f bf c0 48 0f bf d1 49 0f bf c8 33 d1 48 0f bf d2 48 0f bf c0 23 c2 48 0f bf c0 c3}
; Capture completion code, RET_SBB
; 2020-01-25 02:10:41:786
