...
; inc_g[45] = {56 48 83 ec 20 e8 5e fa ff ff 0f b6 48 08 ff c1 40 0f b6 f1 48 b9 30 63 96 c7 f7 7f 00 00 e8 ed 2e ac 5e 40 88 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e3808h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5e fa ff ff}
...
001eh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ed 2e ac 5e}
...
; inc_g[46] = {56 48 83 ec 20 e8 5e fa ff ff 48 0f be 48 08 ff c1 48 0f be f1 48 b9 a0 66 96 c7 f7 7f 00 00 e8 9c 2e ac 5e 40 88 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e3858h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5e fa ff ff}
...
001fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9c 2e ac 5e}
...
; inc_g[44] = {56 48 83 ec 20 e8 3e fa ff ff 0f b7 48 08 ff c1 0f b7 f1 48 b9 b0 69 96 c7 f7 7f 00 00 e8 4e 2e ac 5e 66 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e3888h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3e fa ff ff}
...
001dh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4e 2e ac 5e}
...
; inc_g[46] = {56 48 83 ec 20 e8 2e fa ff ff 48 0f bf 48 08 ff c1 48 0f bf f1 48 b9 c0 6c 96 c7 f7 7f 00 00 e8 0c 2e ac 5e 66 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e38b8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2e fa ff ff}
...
001fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0c 2e ac 5e}
...
; inc_g[39] = {56 48 83 ec 20 e8 0e fa ff ff 8b 70 08 ff c6 48 b9 d0 6f 96 c7 f7 7f 00 00 e8 c2 2d ac 5e 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e38e8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0e fa ff ff}
...
0019h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c2 2d ac 5e}
...
; inc_g[39] = {56 48 83 ec 20 e8 fe f9 ff ff 8b 70 08 ff c6 48 b9 e0 72 96 c7 f7 7f 00 00 e8 82 2d ac 5e 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e3918h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fe f9 ff ff}
000ah mov esi,[rax+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 70 08}
000dh inc esi                                 ; INC r/m32 || o32 FF /0 || encoded[2]{ff c6}
000fh mov rcx,7ff7c79672e0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e0 72 96 c7 f7 7f 00 00}
0019h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 82 2d ac 5e}
001eh mov [rax+8],esi                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 08}
0021h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0025h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0026h ret                                     ; RET || C3 || encoded[1]{c3}
...
; inc_g[42] = {56 48 83 ec 20 e8 ee f9 ff ff 48 8b 70 08 48 ff c6 48 b9 f0 75 96 c7 f7 7f 00 00 e8 40 2d ac 5e 48 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e3948h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ee f9 ff ff}
...
001bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 40 2d ac 5e}
...
; inc_g[42] = {56 48 83 ec 20 e8 de f9 ff ff 48 8b 70 08 48 ff c6 48 b9 00 79 96 c7 f7 7f 00 00 e8 00 2d ac 5e 48 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73e3978h                      ; CALL rel32 || E8 cd || encoded[5]{e8 de f9 ff ff}
000ah mov rsi,[rax+8]                         ; MOV r64, r/m64 || REX.W 8B /r || encoded[4]{48 8b 70 08}
000eh inc rsi                                 ; INC r/m64 || REX.W FF /0 || encoded[3]{48 ff c6}
0011h mov rcx,7ff7c7967900h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 00 79 96 c7 f7 7f 00 00}
001bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 00 2d ac 5e}
0020h mov [rax+8],rsi                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 70 08}
0024h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0028h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0029h ret                                     ; RET || C3 || encoded[1]{c3}
