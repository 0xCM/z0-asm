...
; inc_g~eg_IUnaryArithmeticOp`1_Byte[45] = {56 48 83 ec 20 e8 66 f8 ff ff 0f b6 48 08 ff c1 40 0f b6 f1 48 b9 60 03 95 c7 f7 7f 00 00 e8 3d a9 aa 5e 40 88 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fbbc0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 66 f8 ff ff}
...
001eh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3d a9 aa 5e}
...
; inc_g~eg_IUnaryArithmeticOp`1_SByte[46] = {56 48 83 ec 20 e8 66 f8 ff ff 48 0f be 48 08 ff c1 48 0f be f1 48 b9 d0 06 95 c7 f7 7f 00 00 e8 ec a8 aa 5e 40 88 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fbc10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 66 f8 ff ff}
...
001fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec a8 aa 5e}
...
; inc_g~eg_IUnaryArithmeticOp`1_UInt16[44] = {56 48 83 ec 20 e8 46 f8 ff ff 0f b7 48 08 ff c1 0f b7 f1 48 b9 e0 09 95 c7 f7 7f 00 00 e8 9e a8 aa 5e 66 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fbc40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 46 f8 ff ff}
...
001dh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9e a8 aa 5e}
...
; inc_g~eg_IUnaryArithmeticOp`1_Int16[46] = {56 48 83 ec 20 e8 36 f8 ff ff 48 0f bf 48 08 ff c1 48 0f bf f1 48 b9 f0 0c 95 c7 f7 7f 00 00 e8 5c a8 aa 5e 66 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fbc70h                      ; CALL rel32 || E8 cd || encoded[5]{e8 36 f8 ff ff}
...
001fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c a8 aa 5e}
...
; inc_g~eg_IUnaryArithmeticOp`1_UInt32[39] = {56 48 83 ec 20 e8 fe fb ff ff 8b 70 08 ff c6 48 b9 00 10 95 c7 f7 7f 00 00 e8 12 a4 aa 5e 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fc488h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fe fb ff ff}
...
0019h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 12 a4 aa 5e}
...
; inc_g~eg_IUnaryArithmeticOp`1_Int32[39] = {56 48 83 ec 20 e8 ee fb ff ff 8b 70 08 ff c6 48 b9 10 13 95 c7 f7 7f 00 00 e8 d2 a3 aa 5e 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fc4b8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ee fb ff ff}
000ah mov esi,[rax+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 70 08}
000dh inc esi                                 ; INC r/m32 || o32 FF /0 || encoded[2]{ff c6}
000fh mov rcx,7ff7c7951310h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 13 95 c7 f7 7f 00 00}
0019h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d2 a3 aa 5e}
001eh mov [rax+8],esi                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 08}
0021h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0025h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0026h ret                                     ; RET || C3 || encoded[1]{c3}
...
; inc_g~eg_IUnaryArithmeticOp`1_UInt64[42] = {56 48 83 ec 20 e8 de fb ff ff 48 8b 70 08 48 ff c6 48 b9 20 16 95 c7 f7 7f 00 00 e8 90 a3 aa 5e 48 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fc4e8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 de fb ff ff}
...
001bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 a3 aa 5e}
...
; inc_g~eg_IUnaryArithmeticOp`1_Int64[42] = {56 48 83 ec 20 e8 ce fb ff ff 48 8b 70 08 48 ff c6 48 b9 30 19 95 c7 f7 7f 00 00 e8 50 a3 aa 5e 48 89 70 08 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73fc518h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ce fb ff ff}
000ah mov rsi,[rax+8]                         ; MOV r64, r/m64 || REX.W 8B /r || encoded[4]{48 8b 70 08}
000eh inc rsi                                 ; INC r/m64 || REX.W FF /0 || encoded[3]{48 ff c6}
0011h mov rcx,7ff7c7951930h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 30 19 95 c7 f7 7f 00 00}
001bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 50 a3 aa 5e}
0020h mov [rax+8],rsi                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 70 08}
0024h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0028h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0029h ret                                     ; RET || C3 || encoded[1]{c3}
