...
; dec_g[45] = {56 48 83 ec 20 e8 a6 f8 ff ff 0f b6 48 08 ff c9 40 0f b6 f1 48 b9 48 d1 96 c7 f7 7f 00 00 e8 3d 2f b0 5e 40 88 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_Zx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a3600h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a6 f8 ff ff}
...
001eh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3d 2f b0 5e}
...
; dec_g[46] = {56 48 83 ec 20 e8 a6 f8 ff ff 48 0f be 48 08 ff c9 48 0f be f1 48 b9 b8 d4 96 c7 f7 7f 00 00 e8 ec 2e b0 5e 40 88 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_Zx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a3650h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a6 f8 ff ff}
...
001fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec 2e b0 5e}
...
; dec_g[44] = {56 48 83 ec 20 e8 86 f8 ff ff 0f b7 48 08 ff c9 0f b7 f1 48 b9 c8 d7 96 c7 f7 7f 00 00 e8 9e 2e b0 5e 66 89 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a3680h                      ; CALL rel32 || E8 cd || encoded[5]{e8 86 f8 ff ff}
...
001dh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9e 2e b0 5e}
...
; dec_g[46] = {56 48 83 ec 20 e8 76 f8 ff ff 48 0f bf 48 08 ff c9 48 0f bf f1 48 b9 d8 da 96 c7 f7 7f 00 00 e8 5c 2e b0 5e 66 89 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_Zx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a36b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 76 f8 ff ff}
...
001fh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c 2e b0 5e}
...
; dec_g[39] = {56 48 83 ec 20 e8 56 f8 ff ff 8b 70 08 ff ce 48 b9 e8 dd 96 c7 f7 7f 00 00 e8 12 2e b0 5e 89 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a36e0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 56 f8 ff ff}
...
0019h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 12 2e b0 5e}
...
; dec_g[39] = {56 48 83 ec 20 e8 46 f8 ff ff 8b 70 08 ff ce 48 b9 f8 e0 96 c7 f7 7f 00 00 e8 d2 2d b0 5e 89 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a3710h                      ; CALL rel32 || E8 cd || encoded[5]{e8 46 f8 ff ff}
000ah mov esi,[rax+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 70 08}
000dh dec esi                                 ; DEC r/m32 || o32 FF /1 || encoded[2]{ff ce}
000fh mov rcx,7ff7c796e0f8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 f8 e0 96 c7 f7 7f 00 00}
0019h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d2 2d b0 5e}
001eh mov [rax+8],esi                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 08}
0021h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0025h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0026h ret                                     ; RET || C3 || encoded[1]{c3}
...
; dec_g[42] = {56 48 83 ec 20 e8 36 f8 ff ff 48 8b 70 08 48 ff ce 48 b9 08 e4 96 c7 f7 7f 00 00 e8 90 2d b0 5e 48 89 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_Zx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a3740h                      ; CALL rel32 || E8 cd || encoded[5]{e8 36 f8 ff ff}
...
001bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 2d b0 5e}
...
; dec_g[42] = {56 48 83 ec 20 e8 26 f8 ff ff 48 8b 70 08 48 ff ce 48 b9 18 e7 96 c7 f7 7f 00 00 e8 50 2d b0 5e 48 89 70 08 48 83 c4 20 5e c3}
; TermCode = CTC_RET_Zx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h call 7ff7c73a3770h                      ; CALL rel32 || E8 cd || encoded[5]{e8 26 f8 ff ff}
000ah mov rsi,[rax+8]                         ; MOV r64, r/m64 || REX.W 8B /r || encoded[4]{48 8b 70 08}
000eh dec rsi                                 ; DEC r/m64 || REX.W FF /1 || encoded[3]{48 ff ce}
0011h mov rcx,7ff7c796e718h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 18 e7 96 c7 f7 7f 00 00}
001bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 50 2d b0 5e}
0020h mov [rax+8],rsi                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 70 08}
0024h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0028h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0029h ret                                     ; RET || C3 || encoded[1]{c3}
