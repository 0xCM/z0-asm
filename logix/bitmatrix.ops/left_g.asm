...
; left_gbm8x8u~in_bm8x8u~in[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 2d ad b5 5e 48 a5 48 8b c3 5b 5e 5f c3}
...
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2d ad b5 5e}
...
; left_gbm16x16u~in_bm16x16u~in[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 ed ac b5 5e 48 a5 48 8b c3 5b 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0008h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
000bh mov rsi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f2}
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ed ac b5 5e}
0013h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0015h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0018h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0019h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
; left_gbm32x32u~in_bm32x32u~in[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 ad ac b5 5e 48 a5 48 8b c3 5b 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0008h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
000bh mov rsi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f2}
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ad ac b5 5e}
0013h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0015h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0018h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0019h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
; left_gbm64x64u~in_bm64x64u~in[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 6d ac b5 5e 48 a5 48 8b c3 5b 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0008h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
000bh mov rsi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f2}
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6d ac b5 5e}
0013h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0015h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0018h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0019h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
004dh call 7ff816cf8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ae dc 5e 4e}
...
005bh call 7ff7c7762930h                      ; CALL rel32 || E8 cd || encoded[5]{e8 80 76 05 ff}
...
0050h call 7ff816cf8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2b dc 5e 4e}
...
005eh call 7ff7c7762930h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fd 75 05 ff}
...
0051h call 7ff816cf8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 aa db 5e 4e}
...
005fh call 7ff7c7762930h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7c 75 05 ff}
...
0051h call 7ff816cf8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2a db 5e 4e}
0056h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0059h add rsp,40h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 40}
005dh pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
005eh ret                                     ; RET || C3 || encoded[1]{c3}
005fh call 7ff7c7762930h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fc 74 05 ff}
0064h int 3                                   ; INT3 || CC || encoded[1]{cc}
