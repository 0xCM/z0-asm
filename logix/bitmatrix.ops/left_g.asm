...
; left_g[8u](bm8x8u~in,bm8x8u~in)[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 dd 0d be 5e 48 a5 48 8b c3 5b 5e 5f c3}
...
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd 0d be 5e}
...
; left_g[16u](bm16x16u~in,bm16x16u~in)[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 9d 0d be 5e 48 a5 48 8b c3 5b 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0008h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
000bh mov rsi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f2}
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9d 0d be 5e}
0013h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0015h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0018h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0019h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
; left_g[32u](bm32x32u~in,bm32x32u~in)[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 5d 0d be 5e 48 a5 48 8b c3 5b 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0008h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
000bh mov rsi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f2}
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5d 0d be 5e}
0013h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0015h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0018h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0019h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
; left_g[64u](bm64x64u~in,bm64x64u~in)[28] = {57 56 53 66 90 48 8b d9 48 8b fb 48 8b f2 e8 1d 0d be 5e 48 a5 48 8b c3 5b 5e 5f c3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0008h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
000bh mov rsi,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f2}
000eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d 0d be 5e}
0013h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0015h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0018h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0019h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
004dh call 7ff815ee8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5e 3d 86 4d}
...
005bh call 7ff7c77657c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c0 05 0e ff}
...
0050h call 7ff815ee8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 db 3c 86 4d}
...
005eh call 7ff7c77657c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3d 05 0e ff}
...
0051h call 7ff815ee8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5a 3c 86 4d}
...
005fh call 7ff7c77657c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bc 04 0e ff}
...
0051h call 7ff815ee8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 da 3b 86 4d}
0056h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0059h add rsp,40h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 40}
005dh pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
005eh ret                                     ; RET || C3 || encoded[1]{c3}
005fh call 7ff7c77657c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3c 04 0e ff}
0064h int 3                                   ; INT3 || CC || encoded[1]{cc}
