...
; true_gbm8x8u(in)_bm8x8u(in)[39] = {56 48 83 ec 30 48 8b f1 b9 ff 00 00 00 88 4c 24 28 48 8b ce 0f b6 54 24 28 e8 7a 3c ff ff 48 8b c6 48 83 c4 30 5e c3}
...
0019h call 7ff7c7359ae8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7a 3c ff ff}
...
; true_gbm16x16u(in)_bm16x16u(in)[40] = {56 48 83 ec 30 48 8b f1 b9 ff ff 00 00 66 89 4c 24 28 48 8b ce 0f b7 54 24 28 e8 f1 5c ff ff 48 8b c6 48 83 c4 30 5e c3}
; TermCode = RET_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,30h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 30}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
...
001ah call 7ff7c735bba0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f1 5c ff ff}
...
; true_gbm32x32u(in)_bm32x32u(in)[30] = {56 48 83 ec 20 48 8b f1 48 8b ce ba ff ff ff ff e8 73 70 ff ff 48 8b c6 48 83 c4 20 5e c3}
; TermCode = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
...
0010h call 7ff7c735cf58h                      ; CALL rel32 || E8 cd || encoded[5]{e8 73 70 ff ff}
...
; true_gbm64x64u(in)_bm64x64u(in)[35] = {56 48 83 ec 20 48 8b f1 48 8b ce 48 ba ff ff ff ff ff ff ff ff e8 a6 76 ff ff 48 8b c6 48 83 c4 20 5e c3}
; TermCode = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
...
0015h call 7ff7c735d5d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a6 76 ff ff}
