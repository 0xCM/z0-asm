...
; nor_g[8u](bm8x8u~in,bm8x8u~in)[104] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 48 8b f2 49 8b f8 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 e8 d7 c6 fc ff 48 8b 06 48 8b 17 48 8d 4c 24 20 48 8b 09 48 8b 00 48 8b 12 48 0b c2 48 f7 d0 48 89 01 48 8b fb 48 8d 74 24 20 e8 d5 99 ba 5e 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
...
002ch call 7ff7c8688b68h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d7 c6 fc ff}
...
0056h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d5 99 ba 5e}
...
002fh call 7ff7c8688bb8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 94 c6 fc ff}
...
008eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0d 99 ba 5e}
...
0026h vmovdqu xmmword ptr [rcx],xmm0          ; VMOVDQU xmm2/m128, xmm1 || VEX.128.F3.0F.WIG 7F /r || encoded[4]{c5 fa 7f 01}
002ah lea rcx,[rsp+70h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 70}
002fh call 7ff7c8688bd8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e4 c5 fc ff}
0034h mov rax,[rsi]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 06}
0037h mov rdx,[rdi]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 17}
003ah lea rcx,[rsp+70h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 70}
003fh mov rcx,[rcx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 09}
...
00b5h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 16 98 ba 5e}
...
0026h vmovdqu xmmword ptr [rcx],xmm0          ; VMOVDQU xmm2/m128, xmm1 || VEX.128.F3.0F.WIG 7F /r || encoded[4]{c5 fa 7f 01}
002ah lea rcx,[rsp+70h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 70}
002fh call 7ff7c8688bf8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 c5 fc ff}
0034h mov rax,[rsi]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 06}
0037h mov rdx,[rdi]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 17}
003ah lea rcx,[rsp+70h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 70}
003fh mov rcx,[rcx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 09}
...
00b6h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 15 97 ba 5e}
