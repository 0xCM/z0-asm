...
; true_1u_1u_1u[24] = {0f 1f 44 00 00 89 4c 24 08 89 54 24 10 44 89 44 24 18 b8 01 00 00 00 c3}
; TermCode = RET_SBB
...
------------------------------------------------------------------------------------------------------------------------
; bit true(bit a)
; true_1u[15] = {0f 1f 44 00 00 89 4c 24 08 b8 01 00 00 00 c3}
...
; true_1u_1u[19] = {0f 1f 44 00 00 89 4c 24 08 89 54 24 10 b8 01 00 00 00 c3}
; TermCode = RET_ZED_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov [rsp+8],ecx                         ; MOV r/m32, r32 || o32 89 /r || encoded[4]{89 4c 24 08}
0009h mov [rsp+10h],edx                       ; MOV r/m32, r32 || o32 89 /r || encoded[4]{89 54 24 10}
