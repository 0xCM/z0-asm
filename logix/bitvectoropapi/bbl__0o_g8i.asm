...
; bbl__0o_g8i[7ff7c6b5e840h, 7ff7c6b5ea31h][497] = {57 56 55 53 48 83 ec 28 8b f1 40 0f b6 c6 83 f8 0f 0f 87 59 01 00 00 8b c0 48 8d 0d d8 01 00 00 8b 0c 81 4c 8d 0d e0 ff ff ff 49 03 c9 ff e1 b8 ff ff ff ff e9 2e 01 00 00 33 c0 e9 27 01 00 00 48 0f be c2 49 0f be d0 4c 0f be c0 41 23 d0 48 0f be c2 e9 0f 01 00 00 48 0f be c2 49 0f be d0 4c 0f be c0 41 23 d0 8b c2 f7 d0 48 0f be c0 e9 f3 00 00 00 48 0f be c2 49 0f be d0 4c 0f be c0 41 0b d0 48 0f be c2 e9 db 00 00 00 48 0f be c2 49 0f be d0 4c 0f be c0 41 0b d0 8b c2 f7 d0 48 0f be c0 e9 bf 00 00 00 48 0f be c2 49 0f be d0 4c 0f be c0 41 33 d0 48 0f be c2 e9 a7 00 00 00 48 0f be c2 49 0f be d0 4c 0f be c0 41 33 d0 8b c2 f7 d0 48 0f be c0 e9 8b 00 00 00 48 0f be c2 e9 82 00 00 00 49 0f be c0 eb 7c 48 0f be c2 44 8b c0 41 f7 d0 49 0f be c0 eb 6c 49 0f be c0 8b d0 f7 d2 48 0f be c2 eb 5e 48 0f be c2 49 0f be d0 4c 0f be c0 8b c2 f7 d0 41 0b c0 48 0f be c0 eb 45 48 0f be c2 49 0f be d0 4c 0f be c0 c4 e2 38 f2 c2 48 0f be c0 eb 2e 48 0f be c2 49 0f be d0 4c 0f be c0 41 8b c0 f7 d0 0b c2 48 0f be c0 eb 15 48 0f be c2 49 0f be c8 48 0f be c0 c4 e2 70 f2 c0 48 0f be c0 48 83 c4 28 5b 5d 5e 5f c3 48 b9 c8 37 88 c6 f7 7f 00 00 e8 f1 82 34 5f 48 8b f8 40 88 77 08 48 b9 68 6f 34 c6 f7 7f 00 00 e8 1b 06 2f 5f 48 8b c8 e8 a3 fd eb ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 c2 82 34 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 ab 1b 47 5f 48 8b e8 8b ce e8 81 d5 83 ff 4c 8b c0 48 8b cd 48 8b d7 e8 1b 57 81 ff 48 8b d0 48 8b cb e8 e8 03 83 ff 48 8b cb e8 d0 ce 2b 5f cc}
; Capture completion code, ZEDx6
; 2020-01-24 02:54:45:377
...
0019h lea rcx,[7ff7c6b5ea38h]                 ; LEA r64, m || REX.W 8D /r || encoded[7]{48 8d 0d d8 01 00 00}
0020h mov ecx,[rcx+rax*4]                     ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 0c 81}
0023h lea r9,[7ff7c6b5e84ah]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d e0 ff ff ff}
...
017ah call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f1 82 34 5f}
017fh mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
0182h mov [rdi+8],sil                         ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 77 08}
0186h mov rcx,7ff7c6346f68h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 68 6f 34 c6 f7 7f 00 00}
0190h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1b 06 2f 5f}
0195h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
0198h call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a3 fd eb ff}
...
01a9h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c2 82 34 5f}
...
01c0h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ab 1b 47 5f}
01c5h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
01c8h mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
01cah call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 81 d5 83 ff}
...
01d8h call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1b 57 81 ff}
...
01e3h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e8 03 83 ff}
01e8h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
01ebh call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d0 ce 2b 5f}
