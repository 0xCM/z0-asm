...
; evalspec__0o_g32i[7ff7c6b72380h, 7ff7c6b724feh][382] = {57 56 55 53 48 83 ec 28 8b f1 8b c2 41 8b d0 40 0f b6 ce 83 f9 0f 0f 87 9f 00 00 00 8b c9 4c 8d 05 1b 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 b8 ff ff ff ff eb 74 33 c0 eb 70 8b c8 e8 f0 f8 ff ff eb 67 8b c8 e8 37 f8 ff ff eb 5e 8b c8 e8 9e f8 ff ff eb 55 8b c8 e8 85 f8 ff ff eb 4c 8b c8 e8 9c f8 ff ff eb 43 8b c8 e8 63 f8 ff ff eb 3a eb 38 8b c2 eb 34 8b c8 e8 24 f8 ff ff eb 2b 8b c8 e8 3b f8 ff ff eb 22 8b c8 e8 22 f8 ff ff eb 19 8b c8 e8 79 f8 ff ff eb 10 8b c8 e8 f0 f7 ff ff eb 07 8b c8 e8 77 f8 ff ff 90 48 83 c4 28 5b 5d 5e 5f c3 48 b9 b0 c7 91 c6 f7 7f 00 00 e8 66 48 33 5f 48 8b f8 40 88 77 08 48 b9 08 8f 36 c6 f7 7f 00 00 e8 90 cb 2d 5f 48 8b c8 e8 f8 a0 ea ff 8b f0 48 b9 38 2a 5b c6 f7 7f 00 00 e8 37 48 33 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 20 e1 45 5f 48 8b e8 8b ce e8 be 9c ea ff 4c 8b c0 48 8b cd 48 8b d7 e8 90 1c 82 ff 48 8b d0 48 8b cb e8 ad b3 83 ff 48 8b cb e8 45 94 2a 5f cc 00 00 00 00 2e 00 00 00 32 00 00 00 9b 00 00 00 68 00 00 00 89 00 00 00 6a 00 00 00 56 00 00 00 44 00 00 00 4d 00 00 00 5f 00 00 00 77 00 00 00 80 00 00 00 6e 00 00 00 92 00 00 00 3b 00 00 00 27 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-25 02:10:39:138
...
001eh lea r8,[7ff7c6b724c0h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 05 1b 01 00 00}
0025h mov r8d,[r8+rcx*4]                      ; MOV r32, r/m32 || o32 8B /r || encoded[4]{45 8b 04 88}
0029h lea r9,[7ff7c6b7238fh]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d df ff ff ff}
...
00c5h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 66 48 33 5f}
...
00dbh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 cb 2d 5f}
00e0h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00e3h call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f8 a0 ea ff}
...
00f4h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 37 48 33 5f}
...
010bh call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 20 e1 45 5f}
0110h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
0113h mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
0115h call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 be 9c ea ff}
...
0123h call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 1c 82 ff}
...
012eh call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ad b3 83 ff}
0133h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0136h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 45 94 2a 5f}
