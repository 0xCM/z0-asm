...
; evalspec__0o_g16u[7ff7c6b622b0h, 7ff7c6b6242eh][382] = {57 56 55 53 48 83 ec 28 8b f1 8b c2 41 8b d0 40 0f b6 ce 83 f9 0f 0f 87 a3 00 00 00 8b c9 4c 8d 05 1b 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 b8 ff ff 00 00 eb 78 33 c0 eb 74 8b c8 e8 18 f9 ff ff eb 6b 8b c8 e8 5f f8 ff ff eb 62 8b c8 e8 c6 f8 ff ff eb 59 8b c8 e8 ad f8 ff ff eb 50 8b c8 e8 c4 f8 ff ff eb 47 8b c8 e8 8b f8 ff ff eb 3e 0f b7 c0 eb 39 0f b7 c2 eb 34 8b c8 e8 48 f8 ff ff eb 2b 8b c8 e8 5f f8 ff ff eb 22 8b c8 e8 46 f8 ff ff eb 19 8b c8 e8 9d f8 ff ff eb 10 8b c8 e8 14 f8 ff ff eb 07 8b c8 e8 9b f8 ff ff 90 48 83 c4 28 5b 5d 5e 5f c3 48 b9 c8 37 88 c6 f7 7f 00 00 e8 32 49 34 5f 48 8b f8 40 88 77 08 48 b9 38 87 34 c6 f7 7f 00 00 e8 5c cc 2e 5f 48 8b c8 e8 e4 c3 eb ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 03 49 34 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 ec e1 46 5f 48 8b e8 8b ce e8 c2 9b 83 ff 4c 8b c0 48 8b cd 48 8b d7 e8 5c 1d 81 ff 48 8b d0 48 8b cb e8 29 ca 82 ff 48 8b cb e8 11 95 2b 5f cc 2e 00 00 00 32 00 00 00 9f 00 00 00 68 00 00 00 8d 00 00 00 6d 00 00 00 56 00 00 00 44 00 00 00 4d 00 00 00 5f 00 00 00 7b 00 00 00 84 00 00 00 72 00 00 00 96 00 00 00 3b 00 00 00 27 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-24 02:54:45:415
...
001eh lea r8,[7ff7c6b623f0h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 05 1b 01 00 00}
0025h mov r8d,[r8+rcx*4]                      ; MOV r32, r/m32 || o32 8B /r || encoded[4]{45 8b 04 88}
0029h lea r9,[7ff7c6b622bfh]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d df ff ff ff}
...
00c9h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 32 49 34 5f}
...
00dfh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c cc 2e 5f}
00e4h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00e7h call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e4 c3 eb ff}
...
00f8h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 03 49 34 5f}
...
010fh call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec e1 46 5f}
0114h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
0117h mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
0119h call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c2 9b 83 ff}
...
0127h call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c 1d 81 ff}
...
0132h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 29 ca 82 ff}
0137h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
013ah call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 11 95 2b 5f}
