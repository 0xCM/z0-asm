...
; evalspec__0o_g64i[7ff7c6b72af0h, 7ff7c6b72c86h][406] = {57 56 55 53 48 83 ec 28 8b f1 48 8b c2 49 8b d0 40 0f b6 ce 83 f9 0f 0f 87 b7 00 00 00 8b c9 4c 8d 05 32 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 48 b8 ff ff ff ff ff ff ff ff e9 84 00 00 00 33 c0 e9 7d 00 00 00 48 8b c8 e8 5b fb ff ff eb 73 48 8b c8 e8 a1 fa ff ff eb 69 48 8b c8 e8 07 fb ff ff eb 5f 48 8b c8 e8 ed fa ff ff eb 55 48 8b c8 e8 03 fb ff ff eb 4b 48 8b c8 e8 c9 fa ff ff eb 41 eb 3f 48 8b c2 eb 3a 48 8b c8 e8 88 fa ff ff eb 30 48 8b c8 e8 9e fa ff ff eb 26 48 8b c8 e8 84 fa ff ff eb 1c 48 8b c8 e8 da fa ff ff eb 12 48 8b c8 e8 50 fa ff ff eb 08 48 8b c8 e8 d6 fa ff ff 90 48 83 c4 28 5b 5d 5e 5f c3 48 b9 b0 c7 91 c6 f7 7f 00 00 e8 dd 40 33 5f 48 8b f8 40 88 77 08 48 b9 a8 9e 36 c6 f7 7f 00 00 e8 07 c4 2d 5f 48 8b c8 e8 6f 99 ea ff 8b f0 48 b9 38 2a 5b c6 f7 7f 00 00 e8 ae 40 33 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 97 d9 45 5f 48 8b e8 8b ce e8 35 95 ea ff 4c 8b c0 48 8b cd 48 8b d7 e8 07 15 82 ff 48 8b d0 48 8b cb e8 24 ac 83 ff 48 8b cb e8 bc 8c 2a 5f cc 00 00 00 36 00 00 00 3d 00 00 00 b2 00 00 00 79 00 00 00 9e 00 00 00 7b 00 00 00 65 00 00 00 51 00 00 00 5b 00 00 00 6f 00 00 00 8a 00 00 00 94 00 00 00 80 00 00 00 a8 00 00 00 47 00 00 00 27 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-25 02:10:39:145
...
001fh lea r8,[7ff7c6b72c48h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 05 32 01 00 00}
0026h mov r8d,[r8+rcx*4]                      ; MOV r32, r/m32 || o32 8B /r || encoded[4]{45 8b 04 88}
002ah lea r9,[7ff7c6b72b00h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d df ff ff ff}
...
00deh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd 40 33 5f}
00e3h mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
00e6h mov [rdi+8],sil                         ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 77 08}
00eah mov rcx,7ff7c6369ea8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a8 9e 36 c6 f7 7f 00 00}
00f4h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 07 c4 2d 5f}
00f9h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00fch call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6f 99 ea ff}
...
010dh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ae 40 33 5f}
...
0124h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 97 d9 45 5f}
0129h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
012ch mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
012eh call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 35 95 ea ff}
...
013ch call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 07 15 82 ff}
...
0147h call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 24 ac 83 ff}
014ch mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
014fh call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bc 8c 2a 5f}
...
015bh add [7ff778b72c51h],bh                  ; ADD r/m8, r8 || 00 /r || encoded[6]{00 3d 00 00 00 b2}
