...
; evalspec__0o_g64u[7ff7c6b62d50h, 7ff7c6b62ee6h][406] = {57 56 55 53 48 83 ec 28 8b f1 48 8b c2 49 8b d0 40 0f b6 ce 83 f9 0f 0f 87 b7 00 00 00 8b c9 4c 8d 05 32 01 00 00 45 8b 04 88 4c 8d 0d df ff ff ff 4d 03 c1 41 ff e0 48 b8 ff ff ff ff ff ff ff ff e9 84 00 00 00 33 c0 e9 7d 00 00 00 48 8b c8 e8 1b fc ff ff eb 73 48 8b c8 e8 b1 f0 ff ff eb 69 48 8b c8 e8 c7 fb ff ff eb 5f 48 8b c8 e8 ad fb ff ff eb 55 48 8b c8 e8 c3 fb ff ff eb 4b 48 8b c8 e8 89 fb ff ff eb 41 eb 3f 48 8b c2 eb 3a 48 8b c8 e8 98 f0 ff ff eb 30 48 8b c8 e8 5e fb ff ff eb 26 48 8b c8 e8 44 fb ff ff eb 1c 48 8b c8 e8 9a fb ff ff eb 12 48 8b c8 e8 60 f0 ff ff eb 08 48 8b c8 e8 96 fb ff ff 90 48 83 c4 28 5b 5d 5e 5f c3 48 b9 c8 37 88 c6 f7 7f 00 00 e8 7d 3e 34 5f 48 8b f8 40 88 77 08 48 b9 78 a6 34 c6 f7 7f 00 00 e8 a7 c1 2e 5f 48 8b c8 e8 2f b9 eb ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 4e 3e 34 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 37 d7 46 5f 48 8b e8 8b ce e8 0d 91 83 ff 4c 8b c0 48 8b cd 48 8b d7 e8 a7 12 81 ff 48 8b d0 48 8b cb e8 74 bf 82 ff 48 8b cb e8 5c 8a 2b 5f cc 00 00 00 36 00 00 00 3d 00 00 00 b2 00 00 00 79 00 00 00 9e 00 00 00 7b 00 00 00 65 00 00 00 51 00 00 00 5b 00 00 00 6f 00 00 00 8a 00 00 00 94 00 00 00 80 00 00 00 a8 00 00 00 47 00 00 00 27 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-24 02:54:45:424
...
001fh lea r8,[7ff7c6b62ea8h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 05 32 01 00 00}
0026h mov r8d,[r8+rcx*4]                      ; MOV r32, r/m32 || o32 8B /r || encoded[4]{45 8b 04 88}
002ah lea r9,[7ff7c6b62d60h]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d df ff ff ff}
...
00deh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7d 3e 34 5f}
...
00f4h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a7 c1 2e 5f}
00f9h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00fch call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2f b9 eb ff}
...
010dh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4e 3e 34 5f}
...
0124h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 37 d7 46 5f}
0129h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
012ch mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
012eh call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0d 91 83 ff}
...
013ch call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a7 12 81 ff}
...
0147h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 74 bf 82 ff}
014ch mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
014fh call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c 8a 2b 5f}
...
015bh add [7ff778b62eb1h],bh                  ; ADD r/m8, r8 || 00 /r || encoded[6]{00 3d 00 00 00 b2}
