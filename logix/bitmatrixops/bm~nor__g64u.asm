...
002fh call 7ff7c6a32958h                      ; CALL rel32 || E8 cd || encoded[5]{e8 44 f3 ec ff}
...
00b6h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f5 27 34 5f}
