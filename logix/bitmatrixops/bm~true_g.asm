...
; bm~true_g8u_8u[39] = {56 48 83 ec 30 48 8b f1 b9 ff 00 00 00 88 4c 24 28 48 8b ce 0f b6 54 24 28 e8 92 ad fe ff 48 8b c6 48 83 c4 30 5e c3}
...
0019h call 7ff7c6b70430h                      ; CALL rel32 || E8 cd || encoded[5]{e8 92 ad fe ff}
...
; bm~true_g8i_8i[30] = {56 48 83 ec 20 48 8b f1 ba ff ff ff ff 48 8b ce e8 eb d8 fe ff 48 8b c6 48 83 c4 20 5e c3}
...
0010h call 7ff7c6b72fc0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 eb d8 fe ff}
...
; bm~true_g16u_16u[40] = {56 48 83 ec 30 48 8b f1 b9 ff ff 00 00 66 89 4c 24 28 48 8b ce 0f b7 54 24 28 e8 71 e5 fe ff 48 8b c6 48 83 c4 30 5e c3}
...
001ah call 7ff7c6b73c90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 71 e5 fe ff}
...
; bm~true_g16i_16i[30] = {56 48 83 ec 20 48 8b f1 ba ff ff ff ff 48 8b ce e8 93 f7 fe ff 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
0008h mov edx,0ffffffffh                      ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba ff ff ff ff}
000dh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
0010h call 7ff7c6b74ee8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 93 f7 fe ff}
0015h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0018h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
001ch pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
001dh ret                                     ; RET || C3 || encoded[1]{c3}
...
; bm~true_g32u_32u[30] = {56 48 83 ec 20 48 8b f1 48 8b ce ba ff ff ff ff e8 03 05 ff ff 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
...
0010h call 7ff7c6b75c98h                      ; CALL rel32 || E8 cd || encoded[5]{e8 03 05 ff ff}
0015h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0018h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
001ch pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
001dh ret                                     ; RET || C3 || encoded[1]{c3}
...
; bm~true_g32i_32i[30] = {56 48 83 ec 20 48 8b f1 48 8b ce ba ff ff ff ff e8 d3 20 ff ff 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code = RET_ZEDx3
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
0008h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
000bh mov edx,0ffffffffh                      ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba ff ff ff ff}
0010h call 7ff7c6b778a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d3 20 ff ff}
0015h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0018h add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
001ch pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
001dh ret                                     ; RET || C3 || encoded[1]{c3}
...
; bm~true_g64u_64u[35] = {56 48 83 ec 20 48 8b f1 48 8b ce 48 ba ff ff ff ff ff ff ff ff e8 c6 25 ff ff 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
...
0015h call 7ff7c6b77de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c6 25 ff ff}
...
; bm~true_g64i_64i[35] = {56 48 83 ec 20 48 8b f1 48 8b ce 48 ba ff ff ff ff ff ff ff ff e8 26 32 ff ff 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code = RET_ZED_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
0008h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
000bh mov rdx,0ffffffffffffffffh              ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba ff ff ff ff ff ff ff ff}
0015h call 7ff7c6b78a80h                      ; CALL rel32 || E8 cd || encoded[5]{e8 26 32 ff ff}
001ah mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
001dh add rsp,20h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 20}
0021h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0022h ret                                     ; RET || C3 || encoded[1]{c3}
