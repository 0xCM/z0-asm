...
; bm~xor__g64i[7ff7c6b64270h, 7ff7c6b642ceh][94] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 48 8b f2 49 8b f8 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 e8 bf ee ec ff 48 8b 0e 48 8b 17 4c 8d 44 24 20 4d 8b 00 e8 6c 0a ff ff 48 8b fb 48 8d 74 24 20 e8 cf 1b 34 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:10:38:538
...
002ch call 7ff7c6a33160h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bf ee ec ff}
...
003fh call 7ff7c6b54d20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6c 0a ff ff}
...
004ch call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cf 1b 34 5f}
