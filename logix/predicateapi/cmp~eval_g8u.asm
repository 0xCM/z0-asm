...
; cmp~eval_g8u[7ff7c6ceead0h, 7ff7c6ceebdeh][270] = {57 56 55 53 48 83 ec 28 8b f1 40 0f b6 c6 ff c8 83 f8 05 77 61 8b c0 48 8d 0d da 00 00 00 8b 0c 81 4c 8d 0d e2 ff ff ff 49 03 c9 ff e1 49 3b d0 0f 94 c0 0f b6 c0 eb 35 49 3b d0 0f 95 c0 0f b6 c0 eb 2a 49 3b d0 0f 9c c0 0f b6 c0 eb 1f 49 3b d0 0f 9e c0 0f b6 c0 eb 14 49 3b d0 0f 9f c0 0f b6 c0 eb 09 49 3b d0 0f 9d c0 0f b6 c0 48 83 c4 28 5b 5d 5e 5f c3 48 b9 48 d5 88 c6 f7 7f 00 00 e8 5b 81 1b 5f 48 8b f8 40 88 77 08 48 b9 a8 9e 34 c6 f7 7f 00 00 e8 85 04 16 5f 48 8b c8 e8 0d fc d2 ff 8b f0 48 b9 50 58 58 c6 f7 7f 00 00 e8 2c 81 1b 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 15 1a 2e 5f 48 8b e8 8b ce e8 eb d3 6a ff 4c 8b c0 48 8b cd 48 8b d7 e8 85 55 68 ff 48 8b d0 48 8b cb e8 52 02 6a ff 48 8b cb e8 3a cd 12 5f cc 00 23 00 00 00 39 00 00 00 44 00 00 00 4f 00 00 00 5a 00 00 00 2e 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-24 02:54:56:862
...
0017h lea rcx,[7ff7c6ceebc8h]                 ; LEA r64, m || REX.W 8D /r || encoded[7]{48 8d 0d da 00 00 00}
001eh mov ecx,[rcx+rax*4]                     ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 0c 81}
0021h lea r9,[7ff7c6ceeadah]                  ; LEA r64, m || REX.W 8D /r || encoded[7]{4c 8d 0d e2 ff ff ff}
...
0076h mov rcx,7ff7c688d548h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 48 d5 88 c6 f7 7f 00 00}
0080h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5b 81 1b 5f}
...
0096h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 85 04 16 5f}
009bh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
009eh call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0d fc d2 ff}
00a3h mov esi,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f0}
00a5h mov rcx,7ff7c6585850h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 50 58 58 c6 f7 7f 00 00}
00afh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2c 81 1b 5f}
...
00bch mov rdx,7ff7c65ad200h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 00 d2 5a c6 f7 7f 00 00}
00c6h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 15 1a 2e 5f}
00cbh mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
00ceh mov ecx,esi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b ce}
00d0h call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 eb d3 6a ff}
...
00deh call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 85 55 68 ff}
...
00e9h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 52 02 6a ff}
00eeh mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
00f1h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3a cd 12 5f}
