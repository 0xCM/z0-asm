...
; bm~ubl~eval~byref__0o_g16i[7ff7c6a36080h, 7ff7c6a361ach][300] = {57 56 55 53 48 83 ec 48 c5 f8 77 33 c0 48 89 44 24 38 48 89 44 24 28 48 8b d9 8b ea 49 8b f1 40 80 fd 01 74 5f 40 80 fd 02 0f 85 7c 00 00 00 c5 fa 6f 06 c5 fa 7f 44 24 28 c4 c1 7a 6f 00 c5 fa 7f 44 24 38 4c 8d 44 24 38 49 8b 10 45 8b 40 08 48 8d 4c 24 28 48 8b 01 8b 49 08 44 3b c1 77 45 48 8b c8 4d 63 c0 49 d1 e0 e8 62 2e 49 4f 48 8b fb e8 9a fd 46 5f 48 a5 48 8b c3 48 83 c4 48 5b 5d 5e 5f c3 49 8b 08 48 8b 16 e8 11 d7 ff ff 48 8b fb e8 79 fd 46 5f 48 a5 48 8b c3 48 83 c4 48 5b 5d 5e 5f c3 e8 16 c9 94 ff cc 48 b9 00 6a 88 c6 f7 7f 00 00 e8 76 0b 47 5f 48 8b f0 40 88 6e 08 48 b9 48 7f 34 c6 f7 7f 00 00 e8 a0 8e 41 5f 48 8b c8 e8 28 86 fe ff 8b f8 48 b9 50 58 58 c6 f7 7f 00 00 e8 47 0b 47 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 30 a4 59 5f 48 8b e8 8b cf e8 06 5e 96 ff 4c 8b c0 48 8b cd 48 8b d6 e8 a0 df 93 ff 48 8b d0 48 8b cb e8 6d 8c 95 ff 48 8b cb e8 55 57 3e 5f cc}
; Capture completion code, INTRx2
; 2020-01-24 02:54:43:772
...
0069h call 7ff815ec8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 62 2e 49 4f}
006eh mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0071h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9a fd 46 5f}
...
008ah call 7ff7c6a33820h                      ; CALL rel32 || E8 cd || encoded[5]{e8 11 d7 ff ff}
008fh mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0092h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 79 fd 46 5f}
...
00a5h call 7ff7c6382a40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 16 c9 94 ff}
00aah int 3                                   ; INT3 || CC || encoded[1]{cc}
00abh mov rcx,7ff7c6886a00h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 00 6a 88 c6 f7 7f 00 00}
00b5h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 76 0b 47 5f}
...
00cbh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a0 8e 41 5f}
00d0h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00d3h call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 28 86 fe ff}
00d8h mov edi,eax                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b f8}
00dah mov rcx,7ff7c6585850h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 50 58 58 c6 f7 7f 00 00}
00e4h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 47 0b 47 5f}
...
00f1h mov rdx,7ff7c65ad200h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 00 d2 5a c6 f7 7f 00 00}
00fbh call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 30 a4 59 5f}
0100h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
0103h mov ecx,edi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b cf}
0105h call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 06 5e 96 ff}
...
0113h call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a0 df 93 ff}
...
011eh call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6d 8c 95 ff}
0123h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0126h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 55 57 3e 5f}
