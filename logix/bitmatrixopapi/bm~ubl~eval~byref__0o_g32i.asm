...
; bm~ubl~eval~byref__0o_g32i[7ff7c6a34770h, 7ff7c6a3489dh][301] = {57 56 55 53 48 83 ec 48 c5 f8 77 33 c0 48 89 44 24 38 48 89 44 24 28 48 8b d9 8b ea 49 8b f1 40 80 fd 01 74 60 40 80 fd 02 0f 85 7d 00 00 00 c5 fa 6f 06 c5 fa 7f 44 24 28 c4 c1 7a 6f 00 c5 fa 7f 44 24 38 4c 8d 44 24 38 49 8b 10 45 8b 40 08 48 8d 4c 24 28 48 8b 01 8b 49 08 44 3b c1 77 46 48 8b c8 4d 63 c0 49 c1 e0 02 e8 71 47 49 4f 48 8b fb e8 a9 16 47 5f 48 a5 48 8b c3 48 83 c4 48 5b 5d 5e 5f c3 49 8b 08 48 8b 16 e8 58 df ff ff 48 8b fb e8 88 16 47 5f 48 a5 48 8b c3 48 83 c4 48 5b 5d 5e 5f c3 e8 25 e2 96 ff cc 48 b9 e8 f9 91 c6 f7 7f 00 00 e8 85 24 47 5f 48 8b f0 40 88 6e 08 48 b9 08 8f 36 c6 f7 7f 00 00 e8 af a7 41 5f 48 8b c8 e8 17 7d fe ff 8b f8 48 b9 38 2a 5b c6 f7 7f 00 00 e8 56 24 47 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 3f bd 59 5f 48 8b e8 8b cf e8 dd 78 fe ff 4c 8b c0 48 8b cd 48 8b d6 e8 af f8 95 ff 48 8b d0 48 8b cb e8 cc 8f 97 ff 48 8b cb e8 64 70 3e 5f cc}
; Capture completion code, INTRx2
; 2020-01-25 02:10:37:205
...
006ah call 7ff815ec8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 71 47 49 4f}
006fh mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0072h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a9 16 47 5f}
...
008bh call 7ff7c6a32758h                      ; CALL rel32 || E8 cd || encoded[5]{e8 58 df ff ff}
0090h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0093h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 88 16 47 5f}
...
00a6h call 7ff7c63a2a40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 25 e2 96 ff}
...
00b6h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 85 24 47 5f}
...
00cch call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 af a7 41 5f}
00d1h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00d4h call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 17 7d fe ff}
...
00e5h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 56 24 47 5f}
...
00fch call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3f bd 59 5f}
0101h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
0104h mov ecx,edi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b cf}
0106h call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd 78 fe ff}
...
0114h call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 af f8 95 ff}
...
011fh call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cc 8f 97 ff}
0124h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0127h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 64 70 3e 5f}
