...
; bm~ubl~eval~byref__0o_g32u[7ff7c6a345d0h, 7ff7c6a34748h][376] = {57 56 55 53 48 83 ec 78 c5 f8 77 33 c0 48 89 44 24 30 48 89 44 24 20 48 8b d9 8b ea 49 8b f1 40 80 fd 01 74 67 40 80 fd 02 0f 85 c8 00 00 00 c5 fa 6f 06 c5 fa 7f 44 24 20 c4 c1 7a 6f 00 c5 fa 7f 44 24 30 4c 8d 44 24 30 49 8b 10 45 8b 40 08 48 8d 4c 24 20 48 8b 01 8b 49 08 44 3b c1 0f 87 8d 00 00 00 48 8b c8 4d 63 c0 49 c1 e0 02 e8 0d 49 49 4f 48 8b fb e8 45 18 47 5f 48 a5 48 8b c3 c5 f8 77 48 83 c4 78 5b 5d 5e 5f c3 49 8b 00 48 8b 16 33 c9 45 33 c0 4d 63 c8 49 c1 e1 02 4e 8d 14 08 c5 fc 57 c0 c5 fd 11 44 24 40 c4 c1 7f f0 02 c5 fd 11 44 24 40 c5 fd 10 44 24 40 c5 fd 76 c8 c5 fd ef c1 4c 03 ca c4 c1 7e 7f 01 ff c1 41 83 c0 08 83 f9 04 7c bf 48 8b fb e8 e0 17 47 5f 48 a5 48 8b c3 c5 f8 77 48 83 c4 78 5b 5d 5e 5f c3 e8 7a e3 96 ff cc 48 b9 e8 f9 91 c6 f7 7f 00 00 e8 da 25 47 5f 48 8b f0 40 88 6e 08 48 b9 d8 96 36 c6 f7 7f 00 00 e8 04 a9 41 5f 48 8b c8 e8 6c 7e fe ff 8b f8 48 b9 38 2a 5b c6 f7 7f 00 00 e8 ab 25 47 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 94 be 59 5f 48 8b e8 8b cf e8 32 7a fe ff 4c 8b c0 48 8b cd 48 8b d6 e8 04 fa 95 ff 48 8b d0 48 8b cb e8 21 91 97 ff 48 8b cb e8 b9 71 3e 5f cc}
; Capture completion code, INTRx2
; 2020-01-25 02:10:37:202
...
006eh call 7ff815ec8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0d 49 49 4f}
0073h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0076h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 45 18 47 5f}
...
00dbh call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e0 17 47 5f}
...
00f1h call 7ff7c63a2a40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7a e3 96 ff}
00f6h int 3                                   ; INT3 || CC || encoded[1]{cc}
00f7h mov rcx,7ff7c691f9e8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e8 f9 91 c6 f7 7f 00 00}
0101h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 da 25 47 5f}
...
0117h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 a9 41 5f}
011ch mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
011fh call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6c 7e fe ff}
...
0130h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ab 25 47 5f}
...
013dh mov rdx,7ff7c68117f0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba f0 17 81 c6 f7 7f 00 00}
0147h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 94 be 59 5f}
014ch mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
014fh mov ecx,edi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b cf}
0151h call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 32 7a fe ff}
...
015fh call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 fa 95 ff}
...
016ah call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 21 91 97 ff}
016fh mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0172h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b9 71 3e 5f}
