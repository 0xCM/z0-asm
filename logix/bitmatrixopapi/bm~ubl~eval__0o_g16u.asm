...
; bm~ubl~eval__0o_g16u[7ff7c6a31370h, 7ff7c6a3149ah][298] = {57 56 55 53 48 83 ec 58 c5 f8 77 33 c0 48 89 44 24 48 48 8b d9 8b ea 49 8b f0 40 80 fd 01 74 23 40 80 fd 02 0f 85 7f 00 00 00 48 8b fb e8 ee 4a 47 5f 48 a5 48 8b c3 c5 f8 77 48 83 c4 58 5b 5d 5e 5f c3 48 8d 4c 24 48 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 48 e8 de ac ff ff 48 8b 06 48 8d 54 24 48 48 8b 12 c5 fc 57 c0 c5 fd 11 44 24 20 c5 ff f0 00 c5 fd 11 44 24 20 c5 fd 10 44 24 20 c5 fd 75 c8 c5 fd ef c1 c5 fe 7f 02 48 8b fb 48 8d 74 24 48 e8 88 4a 47 5f 48 a5 48 8b c3 c5 f8 77 48 83 c4 58 5b 5d 5e 5f c3 48 b9 e8 f9 91 c6 f7 7f 00 00 e8 88 58 47 5f 48 8b f0 40 88 6e 08 48 b9 38 87 36 c6 f7 7f 00 00 e8 b2 db 41 5f 48 8b c8 e8 1a b1 fe ff 8b f8 48 b9 38 2a 5b c6 f7 7f 00 00 e8 59 58 47 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 42 f1 59 5f 48 8b e8 8b cf e8 e0 ac fe ff 4c 8b c0 48 8b cd 48 8b d6 e8 b2 2c 96 ff 48 8b d0 48 8b cb e8 cf c3 97 ff 48 8b cb e8 67 a4 3e 5f cc}
; Capture completion code, INTRx2
; 2020-01-25 02:10:37:169
...
002dh call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ee 4a 47 5f}
...
0055h call 7ff7c6a2c0a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 de ac ff ff}
...
0093h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 88 4a 47 5f}
...
00a9h mov rcx,7ff7c691f9e8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e8 f9 91 c6 f7 7f 00 00}
00b3h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 88 58 47 5f}
...
00c9h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 db 41 5f}
00ceh mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00d1h call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1a b1 fe ff}
...
00e2h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 59 58 47 5f}
...
00efh mov rdx,7ff7c68117f0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba f0 17 81 c6 f7 7f 00 00}
00f9h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 42 f1 59 5f}
00feh mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
0101h mov ecx,edi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b cf}
0103h call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e0 ac fe ff}
...
0111h call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 2c 96 ff}
...
011ch call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 cf c3 97 ff}
0121h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
0124h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 67 a4 3e 5f}
