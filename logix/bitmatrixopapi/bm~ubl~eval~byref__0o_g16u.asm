...
; bm~ubl~eval~byref__0o_g16u[7ff7c6a33dd0h, 7ff7c6a33f23h][339] = {57 56 55 53 48 83 ec 78 c5 f8 77 33 c0 48 89 44 24 30 48 89 44 24 20 48 8b d9 8b ea 49 8b f1 40 80 fd 01 74 62 40 80 fd 02 0f 85 a3 00 00 00 c5 fa 6f 06 c5 fa 7f 44 24 20 c4 c1 7a 6f 00 c5 fa 7f 44 24 30 4c 8d 44 24 30 49 8b 10 45 8b 40 08 48 8d 4c 24 20 48 8b 01 8b 49 08 44 3b c1 77 6c 48 8b c8 4d 63 c0 49 d1 e0 e8 12 51 49 4f 48 8b fb e8 4a 20 47 5f 48 a5 48 8b c3 c5 f8 77 48 83 c4 78 5b 5d 5e 5f c3 49 8b 00 48 8b 16 c5 fc 57 c0 c5 fd 11 44 24 40 c5 ff f0 00 c5 fd 11 44 24 40 c5 fd 10 44 24 40 c5 fd 75 c8 c5 fd ef c1 c5 fe 7f 02 48 8b fb e8 05 20 47 5f 48 a5 48 8b c3 c5 f8 77 48 83 c4 78 5b 5d 5e 5f c3 e8 9f eb 96 ff cc 48 b9 e8 f9 91 c6 f7 7f 00 00 e8 ff 2d 47 5f 48 8b f0 40 88 6e 08 48 b9 38 87 36 c6 f7 7f 00 00 e8 29 b1 41 5f 48 8b c8 e8 91 86 fe ff 8b f8 48 b9 38 2a 5b c6 f7 7f 00 00 e8 d0 2d 47 5f 48 8b d8 b9 68 04 00 00 48 ba f0 17 81 c6 f7 7f 00 00 e8 b9 c6 59 5f 48 8b e8 8b cf e8 57 82 fe ff 4c 8b c0 48 8b cd 48 8b d6 e8 29 02 96 ff 48 8b d0 48 8b cb e8 46 99 97 ff 48 8b cb e8 de 79 3e 5f cc}
; Capture completion code, INTRx2
; 2020-01-25 02:10:37:196
...
0069h call 7ff815ec8f50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 12 51 49 4f}
006eh mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0071h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4a 20 47 5f}
...
00b6h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 05 20 47 5f}
...
00cch call 7ff7c63a2a40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9f eb 96 ff}
00d1h int 3                                   ; INT3 || CC || encoded[1]{cc}
00d2h mov rcx,7ff7c691f9e8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e8 f9 91 c6 f7 7f 00 00}
00dch call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ff 2d 47 5f}
...
00f2h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 29 b1 41 5f}
00f7h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00fah call 7ff7c6a1c560h                      ; CALL rel32 || E8 cd || encoded[5]{e8 91 86 fe ff}
...
010bh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d0 2d 47 5f}
...
0118h mov rdx,7ff7c68117f0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba f0 17 81 c6 f7 7f 00 00}
0122h call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b9 c6 59 5f}
0127h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
012ah mov ecx,edi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b cf}
012ch call 7ff7c6a1c158h                      ; CALL rel32 || E8 cd || encoded[5]{e8 57 82 fe ff}
...
013ah call 7ff7c6394138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 29 02 96 ff}
...
0145h call 7ff7c63ad860h                      ; CALL rel32 || E8 cd || encoded[5]{e8 46 99 97 ff}
014ah mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
014dh call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 de 79 3e 5f}
