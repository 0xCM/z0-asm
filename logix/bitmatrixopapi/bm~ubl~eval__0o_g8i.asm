...
; bm~ubl~eval__0o_g8i[7ff7c6a2e820h, 7ff7c6a2e91fh][255] = {57 56 55 53 48 83 ec 38 c5 f8 77 33 c0 48 89 44 24 28 48 8b d9 8b ea 49 8b f0 40 80 fd 01 74 1c 40 80 fd 02 75 58 48 8b fb e8 42 76 47 5f 48 a5 48 8b c3 48 83 c4 38 5b 5d 5e 5f c3 48 8d 4c 24 28 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 28 e8 35 eb ff ff 48 8b 0e 48 8d 54 24 28 48 8b 12 e8 35 eb ff ff 48 8b fb 48 8d 74 24 28 e8 00 76 47 5f 48 a5 48 8b c3 48 83 c4 38 5b 5d 5e 5f c3 48 b9 00 6a 88 c6 f7 7f 00 00 e8 03 84 47 5f 48 8b f0 40 88 6e 08 48 b9 68 6f 34 c6 f7 7f 00 00 e8 2d 07 42 5f 48 8b c8 e8 b5 fe fe ff 8b f8 48 b9 50 58 58 c6 f7 7f 00 00 e8 d4 83 47 5f 48 8b d8 b9 68 04 00 00 48 ba 00 d2 5a c6 f7 7f 00 00 e8 bd 1c 5a 5f 48 8b e8 8b cf e8 93 d6 96 ff 4c 8b c0 48 8b cd 48 8b d6 e8 2d 58 94 ff 48 8b d0 48 8b cb e8 fa 04 96 ff 48 8b cb e8 e2 cf 3e 5f cc}
; Capture completion code, INTRx2
; 2020-01-24 02:54:43:740
...
0029h call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 42 76 47 5f}
...
004eh call 7ff7c6a2d3a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 35 eb ff ff}
...
005eh call 7ff7c6a2d3b8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 35 eb ff ff}
...
006bh call 7ff825ea5e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 00 76 47 5f}
...
0088h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 03 84 47 5f}
...
009eh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2d 07 42 5f}
00a3h mov rcx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c8}
00a6h call 7ff7c6a1e780h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b5 fe fe ff}
...
00b7h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d4 83 47 5f}
...
00ceh call 7ff825fd05b0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bd 1c 5a 5f}
00d3h mov rbp,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b e8}
00d6h mov ecx,edi                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b cf}
00d8h call 7ff7c639bf90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 93 d6 96 ff}
...
00e6h call 7ff7c6374138h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2d 58 94 ff}
...
00f1h call 7ff7c638ee10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fa 04 96 ff}
00f6h mov rcx,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b cb}
00f9h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e2 cf 3e 5f}
