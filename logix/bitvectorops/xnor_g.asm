...
; xnor_g[22] = {0f 1f 44 00 00 0f b6 c1 0f b6 d2 0f b6 c0 33 c2 f7 d0 0f b6 c0 c3}
; TermCode = RET_ZEDx3
...
------------------------------------------------------------------------------------------------------------------------
; BitVector<sbyte> xnor<sbyte>(BitVector<sbyte> x, BitVector<sbyte> y)
; xnor_g[26] = {0f 1f 44 00 00 48 0f be c1 48 0f be d2 48 0f be c0 33 c2 f7 d0 48 0f be c0 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h movsx rax,cl                            ; MOVSX r64, r/m8 || REX.W 0F BE /r || encoded[4]{48 0f be c1}
0009h movsx rdx,dl                            ; MOVSX r64, r/m8 || REX.W 0F BE /r || encoded[4]{48 0f be d2}
000dh movsx rax,al                            ; MOVSX r64, r/m8 || REX.W 0F BE /r || encoded[4]{48 0f be c0}
0011h xor eax,edx                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c2}
...
; xnor_g[22] = {0f 1f 44 00 00 0f b7 c1 0f b7 d2 0f b7 c0 33 c2 f7 d0 0f b7 c0 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
0015h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; BitVector<short> xnor<short>(BitVector<short> x, BitVector<short> y)
; xnor_g[26] = {0f 1f 44 00 00 48 0f bf c1 48 0f bf d2 48 0f bf c0 33 c2 f7 d0 48 0f bf c0 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; xnor_g[12] = {0f 1f 44 00 00 33 d1 8b c2 f7 d0 c3}
; TermCode = RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; BitVector<int> xnor<int>(BitVector<int> x, BitVector<int> y)
; xnor_g[12] = {0f 1f 44 00 00 33 d1 8b c2 f7 d0 c3}
; TermCode = RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor edx,ecx                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 d1}
...
; xnor_g[15] = {0f 1f 44 00 00 48 33 d1 48 8b c2 48 f7 d0 c3}
