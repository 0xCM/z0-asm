...
; rnot_g~eg_BitVector`1_Byte_~eg_BitVector`1_Byte[18] = {0f 1f 44 00 00 89 4c 24 08 0f b6 c2 f7 d0 0f b6 c0 c3}
; TermCode = RET_ZEDx3
...
; rnot_g~eg_BitVector`1_UInt16_~eg_BitVector`1_UInt16[18] = {0f 1f 44 00 00 89 4c 24 08 0f b7 c2 f7 d0 0f b7 c0 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov [rsp+8],ecx                         ; MOV r/m32, r32 || o32 89 /r || encoded[4]{89 4c 24 08}
...
; rnot_g~eg_BitVector`1_UInt32_~eg_BitVector`1_UInt32[14] = {0f 1f 44 00 00 89 4c 24 08 8b c2 f7 d0 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov [rsp+8],ecx                         ; MOV r/m32, r32 || o32 89 /r || encoded[4]{89 4c 24 08}
...
; rnot_g~eg_BitVector`1_UInt64_~eg_BitVector`1_UInt64[17] = {0f 1f 44 00 00 48 89 4c 24 08 48 8b c2 48 f7 d0 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
