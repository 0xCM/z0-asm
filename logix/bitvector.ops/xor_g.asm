...
; xor_g~eg_BitVector`1_Byte_~eg_BitVector`1_Byte[20] = {0f 1f 44 00 00 0f b6 c1 0f b6 d2 0f b6 c0 33 c2 0f b6 c0 c3}
; TermCode = RET_SBB
...
; xor_g~eg_BitVector`1_UInt16_~eg_BitVector`1_UInt16[20] = {0f 1f 44 00 00 0f b7 c1 0f b7 d2 0f b7 c0 33 c2 0f b7 c0 c3}
; TermCode = RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; xor_g~eg_BitVector`1_UInt32_~eg_BitVector`1_UInt32[10] = {0f 1f 44 00 00 33 d1 8b c2 c3}
; TermCode = RET_ZEDx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; xor_g~eg_BitVector`1_UInt64_~eg_BitVector`1_UInt64[12] = {0f 1f 44 00 00 48 33 d1 48 8b c2 c3}
; TermCode = RET_SBB
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
