...
0082h pop rdi                                 ; POP r64 || 58+ro || encoded[1]{5f}
0083h ret                                     ; RET || C3 || encoded[1]{c3}
0084h call 7ff825fcfc20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 27 84 c9 5e}
0089h int 3                                   ; INT3 || CC || encoded[1]{cc}
