...
------------------------------------------------------------------------------------------------------------------------
; int for_min_max()
; for_min_max_[98] = {57 56 48 83 ec 28 48 b9 08 a7 77 c7 f7 7f 00 00 e8 2b 53 b9 5e 48 8b f0 33 c9 89 4e 08 48 b9 88 32 dd c6 f7 7f 00 00 e8 14 53 b9 5e 48 8b f8 48 8d 4f 08 48 8b d6 e8 45 44 b9 5e 49 b8 60 14 31 c7 f7 7f 00 00 4c 89 47 18 4c 8b c7 33 c9 ba 08 00 00 00 e8 58 ff ff ff 8b 46 08 48 83 c4 28 5e 5f c3}
; TermCode = RET_ZEDx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0006h mov rcx,7ff7c777a708h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 08 a7 77 c7 f7 7f 00 00}
0010h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2b 53 b9 5e}
...
001dh mov rcx,7ff7c6dd3288h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 88 32 dd c6 f7 7f 00 00}
0027h call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 14 53 b9 5e}
...
0036h call 7ff825ea5df0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 45 44 b9 5e}
003bh mov r8,7ff7c7311460h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{49 b8 60 14 31 c7 f7 7f 00 00}
...
0053h call 7ff7c7311920h                      ; CALL rel32 || E8 cd || encoded[5]{e8 58 ff ff ff}
