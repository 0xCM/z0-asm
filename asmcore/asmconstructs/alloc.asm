...
; alloc_32u_32i[48] = {56 48 83 ec 20 48 8b f1 48 63 d2 48 b9 88 b4 87 c6 f7 7f 00 00 e8 c6 80 b5 5e 48 8d 50 10 8b 40 08 48 89 16 89 46 08 48 8b c6 48 83 c4 20 5e c3}
; TermCode = RET_SBB
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
0008h movsxd rdx,edx                          ; MOVSXD r64, r/m32 || REX.W 63 /r || encoded[3]{48 63 d2}
000bh mov rcx,7ff7c687b488h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 88 b4 87 c6 f7 7f 00 00}
0015h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c6 80 b5 5e}
