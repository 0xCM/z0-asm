...
; alloc_32u_32i[48] = {56 48 83 ec 20 48 8b f1 48 63 d2 48 b9 c8 b4 86 c6 f7 7f 00 00 e8 46 3b b7 5e 48 8d 50 10 8b 40 08 48 89 16 89 46 08 48 8b c6 48 83 c4 20 5e c3}
; TermCode = RET_SBB
...
0015h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 46 3b b7 5e}
