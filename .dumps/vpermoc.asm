...
; vand_delgate[235] = {57 56 53 48 83 ec 60 c5 f8 77 48 b9 98 27 42 c6 f7 7f 00 00 e8 a7 0b 35 5f 48 8b f0 48 b9 88 77 41 c6 f7 7f 00 00 ba 02 00 00 00 e8 e0 89 3a 5f 48 8b f8 48 b9 e0 5a a6 c6 f7 7f 00 00 e8 7e 0b 35 5f 48 8b d8 4c 8b c3 48 8b cf 33 d2 e8 8e 7a 3a 5f 4c 8b c3 48 8b cf ba 01 00 00 00 e8 7e 7a 3a 5f c7 44 24 20 03 00 00 00 48 89 7c 24 28 33 d2 48 89 54 24 30 48 ba 30 f2 00 90 c2 01 00 00 48 8b 12 48 8b ce 41 b8 1c 00 00 00 45 33 c9 e8 ec e9 41 4f 48 8b c8 c5 fc 57 c0 c5 fd 11 44 24 40 48 8d 54 24 40 e8 dd fd ff ff 48 8b f0 48 b9 38 9a c1 c6 f7 7f 00 00 e8 03 0b 35 5f 48 8b d0 48 8b ce 48 8b 06 48 8b 40 68 ff 50 10 48 8b d0 48 b9 38 9a c1 c6 f7 7f 00 00 e8 f1 09 2f 5f 90 c5 f8 77 48 83 c4 60 5b 5e 5f c3}
; TermCode = MSDIAG
...
0014h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a7 0b 35 5f}
...
002bh call 7ff825ea6e40h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e0 89 3a 5f}
0030h mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
0033h mov rcx,7ff7c6a65ae0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e0 5a a6 c6 f7 7f 00 00}
003dh call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7e 0b 35 5f}
...
004dh call 7ff825ea5f10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8e 7a 3a 5f}
...
005dh call 7ff825ea5f10h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7e 7a 3a 5f}
...
0076h mov rdx,1c29000f230h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba 30 f2 00 90 c2 01 00 00}
...
008fh call 7ff815f1ceb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec e9 41 4f}
...
00a6h call 7ff7c6afe2b8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd fd ff ff}
00abh mov rsi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f0}
00aeh mov rcx,7ff7c6c19a38h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 38 9a c1 c6 f7 7f 00 00}
00b8h call 7ff825e4eff0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 03 0b 35 5f}
...
00d0h mov rcx,7ff7c6c19a38h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 38 9a c1 c6 f7 7f 00 00}
00dah call 7ff825deef00h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f1 09 2f 5f}
...
0010h call 7ff7c6afe430h                      ; CALL rel32 || E8 cd || encoded[5]{e8 db fe ff ff}
...
; vbswap_128x16u_128x16u[36] = {c5 f8 77 66 90 c5 f9 10 02 48 b8 f9 53 12 f1 c2 01 00 00 c5 fb f0 08 c4 e2 79 00 c1 c5 f9 11 01 48 8b c1 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
0009h mov rax,1c2f11253f9h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 f9 53 12 f1 c2 01 00 00}
...
; vpermvar32x8_256x8u_256x8u[81] = {c5 f8 77 66 90 c5 fd 10 02 c4 c1 7d 10 08 48 b8 41 7a 08 f1 c2 01 00 00 c5 ff f0 10 c5 f5 fc d2 c4 e2 7d 00 d2 c4 e3 7d 46 c0 03 48 b8 71 78 08 f1 c2 01 00 00 c5 ff f0 18 c5 f5 fc cb c4 e2 7d 00 c1 c5 ed eb c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
0009h vmovupd ymm1,[r8]                       ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[5]{c4 c1 7d 10 08}
000eh mov rax,1c2f1087a41h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 41 7a 08 f1 c2 01 00 00}
...
002bh mov rax,1c2f1087871h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 71 78 08 f1 c2 01 00 00}
