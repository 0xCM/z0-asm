...
; loop_inc_call_64i[30] = {0f 1f 44 00 00 48 8b c1 ba 66 00 00 00 48 63 ca 48 03 c1 ff c2 81 fa 66 06 00 00 7c f0 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; loop_inc_test_neq_call_64i[30] = {0f 1f 44 00 00 48 8b c1 ba 66 00 00 00 48 63 ca 48 03 c1 ff c2 81 fa 66 06 00 00 75 f0 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
0008h mov edx,66h                             ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 66 00 00 00}
...
; loop_inc_step_call_64i[31] = {0f 1f 44 00 00 48 8b c1 ba 66 00 00 00 48 63 ca 48 03 c1 83 c2 06 81 fa 66 06 00 00 7c ef c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
0008h mov edx,66h                             ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 66 00 00 00}
...
; loop_dec_call_64i[27] = {0f 1f 44 00 00 48 8b c1 ba 66 06 00 00 48 63 ca 48 03 c1 ff ca 83 fa 66 7d f3 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
...
; loop_dec_step_call_64i[28] = {0f 1f 44 00 00 48 8b c1 ba 66 06 00 00 48 63 ca 48 03 c1 83 c2 fa 83 fa 66 7d f2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
0008h mov edx,666h                            ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 66 06 00 00}
...
; FindByte_64u[40] = {0f 1f 44 00 00 48 8b c1 48 f7 d8 48 23 c1 48 c1 e8 08 48 ba 80 03 83 02 82 01 81 00 48 0f af c2 48 c1 e8 37 83 e0 07 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
...
; downBy2ne_32i[25] = {0f 1f 44 00 00 33 c0 ba 09 00 00 00 03 c1 83 c2 fe 83 fa 01 75 f6 03 c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
...
; upBy1ne_32i[24] = {0f 1f 44 00 00 33 c0 ba 01 00 00 00 03 c1 ff c2 83 fa 08 75 f7 03 c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
...
; downBy1ne_32i[24] = {0f 1f 44 00 00 33 c0 ba 09 00 00 00 03 c1 ff ca 83 fa 02 75 f7 03 c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
0007h mov edx,9                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 09 00 00 00}
...
; upBy2ne_32i[25] = {0f 1f 44 00 00 33 c0 ba 01 00 00 00 03 c1 83 c2 02 83 fa 09 75 f6 03 c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
0007h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
...
; upBy3neWrap_32i[29] = {0f 1f 44 00 00 33 c0 ba 01 00 00 00 03 c1 83 c2 03 48 0f bf d2 83 fa 08 75 f2 03 c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
0007h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
...
; downBy3neWrap_32i[29] = {0f 1f 44 00 00 33 c0 ba 08 00 00 00 03 c1 83 c2 fd 48 0f bf d2 83 fa 01 75 f2 03 c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
