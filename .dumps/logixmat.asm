...
; comp1_logic_bit_bit[14] = {0f 1f 44 00 00 8b c1 23 c2 33 d1 0b c2 c3}
; TermCode = MSDIAG
...
; comp1_scalar_64u_64u[18] = {0f 1f 44 00 00 48 8b c1 48 23 c2 48 33 d1 48 0b c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; comp1_v128_v128x64u_v128x64u[43] = {c5 f8 77 66 90 c5 f9 10 02 c4 c1 79 10 08 c5 f9 db c1 c5 f9 10 0a c4 c1 79 10 10 c5 f1 ef ca c5 f9 eb c1 c5 f9 11 01 48 8b c1 c3}
; TermCode = MSDIAG
...
; comp1_v256_v256x64u_v256x64u[46] = {c5 f8 77 66 90 c5 fd 10 02 c4 c1 7d 10 08 c5 fd db c1 c5 fd 10 0a c4 c1 7d 10 10 c5 f5 ef ca c5 fd eb c1 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; comp2_logic_bit_bit[21] = {0f 1f 44 00 00 8b c1 23 c2 33 ca 0b c1 23 c2 f7 d0 83 e0 01 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov eax,ecx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c1}
0007h and eax,edx                             ; AND r32, r/m32 || o32 23 /r || encoded[2]{23 c2}
...
; comp2_scalar_64u_64u[24] = {0f 1f 44 00 00 48 8b c1 48 23 c2 48 33 ca 48 0b c1 48 23 c2 48 f7 d0 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
0008h and rax,rdx                             ; AND r64, r/m64 || REX.W 23 /r || encoded[3]{48 23 c2}
...
; comp2_v128_v128x64u_v128x64u[60] = {c5 f8 77 66 90 c5 f9 10 02 c4 c1 79 10 08 c5 f9 db c1 c5 f9 10 0a c4 c1 79 10 10 c5 f1 ef ca c5 f9 eb c1 c4 c1 79 10 08 c5 f1 db c0 c5 f9 76 c8 c5 f9 ef c1 c5 f9 11 01 48 8b c1 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
...
; comp2_v256_v256x64u_v256x64u[64] = {c5 f8 77 66 90 c5 fd 10 02 c4 c1 7d 10 08 c5 fd db c1 c5 fd 10 0a c4 c1 7d 10 10 c5 f5 ef ca c5 fd eb c1 c4 c1 7d 10 08 c5 f5 db c0 c4 e2 7d 29 c8 c5 fd ef c1 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
...
; comp3_logic_bit_bit[60] = {0f 1f 44 00 00 8b c1 23 c2 44 8b c1 44 33 c2 41 0b c0 23 c2 f7 d0 83 e0 01 44 8b c1 44 0b c2 41 f7 d0 41 83 e0 01 33 d1 f7 d2 83 e2 01 41 23 d0 23 c1 f7 d1 23 d1 0b c2 83 e0 01 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov eax,ecx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c1}
0007h and eax,edx                             ; AND r32, r/m32 || o32 23 /r || encoded[2]{23 c2}
...
; comp3_scalar_64u_64u[55] = {0f 1f 44 00 00 48 8b c1 48 23 c2 4c 8b c1 4c 33 c2 49 0b c0 48 23 c2 48 f7 d0 4c 8b c1 4c 0b c2 49 f7 d0 48 33 d1 c4 c2 e8 f2 d0 48 23 c1 c4 e2 f0 f2 d2 48 0b c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c1}
0008h and rax,rdx                             ; AND r64, r/m64 || REX.W 23 /r || encoded[3]{48 23 c2}
...
; comp3_v128_v128x64u_v128x64u[114] = {c5 f8 77 66 90 c5 f9 10 02 c5 f8 28 c8 c4 c1 79 10 10 c5 f8 28 da c5 f1 db cb c5 f8 28 d8 c5 f8 28 e2 c5 e1 ef dc c5 f1 eb cb c5 f8 28 da c5 e1 db c9 c5 f1 76 d9 c5 f1 ef cb c5 f8 28 d8 c5 f8 28 e2 c5 e1 eb dc c5 e1 76 e3 c5 e1 ef dc c5 f8 28 e0 c5 e9 ef d4 c5 e9 df d3 c5 f8 28 d8 c5 e1 db c9 c5 f9 df c2 c5 f1 eb c0 c5 f9 11 01 48 8b c1 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd xmm0,[rdx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 02}
...
; comp3_v256_v256x64u_v256x64u[119] = {c5 f8 77 66 90 c5 fd 10 02 c5 fc 28 c8 c4 c1 7d 10 10 c5 fc 28 da c5 f5 db cb c5 fc 28 d8 c5 fc 28 e2 c5 e5 ef dc c5 f5 eb cb c5 fc 28 da c5 e5 db c9 c4 e2 75 29 d9 c5 f5 ef cb c5 fc 28 d8 c5 fc 28 e2 c5 e5 eb dc c4 e2 65 29 e3 c5 e5 ef dc c5 fc 28 e0 c5 ed ef d4 c5 ed df d3 c5 fc 28 d8 c5 e5 db c9 c5 fd df c2 c5 f5 eb c0 c5 fd 11 01 48 8b c1 c5 f8 77 c3}
; TermCode = MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD ymm1, ymm2/m256 || VEX.256.66.0F.WIG 10 /r || encoded[4]{c5 fd 10 02}
