...
; charspan_5489[86] = {56 48 83 ec 20 48 8b f1 48 b9 d8 7a 5d c6 f7 7f 00 00 ba 04 00 00 00 e8 34 52 38 5f 48 83 c0 10 ba 04 00 00 00 48 8d 48 06 4c 8d 40 04 4c 8d 48 02 66 c7 01 35 00 66 41 c7 00 34 00 66 41 c7 01 38 00 66 c7 00 39 00 48 89 06 89 56 08 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code = MSDIAG
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
0008h mov rcx,7ff7c65d7ad8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 d8 7a 5d c6 f7 7f 00 00}
0012h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
0017h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 34 52 38 5f}
