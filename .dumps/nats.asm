...
; digits_extract_5849_8u[20] = {0f 1f 44 00 00 c6 01 05 c6 02 08 41 c6 00 04 41 c6 01 09 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; digits_extract_5489_ref_8u[30] = {0f 1f 44 00 00 48 8d 41 03 c6 00 05 48 8d 41 02 c6 00 08 48 8d 41 01 c6 00 04 c6 01 09 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; digits_extract_80352178_8u[52] = {0f 1f 44 00 00 48 8b 44 24 28 c6 00 02 48 8b 44 24 30 c6 00 01 48 8b 44 24 38 c6 00 07 48 8b 44 24 40 c6 00 08 c6 01 08 c6 02 00 41 c6 00 03 41 c6 01 05 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; chars_5489_Char_Char_Char_Char[28] = {0f 1f 44 00 00 66 c7 01 35 00 66 c7 02 34 00 66 41 c7 00 38 00 66 41 c7 01 39 00 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; chars_80352178_Char_Char_Char_Char_Char_Char_Char_Char[68] = {0f 1f 44 00 00 66 c7 01 38 00 66 c7 02 30 00 66 41 c7 00 33 00 66 41 c7 01 35 00 48 8b 44 24 28 66 c7 00 32 00 48 8b 44 24 30 66 c7 00 31 00 48 8b 44 24 38 66 c7 00 37 00 48 8b 44 24 40 66 c7 00 38 00 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; charspan_5489[86] = {56 48 83 ec 20 48 8b f1 48 b9 f0 8f 5b c6 f7 7f 00 00 ba 04 00 00 00 e8 f4 d2 39 5f 48 83 c0 10 ba 04 00 00 00 48 8d 48 06 4c 8d 40 04 4c 8d 48 02 66 c7 01 35 00 66 41 c7 00 34 00 66 41 c7 01 38 00 66 c7 00 39 00 48 89 06 89 56 08 48 8b c6 48 83 c4 20 5e c3}
; TermCode = MSDIAG
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,20h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 20}
0005h mov rsi,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f1}
0008h mov rcx,7ff7c65b8ff0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 f0 8f 5b c6 f7 7f 00 00}
0012h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
0017h call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f4 d2 39 5f}
