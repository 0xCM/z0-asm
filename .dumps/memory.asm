...
------------------------------------------------------------------------------------------------------------------------
; Char digit_1()
; digit_1[46] = {0f 1f 44 00 00 48 b8 d8 ef 5b 1d 65 02 00 00 48 8b 00 48 85 c0 75 04 33 d2 eb 0e 8b 10 48 8b d0 39 12 48 83 c2 0c 8b 40 08 0f b7 42 0a c3}
; Capture completion code = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,2651d5befd8h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 d8 ef 5b 1d 65 02 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; Char digit_2()
; digit_2[39] = {48 83 ec 28 90 48 b8 d8 ef 5b 1d 65 02 00 00 48 8b 00 83 78 08 05 76 09 0f b7 40 16 48 83 c4 28 c3 e8 1a f7 4b 5f cc}
; Capture completion code = MSDIAG
...
0021h call 7ff825fcfdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1a f7 4b 5f}
0026h int 3                                   ; INT3 || CC || encoded[1]{cc}
------------------------------------------------------------------------------------------------------------------------
; Char digit(int i)
; digit_32i[23] = {0f 1f 44 00 00 48 63 c1 48 ba b1 7b ae 0b 65 02 00 00 0f b6 04 10 c3}
; Capture completion code = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h movsxd rax,ecx                          ; MOVSXD r64, r/m32 || REX.W 63 /r || encoded[3]{48 63 c1}
0008h mov rdx,2650bae7bb1h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba b1 7b ae 0b 65 02 00 00}
