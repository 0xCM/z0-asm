; 2020-01-24 20:46:48:118
; int blockalign_64x8u_var(int cellcount)
; blockalign_64x8u_var_32i[7ff7c6a9cae0h, 7ff7c6a9cb08h][40] = {0f 1f 44 00 00 8b c1 c1 f8 1f 83 e0 07 03 c1 c1 f8 03 8b d1 c1 fa 1f 83 e2 07 03 d1 83 e2 f8 2b ca 74 04 ff c0 eb 00 c3}
...
; blockalign_64x8u_16__0o[7ff7c6a9cb20h, 7ff7c6a9cb2bh][11] = {0f 1f 44 00 00 b8 02 00 00 00 c3}
; Capture completion code, MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; blockalign_64x8u_17__0o[7ff7c6a9cb40h, 7ff7c6a9cb4bh][11] = {0f 1f 44 00 00 b8 03 00 00 00 c3}
; Capture completion code, MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; Char digit_1()
; digit_1_Char[7ff7c6a9cb60h, 7ff7c6a9cb8eh][46] = {0f 1f 44 00 00 48 b8 f8 ef 36 1d e6 01 00 00 48 8b 00 48 85 c0 75 04 33 d2 eb 0e 8b 10 48 8b d0 39 12 48 83 c2 0c 8b 40 08 0f b7 42 0a c3}
; Capture completion code, MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,1e61d36eff8h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 f8 ef 36 1d e6 01 00 00}
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; Char digit_2()
; digit_2_Char[7ff7c6a9cba0h, 7ff7c6a9cbc7h][39] = {48 83 ec 28 90 48 b8 f8 ef 36 1d e6 01 00 00 48 8b 00 83 78 08 05 76 09 0f b7 40 16 48 83 c4 28 c3 e8 0a 32 53 5f cc}
; Capture completion code, MSDIAG
...
0021h call 7ff825fcfdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0a 32 53 5f}
0026h int 3                                   ; INT3 || CC || encoded[1]{cc}
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; Char digit(int i)
; digit_32i[7ff7c6a9cbe0h, 7ff7c6a9cbf7h][23] = {0f 1f 44 00 00 48 63 c1 48 ba b1 7c 13 0d e6 01 00 00 0f b6 04 10 c3}
; Capture completion code, MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h movsxd rax,ecx                          ; MOVSXD r64, r/m32 || REX.W 63 /r || encoded[3]{48 63 c1}
0008h mov rdx,1e60d137cb1h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 ba b1 7c 13 0d e6 01 00 00}
0012h movzx eax,byte ptr [rax+rdx]            ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[4]{0f b6 04 10}
0016h ret                                     ; RET || C3 || encoded[1]{c3}
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; Char bdigit(bit b)
; bdigit_bit~Char[7ff7c6a9cc10h, 7ff7c6a9cc1ch][12] = {0f 1f 44 00 00 83 c1 30 0f b7 c1 c3}
; Capture completion code, MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
