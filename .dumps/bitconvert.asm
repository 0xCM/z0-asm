; 2020-01-24 20:46:48:079
; void deposit(in ulong src, ref Fixed128 dst)
; deposit__0oFixed128~Void[7ff7c6a9b230h, 7ff7c6a9b23eh][14] = {c5 f8 77 66 90 c5 fa 6f 01 c5 fa 7f 02 c3}
...
; deposit_4_0__0oFixed128~Void[7ff7c6a9b250h, 7ff7c6a9b25eh][14] = {c5 f8 77 66 90 c5 fa 6f 01 c5 fa 7f 02 c3}
; Capture completion code, MSDIAG
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vmovdqu xmm0,xmmword ptr [rcx]          ; VMOVDQU xmm1, xmm2/m128 || VEX.128.F3.0F.WIG 6F /r || encoded[4]{c5 fa 6f 01}
...
; deposit_2_2__0oFixed128~Void[7ff7c6a9b270h, 7ff7c6a9b280h][16] = {0f 1f 44 00 00 48 83 c2 08 48 8b 01 48 89 02 c3}
; Capture completion code, MSDIAG
...
; bc_bytes_16u_16u[7ff7c6a9b290h, 7ff7c6a9b2d0h][64] = {56 48 83 ec 20 89 54 24 38 48 8b f1 48 b9 10 ea 34 c6 f7 7f 00 00 ba 02 00 00 00 e8 30 bb 40 5f 48 83 c0 10 ba 02 00 00 00 0f b7 4c 24 38 66 89 08 48 89 06 89 56 08 48 8b c6 48 83 c4 20 5e c3}
; Capture completion code, MSDIAG
...
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 30 bb 40 5f}
...
; bc_bytes_64u_64u[7ff7c6a9b2f0h, 7ff7c6a9b32ch][60] = {57 56 48 83 ec 28 48 8b f1 48 8b fa 48 b9 10 ea 34 c6 f7 7f 00 00 ba 08 00 00 00 e8 d0 ba 40 5f 48 83 c0 10 ba 08 00 00 00 48 89 38 48 89 06 89 56 08 48 8b c6 48 83 c4 28 5e 5f c3}
; Capture completion code, MSDIAG
...
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d0 ba 40 5f}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
...
; bc_bytes_fixed256_Fixed2568u[7ff7c6a9b750h, 7ff7c6a9b79eh][78] = {57 56 48 83 ec 28 c5 f8 77 48 8b f9 48 8b f2 48 b9 10 ea 34 c6 f7 7f 00 00 ba 20 00 00 00 e8 6d b6 40 5f 48 83 c0 10 ba 20 00 00 00 c5 fa 6f 06 c5 fa 7f 00 c5 fa 6f 46 10 c5 fa 7f 40 10 48 89 07 89 57 08 48 8b c7 48 83 c4 28 5e 5f c3}
; Capture completion code, MSDIAG
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6d b6 40 5f}
...
; bc_bytes_fixed512_Fixed5128u[7ff7c6a9b7c0h, 7ff7c6a9b822h][98] = {57 56 48 83 ec 28 c5 f8 77 48 8b f9 48 8b f2 48 b9 10 ea 34 c6 f7 7f 00 00 ba 40 00 00 00 e8 fd b5 40 5f 48 83 c0 10 ba 40 00 00 00 c5 fa 6f 06 c5 fa 7f 00 c5 fa 6f 46 10 c5 fa 7f 40 10 c5 fa 6f 46 20 c5 fa 7f 40 20 c5 fa 6f 46 30 c5 fa 7f 40 30 48 89 07 89 57 08 48 8b c7 48 83 c4 28 5e 5f c3}
; Capture completion code, MSDIAG
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fd b5 40 5f}
0023h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
...
; bc_bytes_fixed1024_Fixed10248u[7ff7c6a9b850h, 7ff7c6a9b8a1h][81] = {57 56 55 53 48 83 ec 28 48 8b f9 48 8b f2 48 b9 10 ea 34 c6 f7 7f 00 00 ba 80 00 00 00 e8 6e b5 40 5f 48 83 c0 10 48 8b d8 bd 80 00 00 00 48 8b cb 48 8b d6 41 b8 80 00 00 00 e8 c1 a7 40 5f 48 89 1f 89 6f 08 48 8b c7 48 83 c4 28 5b 5d 5e 5f c3}
; Capture completion code, MSDIAG
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
...
000eh mov rcx,7ff7c634ea10h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 ea 34 c6 f7 7f 00 00}
0018h mov edx,80h                             ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 80 00 00 00}
001dh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6e b5 40 5f}
...
003ah call 7ff825ea6050h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c1 a7 40 5f}
...
; bc_bytes_fixed2048_Fixed20488u[7ff7c6a9b8c0h, 7ff7c6a9b911h][81] = {57 56 55 53 48 83 ec 28 48 8b f9 48 8b f2 48 b9 10 ea 34 c6 f7 7f 00 00 ba 00 01 00 00 e8 fe b4 40 5f 48 83 c0 10 48 8b d8 bd 00 01 00 00 48 8b cb 48 8b d6 41 b8 00 01 00 00 e8 51 a7 40 5f 48 89 1f 89 6f 08 48 8b c7 48 83 c4 28 5b 5d 5e 5f c3}
; Capture completion code, MSDIAG
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbp                                ; PUSH r64 || 50+ro || encoded[1]{55}
...
001dh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fe b4 40 5f}
0022h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
0026h mov rbx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d8}
...
003ah call 7ff825ea6050h                      ; CALL rel32 || E8 cd || encoded[5]{e8 51 a7 40 5f}
003fh mov [rdi],rbx                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 1f}
0042h mov [rdi+8],ebp                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 6f 08}
0045h mov rax,rdi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c7}
0048h add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
...
; bc_bytes_fixed4096_Fixed40968u[7ff7c6a9b930h, 7ff7c6a9b981h][81] = {57 56 55 53 48 83 ec 28 48 8b f9 48 8b f2 48 b9 10 ea 34 c6 f7 7f 00 00 ba 00 02 00 00 e8 8e b4 40 5f 48 83 c0 10 48 8b d8 bd 00 02 00 00 48 8b cb 48 8b d6 41 b8 00 02 00 00 e8 e1 a6 40 5f 48 89 1f 89 6f 08 48 8b c7 48 83 c4 28 5b 5d 5e 5f c3}
; Capture completion code, MSDIAG
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbp                                ; PUSH r64 || 50+ro || encoded[1]{55}
...
001dh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8e b4 40 5f}
0022h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
0026h mov rbx,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d8}
...
003ah call 7ff825ea6050h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e1 a6 40 5f}
003fh mov [rdi],rbx                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 1f}
0042h mov [rdi+8],ebp                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 6f 08}
0045h mov rax,rdi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c7}
0048h add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
