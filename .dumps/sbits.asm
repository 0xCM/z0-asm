...
; set_bit_0o_0o_bit[43] = {0f 1f 44 00 00 8b c1 45 85 c0 74 0e 0f b6 ca ba 01 00 00 00 d3 e2 0b c2 eb 10 0f b6 ca ba 01 00 00 00 d3 e2 f7 d2 23 d0 8b c2 c3}
; Capture completion code = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; set_bit_nb_0o_0o_bit[42] = {0f 1f 44 00 00 8b c1 0f b6 d2 83 e2 1f 41 b9 01 00 00 00 8b ca 41 d3 e1 41 f7 d1 41 ff c1 8b ca 41 d3 e0 41 23 c1 41 23 c0 c3}
; Capture completion code = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov eax,ecx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c1}
