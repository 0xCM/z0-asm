...
; bitmatch_32_32_32u_8u_32u_8u[36] = {0f 1f 44 00 00 8b c1 0f b6 ca d3 e8 83 e0 01 41 0f b6 c9 41 d3 e8 41 83 e0 01 41 3b c0 0f 94 c0 0f b6 c0 c3}
; TermCode = MSDIAG
...
02e4h call 7ff7c63b05c0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f7 ca 89 ff}
