...
; bl_and32_32u[10] = {0f 1f 44 00 00 23 d1 8b c2 c3}
; TermCode = MSDIAG
...
; logic_machine_32u[12] = {0f 1f 44 00 00 23 ca 33 d1 8b c2 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; vlogic_machine_128x32u[34] = {c5 f8 77 66 90 c5 f9 10 02 c4 c1 79 10 08 c5 f8 28 d1 c5 f9 db c2 c5 f9 ef c1 c5 f9 11 01 48 8b c1 c3}
; TermCode = MSDIAG
...
; eq_d16u_16u[20] = {0f 1f 44 00 00 0f b7 c1 0f b7 d2 3b c2 0f 94 c0 0f b6 c0 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
; eq_g16u_16u[23] = {0f 1f 44 00 00 0f b7 c1 0f b7 d2 0f b7 c0 3b c2 0f 94 c0 0f b6 c0 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h movzx eax,cx                            ; MOVZX r32, r/m16 || o32 0F B7 /r || encoded[3]{0f b7 c1}
0008h movzx edx,dx                            ; MOVZX r32, r/m16 || o32 0F B7 /r || encoded[3]{0f b7 d2}
...
; eq_o16u_16u[23] = {0f 1f 44 00 00 0f b7 c1 0f b7 d2 0f b7 c0 3b c2 0f 94 c0 0f b6 c0 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h movzx eax,cx                            ; MOVZX r32, r/m16 || o32 0F B7 /r || encoded[3]{0f b7 c1}
0008h movzx edx,dx                            ; MOVZX r32, r/m16 || o32 0F B7 /r || encoded[3]{0f b7 d2}
...
0016h ret                                     ; RET || C3 || encoded[1]{c3}
; string eq_moniker()
; eq_moniker[47] = {48 83 ec 38 33 c0 48 89 44 24 30 48 89 44 24 28 c6 44 24 28 00 48 0f be 4c 24 28 88 4c 24 30 48 8d 4c 24 30 e8 27 fa ff ff 90 48 83 c4 38 c3}
; TermCode = MSDIAG
...
0024h call 7ff7c6afaf80h                      ; CALL rel32 || E8 cd || encoded[5]{e8 27 fa ff ff}
0029h nop                                     ; NOP || o32 90 || encoded[1]{90}
002ah add rsp,38h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 38}
002eh ret                                     ; RET || C3 || encoded[1]{c3}
; string the_name()
; the_name[19] = {0f 1f 44 00 00 48 b8 90 f0 00 90 c2 01 00 00 48 8b 00 c3}
; TermCode = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,1c29000f090h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 90 f0 00 90 c2 01 00 00}
