...
------------------------------------------------------------------------------------------------------------------------
; string eq_moniker()
; eq_moniker[47] = {48 83 ec 38 33 c0 48 89 44 24 30 48 89 44 24 28 c6 44 24 28 00 48 0f be 4c 24 28 88 4c 24 30 48 8d 4c 24 30 e8 3f fa ff ff 90 48 83 c4 38 c3}
; Capture completion code = MSDIAG
...
0024h call 7ff7c6b130a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3f fa ff ff}
0029h nop                                     ; NOP || o32 90 || encoded[1]{90}
002ah add rsp,38h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 38}
002eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; string the_name()
; the_name[19] = {0f 1f 44 00 00 48 b8 a0 f1 5b 1d 65 02 00 00 48 8b 00 c3}
; Capture completion code = MSDIAG
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
0005h mov rax,2651d5bf1a0h                    ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 a0 f1 5b 1d 65 02 00 00}
