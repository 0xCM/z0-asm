...
; head_g[64i]()[159] = {}
; TermCode = CTC_RET_ZED_SBB
...
0013h ret                                     ; RET || C3 || encoded[1]{c3}
0014h call 7ff82738fdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 27 f7 df 5e}
...
0029h (bad)                                   ; <invalid> || <invalid> || encoded[2]{16 8d}
...
0044h call 7ff82738fdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f7 f6 df 5e}
...
0057h add [rax+17h],ah                        ; ADD r/m8, r8 || 00 /r || encoded[3]{00 60 17}
005ah (bad)                                   ; <invalid> || <invalid> || encoded[2]{8d c8}
...
0074h call 7ff82738fdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c7 f6 df 5e}
...
0087h add [rax],cl                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 08}
0089h sbb [rbp+7ff7c8h],ecx                   ; SBB r/m32, r32 || o32 19 /r || encoded[6]{19 8d c8 f7 7f 00}
...
000fh add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
0013h ret                                     ; RET || C3 || encoded[1]{c3}
0014h call 7ff82738fdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f7 f6 df 5e}
0019h int 3                                   ; INT3 || CC || encoded[1]{cc}
001ah add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 00}
001ch sbb [rcx+rax],eax                       ; SBB r/m32, r32 || o32 19 /r || encoded[3]{19 04 01}
001fh add [rdx+rax*2],al                      ; ADD r/m8, r8 || 00 /r || encoded[3]{00 04 42}
0022h add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 00}
0024h add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[3]{40 00 00}
0027h add [rax+17h],ah                        ; ADD r/m8, r8 || 00 /r || encoded[3]{00 60 17}
002ah (bad)                                   ; <invalid> || <invalid> || encoded[2]{8d c8}
...
003fh add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
0043h ret                                     ; RET || C3 || encoded[1]{c3}
0044h call 7ff82738fdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c7 f6 df 5e}
0049h int 3                                   ; INT3 || CC || encoded[1]{cc}
004ah add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 00}
004ch sbb [rcx+rax],eax                       ; SBB r/m32, r32 || o32 19 /r || encoded[3]{19 04 01}
004fh add [rdx+rax*2],al                      ; ADD r/m8, r8 || 00 /r || encoded[3]{00 04 42}
0052h add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 00}
0054h add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[3]{40 00 00}
0057h add [rax],cl                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 08}
0059h sbb [rbp+7ff7c8h],ecx                   ; SBB r/m32, r32 || o32 19 /r || encoded[6]{19 8d c8 f7 7f 00}
...
000fh add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
0013h ret                                     ; RET || C3 || encoded[1]{c3}
0014h call 7ff82738fdd0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c7 f6 df 5e}
0019h int 3                                   ; INT3 || CC || encoded[1]{cc}
001ah add [rax],al                            ; ADD r/m8, r8 || 00 /r || encoded[2]{00 00}
001ch sbb [rcx+rax],eax                       ; SBB r/m32, r32 || o32 19 /r || encoded[3]{19 04 01}
001fh add [rdx+rax*2],al                      ; ADD r/m8, r8 || 00 /r || encoded[3]{00 04 42}
...
0029h sbb [rbp+7ff7c8h],ecx                   ; SBB r/m32, r32 || o32 19 /r || encoded[6]{19 8d c8 f7 7f 00}
