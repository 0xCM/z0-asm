------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<sbyte> src, ref sbyte dst), hex://vfuncs/direct?vstore#vstore_(v128x8i,8i~ref)
...
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<byte> src, ref byte dst), hex://vfuncs/direct?vstore#vstore_(v128x8u,8u~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<short> src, ref short dst), hex://vfuncs/direct?vstore#vstore_(v128x16i,16i~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<ushort> src, ref ushort dst), hex://vfuncs/direct?vstore#vstore_(v128x16u,16u~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<int> src, ref int dst), hex://vfuncs/direct?vstore#vstore_(v128x32i,32i~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<uint> src, ref uint dst), hex://vfuncs/direct?vstore#vstore_(v128x32u,32u~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<long> src, ref long dst), hex://vfuncs/direct?vstore#vstore_(v128x64i,64i~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<ulong> src, ref ulong dst), hex://vfuncs/direct?vstore#vstore_(v128x64u,64u~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<float> src, ref float dst), hex://vfuncs/direct?vstore#vstore_(v128x32f,32f~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<double> src, ref double dst), hex://vfuncs/direct?vstore#vstore_(v128x64f,64f~ref)
...
000dh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<sbyte> src, ref sbyte dst), hex://vfuncs/direct?vstore#vstore_(v256x8i,8i~ref)
...
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<byte> src, ref byte dst), hex://vfuncs/direct?vstore#vstore_(v256x8u,8u~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<short> src, ref short dst), hex://vfuncs/direct?vstore#vstore_(v256x16i,16i~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<ushort> src, ref ushort dst), hex://vfuncs/direct?vstore#vstore_(v256x16u,16u~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<int> src, ref int dst), hex://vfuncs/direct?vstore#vstore_(v256x32i,32i~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<uint> src, ref uint dst), hex://vfuncs/direct?vstore#vstore_(v256x32u,32u~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<long> src, ref long dst), hex://vfuncs/direct?vstore#vstore_(v256x64i,64i~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<ulong> src, ref ulong dst), hex://vfuncs/direct?vstore#vstore_(v256x64u,64u~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<float> src, ref float dst), hex://vfuncs/direct?vstore#vstore_(v256x32f,32f~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<double> src, ref double dst), hex://vfuncs/direct?vstore#vstore_(v256x64f,64f~ref)
...
0010h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<sbyte> src, ref sbyte dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x8i,8i~ref,32i)
...
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<byte> src, ref byte dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x8u,8u~ref,32i)
...
0013h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<short> src, ref short dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x16i,16i~ref,32i)
...
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<ushort> src, ref ushort dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x16u,16u~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<int> src, ref int dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x32i,32i~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<uint> src, ref uint dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x32u,32u~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<long> src, ref long dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x64i,64i~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<ulong> src, ref ulong dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x64u,64u~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<float> src, ref float dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x32f,32f~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector128<double> src, ref double dst, int offset), hex://vfuncs/direct?vstore#vstore_(v128x64f,64f~ref,32i)
...
0014h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<sbyte> src, ref sbyte dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x8i,8i~ref,32i)
...
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<byte> src, ref byte dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x8u,8u~ref,32i)
...
0016h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<short> src, ref short dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x16i,16i~ref,32i)
...
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<ushort> src, ref ushort dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x16u,16u~ref,32i)
...
0017h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<int> src, ref int dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x32i,32i~ref,32i)
...
0017h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<uint> src, ref uint dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x32u,32u~ref,32i)
...
0017h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<long> src, ref long dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x64i,64i~ref,32i)
...
0017h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<ulong> src, ref ulong dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x64u,64u~ref,32i)
...
0017h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<float> src, ref float dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x32f,32f~ref,32i)
...
0017h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void vstore(Vector256<double> src, ref double dst, int offset), hex://vfuncs/direct?vstore#vstore_(v256x64f,64f~ref,32i)
