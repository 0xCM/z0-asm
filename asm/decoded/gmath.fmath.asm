...
; dist_(64f,64f)[47] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xf9,0x2e,0xc1,0x73,0x13,0xc5,0xf3,0x5c,0xc8,0xc5,0xf8,0x28,0xc1,0xe8,0x16,0x94,0x13,0x5f,0x90,0x48,0x83,0xc4,0x28,0xc3,0xc5,0xfb,0x5c,0xc1,0xe8,0x07,0x94,0x13,0x5f,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
...
0015h call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 16 94 13 5f}
...
0024h call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 07 94 13 5f}
...
; divides_(32f,32f)[48] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xf8,0x28,0xd0,0xc5,0xf8,0x28,0xc1,0xc5,0xf8,0x28,0xca,0xe8,0xa8,0xd0,0x13,0x5f,0xc5,0xf0,0x57,0xc9,0xc5,0xf8,0x2e,0xc1,0x0f,0x9b,0xc0,0x7a,0x03,0x0f,0x94,0xc0,0x0f,0xb6,0xc0,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0013h call 7ff827391660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a8 d0 13 5f}
...
; divides_(64f,64f)[48] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xf8,0x28,0xd0,0xc5,0xf8,0x28,0xc1,0xc5,0xf8,0x28,0xca,0xe8,0xc8,0xcf,0x13,0x5f,0xc5,0xf0,0x57,0xc9,0xc5,0xf9,0x2e,0xc1,0x0f,0x9b,0xc0,0x7a,0x03,0x0f,0x94,0xc0,0x0f,0xb6,0xc0,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmovaps xmm2,xmm0                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 d0}
000bh vmovaps xmm0,xmm1                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 c1}
000fh vmovaps xmm1,xmm2                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 ca}
0013h call 7ff8273915d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c8 cf 13 5f}
0018h vxorps xmm1,xmm1,xmm1                   ; VXORPS xmm1, xmm2, xmm3/m128 || VEX.128.0F.WIG 57 /r || encoded[4]{c5 f0 57 c9}
...
; signum_(32f)[18] = {0xc5,0xf8,0x77,0x66,0x90,0x48,0xb8,0xb8,0x3c,0xa0,0xc7,0xf7,0x7f,0x00,0x00,0x48,0xff,0xe0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,7ff7c7a03cb8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 b8 3c a0 c7 f7 7f 00 00}
000fh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[3]{48 ff e0}
------------------------------------------------------------------------------------------------------------------------
; Sign:int signum(double src), hex://gmath/fmath?signum#signum_(64f)
; signum_(64f)[18] = {0xc5,0xf8,0x77,0x66,0x90,0x48,0xb8,0x90,0x3c,0xa0,0xc7,0xf7,0x7f,0x00,0x00,0x48,0xff,0xe0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,7ff7c7a03c90h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 90 3c a0 c7 f7 7f 00 00}
000fh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[3]{48 ff e0}
------------------------------------------------------------------------------------------------------------------------
...
01a3h mov rcx,7ff7c79725e0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e0 25 97 c7 f7 7f 00 00}
01adh call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 be 21 01 5f}
...
01a2h ret                                     ; RET || C3 || encoded[1]{c3}
01a3h mov rcx,7ff7c79725e0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 e0 25 97 c7 f7 7f 00 00}
01adh call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ae 1c 01 5f}
01b2h mov rsi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f0}
01b5h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01b8h call 7ff7c7759b20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 13 4b 50 ff}
01bdh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01c0h call 7ff8271db900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 eb 68 f8 5e}
------------------------------------------------------------------------------------------------------------------------
...
; gcd_(32f,32f)[167] = {}
; TermCode = CTC_INTRx2
...
006dh call 7ff827391660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ce c4 13 5f}
...
0075h call 7ff8273915d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 56 c3 13 5f}
...
; log_(32f)[50] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x48,0x89,0x54,0x24,0x38,0x48,0x8d,0x44,0x24,0x38,0x0f,0xb6,0x10,0xc5,0xfa,0x10,0x48,0x04,0x84,0xd2,0x75,0x0a,0xc5,0xfa,0x10,0x0d,0x13,0x00,0x00,0x00,0xeb,0x00,0xe8,0x8c,0x8a,0xff,0xff,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0027h call 7ff7c824de58h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8c 8a ff ff}
...
; log_(64f)[40] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x0f,0xb6,0x02,0xc5,0xfb,0x10,0x4a,0x08,0x84,0xc0,0x75,0x0a,0xc5,0xfb,0x10,0x0d,0x15,0x00,0x00,0x00,0xeb,0x00,0xe8,0x6e,0xe7,0x7a,0xff,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
001dh call 7ff7c7a03b80h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6e e7 7a ff}
...
002fh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6c 84 13 5f}
...
003eh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5d 84 13 5f}
...
001fh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9c 83 13 5f}
...
002eh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8d 83 13 5f}
