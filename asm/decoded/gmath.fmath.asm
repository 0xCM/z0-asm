...
; dist_(64f,64f)[47] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xf9,0x2e,0xc1,0x73,0x13,0xc5,0xf3,0x5c,0xc8,0xc5,0xf8,0x28,0xc1,0xe8,0x26,0xd0,0xf8,0x5e,0x90,0x48,0x83,0xc4,0x28,0xc3,0xc5,0xfb,0x5c,0xc1,0xe8,0x17,0xd0,0xf8,0x5e,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
...
0015h call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 26 d0 f8 5e}
...
0024h call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 17 d0 f8 5e}
...
; divides_(32f,32f)[48] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xf8,0x28,0xd0,0xc5,0xf8,0x28,0xc1,0xc5,0xf8,0x28,0xca,0xe8,0xb8,0x0c,0xf9,0x5e,0xc5,0xf0,0x57,0xc9,0xc5,0xf8,0x2e,0xc1,0x0f,0x9b,0xc0,0x7a,0x03,0x0f,0x94,0xc0,0x0f,0xb6,0xc0,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0013h call 7ff827391660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b8 0c f9 5e}
...
; divides_(64f,64f)[48] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xf8,0x28,0xd0,0xc5,0xf8,0x28,0xc1,0xc5,0xf8,0x28,0xca,0xe8,0xd8,0x0b,0xf9,0x5e,0xc5,0xf0,0x57,0xc9,0xc5,0xf9,0x2e,0xc1,0x0f,0x9b,0xc0,0x7a,0x03,0x0f,0x94,0xc0,0x0f,0xb6,0xc0,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmovaps xmm2,xmm0                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 d0}
000bh vmovaps xmm0,xmm1                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 c1}
000fh vmovaps xmm1,xmm2                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 ca}
0013h call 7ff8273915d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d8 0b f9 5e}
0018h vxorps xmm1,xmm1,xmm1                   ; VXORPS xmm1, xmm2, xmm3/m128 || VEX.128.0F.WIG 57 /r || encoded[4]{c5 f0 57 c9}
...
; signum_(32f)[18] = {0xc5,0xf8,0x77,0x66,0x90,0x48,0xb8,0xb8,0x4f,0xa4,0xc7,0xf7,0x7f,0x00,0x00,0x48,0xff,0xe0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,7ff7c7a44fb8h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 b8 4f a4 c7 f7 7f 00 00}
000fh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[3]{48 ff e0}
------------------------------------------------------------------------------------------------------------------------
; Sign:int signum(double src), hex://gmath/fmath?signum#signum_(64f)
; signum_(64f)[18] = {0xc5,0xf8,0x77,0x66,0x90,0x48,0xb8,0x90,0x4f,0xa4,0xc7,0xf7,0x7f,0x00,0x00,0x48,0xff,0xe0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,7ff7c7a44f90h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 90 4f a4 c7 f7 7f 00 00}
000fh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[3]{48 ff e0}
------------------------------------------------------------------------------------------------------------------------
...
01a3h mov rcx,7ff7c79a5810h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 58 9a c7 f7 7f 00 00}
01adh call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ce 5d e6 5e}
...
01a2h ret                                     ; RET || C3 || encoded[1]{c3}
01a3h mov rcx,7ff7c79a5810h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 58 9a c7 f7 7f 00 00}
01adh call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 be 58 e6 5e}
01b2h mov rsi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f0}
01b5h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01b8h call 7ff7c7779c38h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3b 88 37 ff}
01bdh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01c0h call 7ff8271db900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fb a4 dd 5e}
------------------------------------------------------------------------------------------------------------------------
...
; gcd_(32f,32f)[167] = {}
; TermCode = CTC_INTRx2
...
006dh call 7ff827391660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 de 00 f9 5e}
...
0075h call 7ff8273915d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 66 ff f8 5e}
...
; log_(32f)[50] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x48,0x89,0x54,0x24,0x38,0x48,0x8d,0x44,0x24,0x38,0x0f,0xb6,0x10,0xc5,0xfa,0x10,0x48,0x04,0x84,0xd2,0x75,0x0a,0xc5,0xfa,0x10,0x0d,0x13,0x00,0x00,0x00,0xeb,0x00,0xe8,0xac,0xe4,0xea,0xff,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0027h call 7ff7c82afc68h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ac e4 ea ff}
...
; log_(64f)[40] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x0f,0xb6,0x02,0xc5,0xfb,0x10,0x4a,0x08,0x84,0xc0,0x75,0x0a,0xc5,0xfb,0x10,0x0d,0x15,0x00,0x00,0x00,0xeb,0x00,0xe8,0x7e,0x36,0x64,0xff,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
001dh call 7ff7c7a44e80h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7e 36 64 ff}
...
002fh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7c c0 f8 5e}
...
003eh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6d c0 f8 5e}
...
001fh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ac bf f8 5e}
...
002eh call 7ff82738d940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9d bf f8 5e}
