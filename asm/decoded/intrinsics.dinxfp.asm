...
0054h call 7ff7c77396d8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8f e5 19 ff}
...
; vdot_(v128x64f,v128x64f)[98] = {0x56,0x48,0x83,0xec,0x40,0xc5,0xf8,0x77,0x4c,0x89,0x4c,0x24,0x68,0x48,0x8b,0xf1,0x48,0x8d,0x4c,0x24,0x68,0x44,0x0f,0xb6,0x09,0x0f,0xb6,0x49,0x01,0xc5,0xf9,0x10,0x02,0xc4,0xc1,0x79,0x10,0x08,0x45,0x84,0xc9,0x75,0x08,0x41,0xb9,0xff,0x00,0x00,0x00,0xeb,0x04,0x44,0x0f,0xb6,0xc9,0x48,0x8b,0xce,0xc5,0xf9,0x29,0x44,0x24,0x30,0xc5,0xf9,0x29,0x4c,0x24,0x20,0x48,0x8d,0x54,0x24,0x30,0x4c,0x8d,0x44,0x24,0x20,0x45,0x0f,0xb6,0xc9,0xe8,0x17,0xe5,0x19,0xff,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x40,0x5e,0xc3}
; TermCode = CTC_RET_INTR
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,40h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 40}
0005h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
004bh lea r8,[rsp+20h]                        ; LEA r64, m || REX.W 8D /r || encoded[5]{4c 8d 44 24 20}
0050h movzx r9d,r9b                           ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[4]{45 0f b6 c9}
0054h call 7ff7c77396e0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 17 e5 19 ff}
0059h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
005ch add rsp,40h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 40}
0060h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
0061h ret                                     ; RET || C3 || encoded[1]{c3}
...
005ah call 7ff7c7739d80h                      ; CALL rel32 || E8 cd || encoded[5]{e8 31 eb 19 ff}
...
; vshuffle_(v128x32f,v128x32f,8u)[63] = {0x56,0x48,0x83,0xec,0x40,0xc5,0xf8,0x77,0x48,0x8b,0xf1,0xc5,0xf9,0x10,0x02,0xc4,0xc1,0x79,0x10,0x08,0x48,0x8b,0xce,0xc5,0xf9,0x29,0x44,0x24,0x30,0xc5,0xf9,0x29,0x4c,0x24,0x20,0x48,0x8d,0x54,0x24,0x30,0x4c,0x8d,0x44,0x24,0x20,0x45,0x0f,0xb6,0xc9,0xe8,0xb2,0xc8,0x19,0xff,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x40,0x5e,0xc3}
; TermCode = CTC_RET_INTR
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,40h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 40}
0005h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0031h call 7ff7c7738748h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 c8 19 ff}
...
; vshuffle_(v128x64f,v128x64f,8u)[63] = {0x56,0x48,0x83,0xec,0x40,0xc5,0xf8,0x77,0x48,0x8b,0xf1,0xc5,0xf9,0x10,0x02,0xc4,0xc1,0x79,0x10,0x08,0x48,0x8b,0xce,0xc5,0xf9,0x29,0x44,0x24,0x30,0xc5,0xf9,0x29,0x4c,0x24,0x20,0x48,0x8d,0x54,0x24,0x30,0x4c,0x8d,0x44,0x24,0x20,0x45,0x0f,0xb6,0xc9,0xe8,0x9a,0xcb,0x19,0xff,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x40,0x5e,0xc3}
; TermCode = CTC_RET_INTR
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,40h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 40}
0005h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0028h lea r8,[rsp+20h]                        ; LEA r64, m || REX.W 8D /r || encoded[5]{4c 8d 44 24 20}
002dh movzx r9d,r9b                           ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[4]{45 0f b6 c9}
0031h call 7ff7c7738a90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9a cb 19 ff}
0036h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0039h add rsp,40h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 40}
003dh pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
003eh ret                                     ; RET || C3 || encoded[1]{c3}
...
; vextract_(v128x32f,8u)[36] = {0x48,0x83,0xec,0x38,0xc5,0xf8,0x77,0xc5,0xf9,0x10,0x01,0xc5,0xf9,0x29,0x44,0x24,0x20,0x48,0x8d,0x4c,0x24,0x20,0x0f,0xb6,0xd2,0xe8,0xd2,0xd4,0x19,0xff,0x90,0x48,0x83,0xc4,0x38,0xc3}
; TermCode = CTC_RET_INTR
...
0019h call 7ff7c7739700h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d2 d4 19 ff}
...
; vextract_(v256x32f,8u)[50] = {0x56,0x48,0x83,0xec,0x50,0xc5,0xf8,0x77,0x48,0x8b,0xf1,0xc5,0xfd,0x10,0x02,0x48,0x8b,0xce,0xc5,0xfd,0x11,0x44,0x24,0x20,0x48,0x8d,0x54,0x24,0x20,0x45,0x0f,0xb6,0xc0,0xe8,0x6a,0xdb,0x19,0xff,0x48,0x8b,0xc6,0xc5,0xf8,0x77,0x48,0x83,0xc4,0x50,0x5e,0xc3}
; TermCode = CTC_RET_INTR
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
...
0021h call 7ff7c7739de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6a db 19 ff}
...
; vextract_(v256x64f,8u)[50] = {0x56,0x48,0x83,0xec,0x50,0xc5,0xf8,0x77,0x48,0x8b,0xf1,0xc5,0xfd,0x10,0x02,0x48,0x8b,0xce,0xc5,0xfd,0x11,0x44,0x24,0x20,0x48,0x8d,0x54,0x24,0x20,0x45,0x0f,0xb6,0xc0,0xe8,0x22,0xdb,0x19,0xff,0x48,0x8b,0xc6,0xc5,0xf8,0x77,0x48,0x83,0xc4,0x50,0x5e,0xc3}
; TermCode = CTC_RET_INTR
0000h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0001h sub rsp,50h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 50}
0005h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0018h lea rdx,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 54 24 20}
001dh movzx r8d,r8b                           ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[4]{45 0f b6 c0}
0021h call 7ff7c7739de8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 22 db 19 ff}
0026h mov rax,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c6}
0029h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
002ch add rsp,50h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 50}
0030h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
; vxscalar_(v128x32f,8u)[36] = {0x48,0x83,0xec,0x38,0xc5,0xf8,0x77,0xc5,0xf9,0x10,0x01,0xc5,0xf9,0x29,0x44,0x24,0x20,0x48,0x8d,0x4c,0x24,0x20,0x0f,0xb6,0xd2,0xe8,0xf2,0xd3,0x19,0xff,0x90,0x48,0x83,0xc4,0x38,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,38h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 38}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmovupd xmm0,[rcx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 01}
...
0011h lea rcx,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 20}
0016h movzx edx,dl                            ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[3]{0f b6 d2}
0019h call 7ff7c7739700h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f2 d3 19 ff}
001eh nop                                     ; NOP || o32 90 || encoded[1]{90}
001fh add rsp,38h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 38}
0023h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; double vxscalar(Vector128<double> src, byte pos), hex://intrinsics/dinxfp?vxscalar#vxscalar_(v128x64f,8u)
; vxscalar_(v128x64f,8u)[53] = {0x48,0x83,0xec,0x38,0xc5,0xf8,0x77,0xc5,0xf9,0x10,0x01,0xc5,0xf9,0x29,0x44,0x24,0x20,0x0f,0xb6,0xca,0x83,0xf9,0x02,0x73,0x12,0x48,0x8d,0x44,0x24,0x20,0x48,0x63,0xc9,0xc5,0xfb,0x10,0x04,0xc8,0x48,0x83,0xc4,0x38,0xc3,0xb9,0x15,0x00,0x00,0x00,0xe8,0x03,0x8e,0x1a,0xff}
; TermCode = CTC_INTRx2
0000h sub rsp,38h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 38}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmovupd xmm0,[rcx]                      ; VMOVUPD xmm1, xmm2/m128 || VEX.128.66.0F.WIG 10 /r || encoded[4]{c5 f9 10 01}
...
0030h call 7ff7c7745168h                      ; CALL rel32 || E8 cd || encoded[5]{e8 03 8e 1a ff}
------------------------------------------------------------------------------------------------------------------------
