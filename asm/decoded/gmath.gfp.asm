...
; signum_g[32f](32f)[18] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xe8,0xac,0x77,0x86,0xff,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_Zx3
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h call 7ff7c7aac4f8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ac 77 86 ff}
...
; signum_g[64f](64f)[18] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xe8,0x54,0x77,0x86,0xff,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_Zx3
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h call 7ff7c7aac4d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 54 77 86 ff}
000ch nop                                     ; NOP || o32 90 || encoded[1]{90}
000dh add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
0011h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
