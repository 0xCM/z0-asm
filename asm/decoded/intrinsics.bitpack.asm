...
0181h call 7ff82738fc20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6a ff de 5e}
0186h call 7ff7c7765098h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd 53 1c ff}
------------------------------------------------------------------------------------------------------------------------
...
; unpack32_g[8u](uspan8u,b256x32u~in,32i)[113] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x48,0x8b,0x01,0x49,0x63,0xc8,0x0f,0xb6,0x04,0x08,0x41,0xc1,0xe0,0x03,0x41,0x8b,0xc8,0x48,0x83,0xc1,0x08,0x44,0x8b,0x4a,0x08,0x49,0x3b,0xc9,0x77,0x47,0x48,0x8b,0x0a,0x4d,0x63,0xc0,0x4a,0x8d,0x0c,0x81,0x0f,0xb6,0xc0,0x45,0x33,0xc0,0x4c,0x89,0x44,0x24,0x20,0x4c,0x89,0x44,0x24,0x20,0x4c,0x8d,0x44,0x24,0x20,0x8b,0xc0,0x49,0xb9,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xc4,0xc2,0xfb,0xf5,0xc1,0x49,0x89,0x00,0xc4,0xc2,0x7d,0x31,0x00,0xc5,0xfe,0x7f,0x01,0x48,0x8b,0xc2,0xc5,0xf8,0x77,0x48,0x83,0xc4,0x28,0xc3,0xe8,0x97,0x0d,0x1c,0xff}
; TermCode = CTC_INTRx2
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h mov rax,[rcx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 01}
...
006ch call 7ff7c7765098h                      ; CALL rel32 || E8 cd || encoded[5]{e8 97 0d 1c ff}
------------------------------------------------------------------------------------------------------------------------
...
0090h call 7ff7c7765098h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e3 08 1c ff}
------------------------------------------------------------------------------------------------------------------------
...
00d8h call 7ff7c7765098h                      ; CALL rel32 || E8 cd || encoded[5]{e8 eb 07 1c ff}
------------------------------------------------------------------------------------------------------------------------
...
0176h call 7ff7c7765098h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4d 06 1c ff}
------------------------------------------------------------------------------------------------------------------------
