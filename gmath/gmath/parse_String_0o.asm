...
; parse_String_0o[7ff7c718f9f0h, 7ff7c718faa0h][176] = {57 56 53 48 83 ec 40 c5 f8 77 33 c0 48 89 44 24 30 48 89 44 24 20 48 89 44 24 28 48 8b f1 c5 f8 57 c0 c5 fb 11 44 24 30 33 c0 48 89 44 24 38 48 85 f6 75 0e c5 f8 57 c0 c5 fb 11 44 24 30 33 ff eb 32 48 8d 7e 0c 8b 5e 08 e8 b2 bc d4 4e 4c 8b c0 48 8d 4c 24 20 48 89 39 89 59 08 48 8d 4c 24 20 4c 8d 4c 24 30 ba e7 00 00 00 e8 98 d0 21 ff 40 0f b6 f8 85 ff 74 13 c5 fb 10 44 24 30 c5 fb 11 44 24 38 b9 01 00 00 00 eb 02 33 c9 85 c9 74 0e c5 fb 10 44 24 38 48 83 c4 40 5b 5e 5f c3 48 8b ce e8 f9 f7 ff ff 90 48 83 c4 40 5b 5e 5f c3}
; Capture completion code, RET_INTR
; 2020-01-24 01:44:38:477
...
0049h call 7ff815edb6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 bc d4 4e}
...
006bh call 7ff7c63acaf8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 98 d0 21 ff}
...
00a2h call 7ff7c718f290h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f9 f7 ff ff}
