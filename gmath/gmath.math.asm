...
; parse_(string,8i~out)[121] = {0x57,0x56,0x53,0x48,0x83,0xec,0x40,0x33,0xc0,0x48,0x89,0x44,0x24,0x28,0x48,0x8b,0xf2,0x48,0x85,0xc9,0x75,0x07,0xc6,0x06,0x00,0x33,0xc0,0xeb,0x54,0x48,0x8d,0x79,0x0c,0x8b,0x59,0x08,0xe8,0x47,0x2d,0xaa,0x4e,0x4c,0x8b,0xc0,0x48,0x8d,0x4c,0x24,0x28,0x48,0x89,0x39,0x89,0x59,0x08,0x48,0x8d,0x4c,0x24,0x28,0x4c,0x8d,0x4c,0x24,0x38,0xba,0x07,0x00,0x00,0x00,0xe8,0xa5,0x3e,0xa9,0x4e,0x85,0xc0,0x75,0x10,0x8b,0x44,0x24,0x38,0x05,0x80,0x00,0x00,0x00,0x3d,0xff,0x00,0x00,0x00,0x76,0x07,0xc6,0x06,0x00,0x33,0xc0,0xeb,0x0b,0x8b,0x44,0x24,0x38,0x88,0x06,0xb8,0x01,0x00,0x00,0x00,0x48,0x83,0xc4,0x40,0x5b,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_Zx3
...
0024h call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 47 2d aa 4e}
...
0046h call 7ff816cfc870h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a5 3e a9 4e}
...
; parse_(string,8u~out)[115] = {0x57,0x56,0x53,0x48,0x83,0xec,0x40,0x33,0xc0,0x48,0x89,0x44,0x24,0x28,0x48,0x8b,0xf2,0x48,0x85,0xc9,0x75,0x07,0xc6,0x06,0x00,0x33,0xc0,0xeb,0x4e,0x48,0x8d,0x79,0x0c,0x8b,0x59,0x08,0xe8,0xa7,0x2c,0xaa,0x4e,0x4c,0x8b,0xc0,0x48,0x8d,0x4c,0x24,0x28,0x48,0x89,0x39,0x89,0x59,0x08,0x48,0x8d,0x4c,0x24,0x28,0x4c,0x8d,0x4c,0x24,0x38,0xba,0x07,0x00,0x00,0x00,0xe8,0xdd,0xf9,0x7b,0xff,0x85,0xc0,0x75,0x0a,0x81,0x7c,0x24,0x38,0xff,0x00,0x00,0x00,0x76,0x07,0xc6,0x06,0x00,0x33,0xc0,0xeb,0x0b,0x8b,0x44,0x24,0x38,0x88,0x06,0xb8,0x01,0x00,0x00,0x00,0x48,0x83,0xc4,0x40,0x5b,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001dh lea rdi,[rcx+0ch]                       ; LEA r64, m || REX.W 8D /r || encoded[4]{48 8d 79 0c}
0021h mov ebx,[rcx+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 59 08}
0024h call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a7 2c aa 4e}
0029h mov r8,rax                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b c0}
002ch lea rcx,[rsp+28h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 28}
0031h mov [rcx],rdi                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 39}
0034h mov [rcx+8],ebx                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 59 08}
...
003ch lea r9,[rsp+38h]                        ; LEA r64, m || REX.W 8D /r || encoded[5]{4c 8d 4c 24 38}
0041h mov edx,7                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 07 00 00 00}
0046h call 7ff7c7a28448h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd f9 7b ff}
004bh test eax,eax                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c0}
...
; parse_(string,16i~out)[126] = {0x57,0x56,0x53,0x48,0x83,0xec,0x40,0x33,0xc0,0x48,0x89,0x44,0x24,0x28,0x48,0x8b,0xf2,0x48,0x85,0xc9,0x75,0x09,0x66,0xc7,0x06,0x00,0x00,0x33,0xc0,0xeb,0x57,0x48,0x8d,0x79,0x0c,0x8b,0x59,0x08,0xe8,0x15,0x2c,0xaa,0x4e,0x4c,0x8b,0xc0,0x48,0x8d,0x4c,0x24,0x28,0x48,0x89,0x39,0x89,0x59,0x08,0x48,0x8d,0x4c,0x24,0x28,0x4c,0x8d,0x4c,0x24,0x38,0xba,0x07,0x00,0x00,0x00,0xe8,0x73,0x3d,0xa9,0x4e,0x85,0xc0,0x75,0x10,0x8b,0x44,0x24,0x38,0x05,0x00,0x80,0x00,0x00,0x3d,0xff,0xff,0x00,0x00,0x76,0x09,0x66,0xc7,0x06,0x00,0x00,0x33,0xc0,0xeb,0x0c,0x8b,0x44,0x24,0x38,0x66,0x89,0x06,0xb8,0x01,0x00,0x00,0x00,0x48,0x83,0xc4,0x40,0x5b,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0026h call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 15 2c aa 4e}
...
0048h call 7ff816cfc870h                      ; CALL rel32 || E8 cd || encoded[5]{e8 73 3d a9 4e}
...
; parse_(string,16u~out)[120] = {0x57,0x56,0x53,0x48,0x83,0xec,0x40,0x33,0xc0,0x48,0x89,0x44,0x24,0x28,0x48,0x8b,0xf2,0x48,0x85,0xc9,0x75,0x09,0x66,0xc7,0x06,0x00,0x00,0x33,0xc0,0xeb,0x51,0x48,0x8d,0x79,0x0c,0x8b,0x59,0x08,0xe8,0x75,0x2b,0xaa,0x4e,0x4c,0x8b,0xc0,0x48,0x8d,0x4c,0x24,0x28,0x48,0x89,0x39,0x89,0x59,0x08,0x48,0x8d,0x4c,0x24,0x28,0x4c,0x8d,0x4c,0x24,0x38,0xba,0x07,0x00,0x00,0x00,0xe8,0xab,0xf8,0x7b,0xff,0x85,0xc0,0x75,0x0a,0x81,0x7c,0x24,0x38,0xff,0xff,0x00,0x00,0x76,0x09,0x66,0xc7,0x06,0x00,0x00,0x33,0xc0,0xeb,0x0c,0x8b,0x44,0x24,0x38,0x66,0x89,0x06,0xb8,0x01,0x00,0x00,0x00,0x48,0x83,0xc4,0x40,0x5b,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001fh lea rdi,[rcx+0ch]                       ; LEA r64, m || REX.W 8D /r || encoded[4]{48 8d 79 0c}
0023h mov ebx,[rcx+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 59 08}
0026h call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 75 2b aa 4e}
002bh mov r8,rax                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b c0}
002eh lea rcx,[rsp+28h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 28}
0033h mov [rcx],rdi                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 39}
0036h mov [rcx+8],ebx                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 59 08}
...
003eh lea r9,[rsp+38h]                        ; LEA r64, m || REX.W 8D /r || encoded[5]{4c 8d 4c 24 38}
0043h mov edx,7                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 07 00 00 00}
0048h call 7ff7c7a28448h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ab f8 7b ff}
004dh test eax,eax                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c0}
...
; parse_(string,32i~out)[86] = {0x56,0x48,0x83,0xec,0x30,0x33,0xc0,0x48,0x89,0x44,0x24,0x20,0x48,0x8b,0xf2,0x48,0x85,0xc9,0x75,0x06,0x33,0xc9,0x89,0x0e,0xeb,0x34,0x48,0x8d,0x41,0x0c,0x8b,0x51,0x08,0x48,0x8d,0x4c,0x24,0x20,0x48,0x89,0x01,0x89,0x51,0x08,0xe8,0xdf,0x2a,0xaa,0x4e,0x4c,0x8b,0xc0,0x48,0x8d,0x4c,0x24,0x20,0x4c,0x8b,0xce,0xba,0x07,0x00,0x00,0x00,0xe8,0x4a,0x3c,0xa9,0x4e,0x85,0xc0,0x0f,0x94,0xc1,0x0f,0xb6,0xc9,0x8b,0xc1,0x48,0x83,0xc4,0x30,0x5e,0xc3}
; TermCode = CTC_RET_Zx3
...
002ch call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 df 2a aa 4e}
...
0041h call 7ff816cfc870h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4a 3c a9 4e}
...
0026h mov [rcx],rax                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 01}
0029h mov [rcx+8],edx                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 51 08}
002ch call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6f 2a aa 4e}
0031h mov r8,rax                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b c0}
0034h lea rcx,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 20}
0039h mov r9,rsi                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b ce}
003ch mov edx,7                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 07 00 00 00}
0041h call 7ff7c7a28448h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 f7 7b ff}
0046h test eax,eax                            ; TEST r/m32, r32 || o32 85 /r || encoded[2]{85 c0}
0048h sete cl                                 ; SETE r/m8 || 0F 94 /r || encoded[3]{0f 94 c1}
004bh movzx ecx,cl                            ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[3]{0f b6 c9}
004eh mov eax,ecx                             ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b c1}
...
0005h call 7ff7c7743088h                      ; CALL rel32 || E8 cd || encoded[5]{e8 be a3 4d ff}
000ah movzx eax,al                            ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[3]{0f b6 c0}
...
002ch call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9f 29 aa 4e}
0031h mov r8,rax                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b c0}
0034h lea rcx,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 20}
...
004ch call 7ff7c7a284a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 37 f7 7b ff}
...
0025h lea rdi,[rcx+0ch]                       ; LEA r64, m || REX.W 8D /r || encoded[4]{48 8d 79 0c}
0029h mov ebx,[rcx+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 59 08}
002ch call 7ff816d0b6f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1f 29 aa 4e}
0031h mov r8,rax                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b c0}
0034h lea rcx,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 4c 24 20}
0039h mov [rcx],rdi                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 39}
003ch mov [rcx+8],ebx                         ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 59 08}
...
0044h mov r9,rsi                              ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{4c 8b ce}
0047h mov edx,0e7h                            ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba e7 00 00 00}
004ch call 7ff7c7a284a0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 af f6 7b ff}
0051h movzx eax,al                            ; MOVZX r32, r/m8 || o32 0F B6 /r || encoded[3]{0f b6 c0}
0054h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
0058h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
0059h pop rsi                                 ; POP r64 || 58+ro || encoded[1]{5e}
...
; modmul_(32f,32f,32f)[26] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xfa,0x59,0xc1,0xc5,0xf8,0x28,0xca,0xe8,0x3c,0x49,0x12,0x5f,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000fh call 7ff827391660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3c 49 12 5f}
...
; modmul_(64f,64f,64f)[26] = {0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0xc5,0xfb,0x59,0xc1,0xc5,0xf8,0x28,0xca,0xe8,0x7c,0x48,0x12,0x5f,0x90,0x48,0x83,0xc4,0x28,0xc3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmulsd xmm0,xmm0,xmm1                   ; VMULSD xmm1, xmm2, xmm3/m64 || VEX.LIG.F2.0F.WIG 59 /r || encoded[4]{c5 fb 59 c1}
000bh vmovaps xmm1,xmm2                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 ca}
000fh call 7ff8273915d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 7c 48 12 5f}
0014h nop                                     ; NOP || o32 90 || encoded[1]{90}
0015h add rsp,28h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 28}
0019h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
