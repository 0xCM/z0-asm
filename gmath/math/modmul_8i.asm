...
; modmul_8i[7ff7c719cae0h, 7ff7c719cb08h][40] = {0f 1f 44 00 00 48 0f be c1 48 63 c0 48 0f be d2 48 63 d2 48 0f af c2 49 0f be d0 48 63 ca 48 99 48 f7 f9 48 0f be c2 c3}
; Capture completion code, RET_SBB
; 2020-01-25 02:10:56:711
