...
; negative_8i[18] = {0f 1f 44 00 00 48 0f be c1 85 c0 0f 9c c0 0f b6 c0 c3}
...
; negative_16i[18] = {0f 1f 44 00 00 48 0f bf c1 85 c0 0f 9c c0 0f b6 c0 c3}
; TermCode = CTC_RET_Zx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; bit negative(int x)
; negative_32i[14] = {0f 1f 44 00 00 85 c9 0f 9c c0 0f b6 c0 c3}
; TermCode = CTC_RET_Zx3
0000h nop dword ptr [rax+rax]                 ; NOP r/m32 || o32 0F 1F /0 || encoded[5]{0f 1f 44 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; bit negative(long x)
; negative_64i[15] = {0f 1f 44 00 00 48 85 c9 0f 9c c0 0f b6 c0 c3}
...
; negative_32f[20] = {c5 f8 77 66 90 c5 f0 57 c9 c5 f8 2e c8 0f 97 c0 0f b6 c0 c3}
...
; negative_64f[20] = {c5 f8 77 66 90 c5 f0 57 c9 c5 f9 2e c8 0f 97 c0 0f b6 c0 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vxorps xmm1,xmm1,xmm1                   ; VXORPS xmm1, xmm2, xmm3/m128 || VEX.128.0F.WIG 57 /r || encoded[4]{c5 f0 57 c9}
