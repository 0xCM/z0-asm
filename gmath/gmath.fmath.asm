...
; dist_(64f,64f)[47] = {48 83 ec 28 c5 f8 77 c5 f9 2e c1 73 13 c5 f3 5c c8 c5 f8 28 c1 e8 f6 ac 22 5f 90 48 83 c4 28 c3 c5 fb 5c c1 e8 e7 ac 22 5f 90 48 83 c4 28 c3}
; TermCode = CTC_RET_INTR
...
0015h call 7ff825fcd940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f6 ac 22 5f}
...
0024h call 7ff825fcd940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 e7 ac 22 5f}
...
; divides_(32f,32f)[48] = {48 83 ec 28 c5 f8 77 c5 f8 28 d0 c5 f8 28 c1 c5 f8 28 ca e8 88 e9 22 5f c5 f0 57 c9 c5 f8 2e c1 0f 9b c0 7a 03 0f 94 c0 0f b6 c0 48 83 c4 28 c3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0013h call 7ff825fd1660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 88 e9 22 5f}
...
; divides_(64f,64f)[48] = {48 83 ec 28 c5 f8 77 c5 f8 28 d0 c5 f8 28 c1 c5 f8 28 ca e8 a8 e8 22 5f c5 f0 57 c9 c5 f9 2e c1 0f 9b c0 7a 03 0f 94 c0 0f b6 c0 48 83 c4 28 c3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmovaps xmm2,xmm0                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 d0}
000bh vmovaps xmm0,xmm1                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 c1}
000fh vmovaps xmm1,xmm2                       ; VMOVAPS xmm1, xmm2/m128 || VEX.128.0F.WIG 28 /r || encoded[4]{c5 f8 28 ca}
0013h call 7ff825fd15d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a8 e8 22 5f}
0018h vxorps xmm1,xmm1,xmm1                   ; VXORPS xmm1, xmm2, xmm3/m128 || VEX.128.0F.WIG 57 /r || encoded[4]{c5 f0 57 c9}
...
; signum_(32f)[18] = {c5 f8 77 66 90 48 b8 28 39 3c c6 f7 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,7ff7c63c3928h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 28 39 3c c6 f7 7f 00 00}
000fh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[3]{48 ff e0}
------------------------------------------------------------------------------------------------------------------------
; Sign:int signum(double src)
; signum_(64f)[18] = {c5 f8 77 66 90 48 b8 00 39 3c c6 f7 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h mov rax,7ff7c63c3900h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b8 00 39 3c c6 f7 7f 00 00}
000fh jmp rax                                 ; JMP r/m64 || FF /4 || encoded[3]{48 ff e0}
------------------------------------------------------------------------------------------------------------------------
...
; between_(32f,32f,32f)[29] = {c5 f8 77 66 90 c5 f8 2e c1 72 0c c5 f8 2e d0 0f 93 c0 0f b6 c0 eb 02 33 c0 0f b6 c0 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vucomiss xmm0,xmm1                      ; VUCOMISS xmm1, xmm2/m32 || VEX.LIG.0F.WIG 2E /r || encoded[4]{c5 f8 2e c1}
...
; between_(64f,64f,64f)[29] = {c5 f8 77 66 90 c5 f9 2e c1 72 0c c5 f9 2e d0 0f 93 c0 0f b6 c0 eb 02 33 c0 0f b6 c0 c3}
; TermCode = CTC_RET_INTR
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
0005h vucomisd xmm0,xmm1                      ; VUCOMISD xmm1, xmm2/m64 || VEX.LIG.66.0F.WIG 2E /r || encoded[4]{c5 f9 2e c1}
...
01a3h mov rcx,7ff7c65e0840h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 40 08 5e c6 f7 7f 00 00}
01adh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 9e 3a 10 5f}
...
01a2h ret                                     ; RET || C3 || encoded[1]{c3}
01a3h mov rcx,7ff7c65e0840h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 40 08 5e c6 f7 7f 00 00}
01adh call 7ff825ea6cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2e 38 10 5f}
01b2h mov rsi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f0}
01b5h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01b8h call 7ff7c63b9d00h                      ; CALL rel32 || E8 cd || encoded[5]{e8 73 68 61 ff}
01bdh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01c0h call 7ff825e1b900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6b 84 07 5f}
------------------------------------------------------------------------------------------------------------------------
; float exp(float pow)
; exp_(32f)[18] = {c5 f8 77 66 90 48 b8 70 8c 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; exp_(64f)[18] = {c5 f8 77 66 90 48 b8 60 8e 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; gcd_(32f,32f)[167] = {48 83 ec 68 c5 f8 77 c5 f8 29 74 24 50 c5 f8 29 7c 24 40 33 c0 48 89 44 24 38 48 89 44 24 28 c5 fa 11 44 24 30 8b 44 24 30 89 44 24 38 48 8d 44 24 38 81 20 ff ff ff 7f c5 fa 10 44 24 38 c5 fa 11 4c 24 20 8b 44 24 20 89 44 24 28 48 8d 44 24 28 81 20 ff ff ff 7f c5 fa 10 74 24 28 c5 f0 57 c9 c5 f8 2e f1 7a 02 74 38 c5 f8 28 ce e8 4e e0 22 5f c5 f8 28 f8 c5 f8 57 c0 c5 f8 2e f8 7a 17 75 15 c5 f8 28 c6 c5 f8 28 74 24 50 c5 f8 28 7c 24 40 48 83 c4 68 c3 c5 f8 28 c6 c5 f8 28 f7 eb c8 c5 f8 28 f0 eb db}
; TermCode = CTC_INTRx2
...
006dh call 7ff825fd1660h                      ; CALL rel32 || E8 cd || encoded[5]{e8 4e e0 22 5f}
...
; gcd_(64f,64f)[175] = {48 83 ec 68 c5 f8 77 c5 f8 29 74 24 50 c5 f8 29 7c 24 40 33 c0 48 89 44 24 38 48 89 44 24 28 c5 fb 11 44 24 30 48 8b 44 24 30 48 89 44 24 38 48 8d 44 24 38 48 ba ff ff ff ff ff ff ff 7f 48 21 10 c5 fb 10 44 24 38 c5 fb 11 4c 24 20 48 8b 44 24 20 48 89 44 24 28 48 8d 44 24 28 48 21 10 c5 fb 10 74 24 28 c5 f0 57 c9 c5 f9 2e f1 7a 02 74 38 c5 f8 28 ce e8 d6 de 22 5f c5 f8 28 f8 c5 f8 57 c0 c5 f9 2e f8 7a 17 75 15 c5 f8 28 c6 c5 f8 28 74 24 50 c5 f8 28 7c 24 40 48 83 c4 68 c3 c5 f8 28 c6 c5 f8 28 f7 eb c8 c5 f8 28 f0 eb db}
; TermCode = CTC_INTRx2
0000h sub rsp,68h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 68}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0007h vmovaps [rsp+50h],xmm6                  ; VMOVAPS xmm2/m128, xmm1 || VEX.128.0F.WIG 29 /r || encoded[6]{c5 f8 29 74 24 50}
...
0075h call 7ff825fd15d0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d6 de 22 5f}
...
; log2_(32f)[18] = {c5 f8 77 66 90 48 b8 f0 8c 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; log2_(64f)[18] = {c5 f8 77 66 90 48 b8 b0 8e 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
------------------------------------------------------------------------------------------------------------------------
; float ln(float src)
; ln_(32f)[18] = {c5 f8 77 66 90 48 b8 00 8d 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; ln_(64f)[18] = {c5 f8 77 66 90 48 b8 c0 8e 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; log_(32f)[50] = {48 83 ec 28 c5 f8 77 48 89 54 24 38 48 8d 44 24 38 0f b6 10 c5 fa 10 48 04 84 d2 75 0a c5 fa 10 0d 13 00 00 00 eb 00 e8 5c e0 ff ff 90 48 83 c4 28 c3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
0027h call 7ff7c6da18a8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5c e0 ff ff}
...
; log_(64f)[40] = {48 83 ec 28 c5 f8 77 0f b6 02 c5 fb 10 4a 08 84 c0 75 0a c5 fb 10 0d 15 00 00 00 eb 00 e8 5e ff 61 ff 90 48 83 c4 28 c3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
001dh call 7ff7c63c37f0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5e ff 61 ff}
...
; pow_(32f,32f)[18] = {c5 f8 77 66 90 48 b8 20 8d 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; pow_(64f,64f)[18] = {c5 f8 77 66 90 48 b8 e0 8e 0f 26 f8 7f 00 00 48 ff e0}
; TermCode = CTC_JMP_RAX
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
...
; relerr_(32f,32f)[159] = {48 83 ec 58 c5 f8 77 c5 f8 29 74 24 40 c5 f8 29 7c 24 30 c5 fa 11 44 24 60 c5 ca 5a f0 c5 c2 5a f9 c5 f9 2e f7 73 0f c5 c3 5c fe c5 f8 28 c7 e8 ec 9f 22 5f eb 0d c5 cb 5c f7 c5 f8 28 c6 e8 dd 9f 22 5f c5 f8 57 c0 c4 e1 fb 2a c0 48 85 c0 7d 08 c5 fb 58 05 5f 00 00 00 c5 fb 5a c0 c5 fa 5e 44 24 60 c5 fa 11 44 24 2c 8b 44 24 2c 25 ff ff ff 7f 3d 00 00 80 7f 7f 11 c5 f8 28 74 24 40 c5 f8 28 7c 24 30 48 83 c4 58 c3 c5 f8 57 c0 c5 f8 28 74 24 40 c5 f8 28 7c 24 30 48 83 c4 58 c3}
; TermCode = CTC_RET_INTR
...
002fh call 7ff825fcd940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ec 9f 22 5f}
...
003eh call 7ff825fcd940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 dd 9f 22 5f}
...
; relerr_(64f,64f)[142] = {48 83 ec 48 c5 f8 77 c5 f8 29 74 24 30 c5 f8 28 f0 c5 f9 2e f1 73 0f c5 f8 28 c1 c5 fb 5c c6 e8 1c 9f 22 5f eb 0d c5 f8 28 c6 c5 fb 5c c1 e8 0d 9f 22 5f c5 f8 57 c0 c4 e1 fb 2a c0 48 85 c0 7d 08 c5 fb 58 05 57 00 00 00 c5 fb 5e c6 c5 fb 11 44 24 28 48 8b 44 24 28 48 ba ff ff ff ff ff ff ff 7f 48 23 c2 48 ba 00 00 00 00 00 00 f0 7f 48 3b c2 7f 0b c5 f8 28 74 24 30 48 83 c4 48 c3 c5 f8 57 c0 c5 f8 28 74 24 30 48 83 c4 48 c3}
; TermCode = CTC_RET_INTR
...
001fh call 7ff825fcd940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1c 9f 22 5f}
...
002eh call 7ff825fcd940h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0d 9f 22 5f}
