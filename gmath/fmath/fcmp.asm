...
01a3h mov rcx,7ff7c7976170h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 70 61 97 c7 f7 7f 00 00}
01adh call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ae 2a 09 5f}
...
01a2h ret                                     ; RET || C3 || encoded[1]{c3}
01a3h mov rcx,7ff7c7976170h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 70 61 97 c7 f7 7f 00 00}
01adh call 7ff827266cb0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ce 27 09 5f}
01b2h mov rsi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f0}
01b5h mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01b8h call 7ff7c7759530h                      ; CALL rel32 || E8 cd || encoded[5]{e8 43 50 58 ff}
01bdh mov rcx,rsi                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b ce}
01c0h call 7ff8271db900h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0b 74 00 5f}
01c5h int 3                                   ; INT3 || CC || encoded[1]{cc}
