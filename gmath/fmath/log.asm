...
; log_32f[50] = {48 83 ec 28 c5 f8 77 48 89 54 24 38 48 8d 44 24 38 0f b6 10 c5 fa 10 48 04 84 d2 75 0a c5 fa 10 0d 13 00 00 00 eb 00 e8 2c f1 ff ff 90 48 83 c4 28 c3}
...
0027h call 7ff7c8273a18h                      ; CALL rel32 || E8 cd || encoded[5]{e8 2c f1 ff ff}
...
; log_64f[40] = {48 83 ec 28 c5 f8 77 0f b6 02 c5 fb 10 4a 08 84 c0 75 0a c5 fb 10 0d 15 00 00 00 eb 00 e8 46 36 51 ff 90 48 83 c4 28 c3}
; TermCode = CTC_RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
001dh call 7ff7c7787f78h                      ; CALL rel32 || E8 cd || encoded[5]{e8 46 36 51 ff}
