...
0027h call 7ff7c6d03ce8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fc e1 ff ff}
...
; log_64f[40] = {48 83 ec 28 c5 f8 77 0f b6 02 c5 fb 10 4a 08 84 c0 75 0a c5 fb 10 0d 15 00 00 00 eb 00 e8 46 a2 a6 ff 90 48 83 c4 28 c3}
; TermCode = RET_INTR
0000h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
0004h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
...
001dh call 7ff7c6770238h                      ; CALL rel32 || E8 cd || encoded[5]{e8 46 a2 a6 ff}
