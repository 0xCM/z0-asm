------------------------------------------------------------------------------------------------------------------------
; float exp(float pow)
; exp_32f[25] = {c5 f8 77 66 90 48 b8 70 8c 0f 26 f8 7f 00 00 48 ff e0 00 00 19 00 00 00 40}
...
; exp_64f[25] = {c5 f8 77 66 90 48 b8 60 8e 0f 26 f8 7f 00 00 48 ff e0 00 00 19 00 00 00 40}
; Capture completion code = ZEDx6_000
0000h vzeroupper                              ; VZEROUPPER || VEX.128.0F.WIG 77 || encoded[3]{c5 f8 77}
0003h xchg ax,ax                              ; NOP || o16 90 || encoded[2]{66 90}
