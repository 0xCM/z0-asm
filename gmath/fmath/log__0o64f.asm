...
; log__0o64f[7ff7c719e0c0h, 7ff7c719e0e8h][40] = {48 83 ec 28 c5 f8 77 0f b6 02 c5 fb 10 4a 08 84 c0 75 0a c5 fb 10 0d 15 00 00 00 eb 00 e8 06 9a 21 ff 90 48 83 c4 28 c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:10:56:999
...
0013h vmovsd xmm1,qword ptr [7ff7c719e0f0h]   ; VMOVSD xmm1, m64 || VEX.LIG.F2.0F.WIG 10 /r || encoded[8]{c5 fb 10 0d 15 00 00 00}
001bh jmp short 001dh                         ; JMP rel8 || EB cb || encoded[2]{eb 00}
001dh call 7ff7c63b7ae8h                      ; CALL rel32 || E8 cd || encoded[5]{e8 06 9a 21 ff}
