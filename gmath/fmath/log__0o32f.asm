...
; log__0o32f[7ff7c719e070h, 7ff7c719e0a2h][50] = {48 83 ec 28 c5 f8 77 48 89 54 24 38 48 8d 44 24 38 0f b6 10 c5 fa 10 48 04 84 d2 75 0a c5 fa 10 0d 13 00 00 00 eb 00 e8 84 93 ff ff 90 48 83 c4 28 c3}
; Capture completion code, RET_INTR
; 2020-01-25 02:10:56:998
...
001dh vmovss xmm1,dword ptr [7ff7c719e0a8h]   ; VMOVSS xmm1, m32 || VEX.LIG.F3.0F.WIG 10 /r || encoded[8]{c5 fa 10 0d 13 00 00 00}
0025h jmp short 0027h                         ; JMP rel8 || EB cb || encoded[2]{eb 00}
0027h call 7ff7c7197420h                      ; CALL rel32 || E8 cd || encoded[5]{e8 84 93 ff ff}
