...
; avg_g32f[7ff7c71be740h, 7ff7c71be776h][54] = {48 83 ec 38 c5 f8 77 33 c0 48 89 44 24 28 48 8b 01 8b 49 08 48 8d 54 24 28 48 89 02 89 4a 08 48 8d 4c 24 28 e8 0f 76 fd ff 90 48 83 c4 38 c3 e8 ac 14 e1 5e cc 00}
; Capture completion code, ZEDx2_SBB
; 2020-01-25 02:11:00:356
...
0024h call 7ff7c7195d78h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0f 76 fd ff}
0029h nop                                     ; NOP || o32 90 || encoded[1]{90}
002ah add rsp,38h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 38}
002eh ret                                     ; RET || C3 || encoded[1]{c3}
002fh call 7ff825fcfc20h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ac 14 e1 5e}
