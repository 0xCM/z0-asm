...
; cells_(n16,16u)[106] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 48 b9 b0 a7 d9 c7 f7 7f 00 00 ba 01 00 00 00 e8 25 64 39 5f 66 89 70 10 48 83 c0 10 ba 01 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 a3 54 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
...
0017h mov rcx,7ff7c7d9a7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 a7 d9 c7 f7 7f 00 00}
0021h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
0026h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 25 64 39 5f}
...
0058h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 a3 54 39 5f}
...
; cells_(n16,64u)[144] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 49 8b f0 48 b9 98 bc a0 c7 f7 7f 00 00 ba 01 00 00 00 e8 65 5a 39 5f 48 8b f8 48 89 77 10 b8 01 00 00 00 33 c9 99 f7 f9 ba 01 00 00 00 83 ea 00 74 0f ba 01 00 00 00 b9 10 00 00 00 e8 ab 88 e9 ff 48 83 c7 10 b8 01 00 00 00 48 8d 54 24 20 c5 f8 57 c0 c5 fa 7f 02 48 8d 54 24 20 48 89 3a 89 42 08 48 8b fb 48 8d 74 24 20 e8 bd 4a 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0017h mov rcx,7ff7c7a0bc98h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 98 bc a0 c7 f7 7f 00 00}
0021h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
0026h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 65 5a 39 5f}
...
0050h call 7ff7c7d69c50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ab 88 e9 ff}
...
007eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bd 4a 39 5f}
...
; cells_(n32,64u)[144] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 49 8b f0 48 b9 98 bc a0 c7 f7 7f 00 00 ba 01 00 00 00 e8 65 55 39 5f 48 8b f8 48 89 77 10 b8 01 00 00 00 33 c9 99 f7 f9 ba 01 00 00 00 83 ea 00 74 0f ba 01 00 00 00 b9 20 00 00 00 e8 ab 83 e9 ff 48 83 c7 10 b8 01 00 00 00 48 8d 54 24 20 c5 f8 57 c0 c5 fa 7f 02 48 8d 54 24 20 48 89 3a 89 42 08 48 8b fb 48 8d 74 24 20 e8 bd 45 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0017h mov rcx,7ff7c7a0bc98h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 98 bc a0 c7 f7 7f 00 00}
0021h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
0026h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 65 55 39 5f}
002bh mov rdi,rax                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b f8}
002eh mov [rdi+10h],rsi                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 77 10}
0032h mov eax,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 01 00 00 00}
0037h xor ecx,ecx                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c9}
...
0050h call 7ff7c7d69c50h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ab 83 e9 ff}
0055h add rdi,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c7 10}
0059h mov eax,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{b8 01 00 00 00}
005eh lea rdx,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 54 24 20}
0063h vxorps xmm0,xmm0,xmm0                   ; VXORPS xmm1, xmm2, xmm3/m128 || VEX.128.0F.WIG 57 /r || encoded[4]{c5 f8 57 c0}
...
0076h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0079h lea rsi,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 74 24 20}
007eh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 bd 45 39 5f}
0083h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0085h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0088h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
008ch pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
...
; cells_(n32,8u,8u,8u,8u)[129] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 10 ea 72 c7 f7 7f 00 00 ba 04 00 00 00 e8 b2 54 39 5f 40 88 70 10 40 88 78 11 8b 74 24 70 40 88 70 12 8b 74 24 78 40 88 70 13 48 83 c0 10 ba 04 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 1c 45 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b2 54 39 5f}
...
006fh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1c 45 39 5f}
...
; cells_(n32,16u,16u)[113] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 b0 a7 d9 c7 f7 7f 00 00 ba 02 00 00 00 e8 12 54 39 5f 66 89 70 10 66 89 78 12 48 83 c0 10 ba 02 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 8c 44 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0014h mov esi,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f0}
0017h mov edi,r9d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f9}
001ah mov rcx,7ff7c7d9a7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 a7 d9 c7 f7 7f 00 00}
0024h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 12 54 39 5f}
...
005fh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8c 44 39 5f}
...
; cells_(n32,32u)[105] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 48 b9 a0 be a0 c7 f7 7f 00 00 ba 01 00 00 00 e8 85 53 39 5f 89 70 10 48 83 c0 10 ba 01 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 04 44 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0011h mov rbx,rcx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b d9}
0014h mov esi,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f0}
0017h mov rcx,7ff7c7a0bea0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a0 be a0 c7 f7 7f 00 00}
0021h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
0026h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 85 53 39 5f}
...
0057h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 04 44 39 5f}
...
; cells_(n64,8u,8u,8u,8u,8u,8u,8u,8u)[173] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 10 ea 72 c7 f7 7f 00 00 ba 08 00 00 00 e8 f2 4e 39 5f 40 88 70 10 40 88 78 11 8b 74 24 70 40 88 70 12 8b 74 24 78 40 88 70 13 8b b4 24 80 00 00 00 40 88 70 14 8b b4 24 88 00 00 00 40 88 70 15 8b b4 24 90 00 00 00 40 88 70 16 8b b4 24 98 00 00 00 40 88 70 17 48 83 c0 10 ba 08 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 30 3f 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f2 4e 39 5f}
002eh mov [rax+10h],sil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 70 10}
0032h mov [rax+11h],dil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 78 11}
0036h mov esi,[rsp+70h]                       ; MOV r32, r/m32 || o32 8B /r || encoded[4]{8b 74 24 70}
003ah mov [rax+12h],sil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 70 12}
...
009bh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 30 3f 39 5f}
...
; cells_(n64,16u,16u,16u,16u)[129] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 b0 a7 d9 c7 f7 7f 00 00 ba 04 00 00 00 e8 22 4e 39 5f 66 89 70 10 66 89 78 12 8b 74 24 70 66 89 70 14 8b 74 24 78 66 89 70 16 48 83 c0 10 ba 04 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 8c 3e 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001ah mov rcx,7ff7c7d9a7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 a7 d9 c7 f7 7f 00 00}
0024h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 22 4e 39 5f}
002eh mov [rax+10h],si                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 70 10}
0032h mov [rax+12h],di                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 78 12}
0036h mov esi,[rsp+70h]                       ; MOV r32, r/m32 || o32 8B /r || encoded[4]{8b 74 24 70}
...
0067h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
006ah lea rsi,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 74 24 20}
006fh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 8c 3e 39 5f}
0074h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0076h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0079h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
007dh pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
...
; cells_(n64,32u,32u)[111] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 a0 be a0 c7 f7 7f 00 00 ba 02 00 00 00 e8 82 4d 39 5f 89 70 10 89 78 14 48 83 c0 10 ba 02 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 fe 3d 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0014h mov esi,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f0}
0017h mov edi,r9d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f9}
001ah mov rcx,7ff7c7a0bea0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a0 be a0 c7 f7 7f 00 00}
0024h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 82 4d 39 5f}
...
005dh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 fe 3d 39 5f}
...
; cells_(n64,64u)[106] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 49 8b f0 48 b9 98 bc a0 c7 f7 7f 00 00 ba 01 00 00 00 e8 f5 4c 39 5f 48 89 70 10 48 83 c0 10 ba 01 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 73 3d 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0017h mov rcx,7ff7c7a0bc98h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 98 bc a0 c7 f7 7f 00 00}
0021h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
0026h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f5 4c 39 5f}
...
0050h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0053h lea rsi,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 74 24 20}
0058h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 73 3d 39 5f}
005dh movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
005fh mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0062h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
0066h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
...
; cells_(n128,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u)[266] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 89 44 24 28 48 8b d9 41 8b f0 41 8b f9 48 b9 10 ea 72 c7 f7 7f 00 00 ba 10 00 00 00 e8 5d 4c 39 5f 40 88 70 10 40 88 78 11 8b 74 24 70 40 88 70 12 8b 74 24 78 40 88 70 13 8b b4 24 80 00 00 00 40 88 70 14 8b b4 24 88 00 00 00 40 88 70 15 8b b4 24 90 00 00 00 40 88 70 16 8b b4 24 98 00 00 00 40 88 70 17 8b b4 24 a0 00 00 00 40 88 70 18 8b b4 24 a8 00 00 00 40 88 70 19 8b b4 24 b0 00 00 00 40 88 70 1a 8b b4 24 b8 00 00 00 40 88 70 1b 8b b4 24 c0 00 00 00 40 88 70 1c 8b b4 24 c8 00 00 00 40 88 70 1d 8b b4 24 d0 00 00 00 40 88 70 1e 8b b4 24 d8 00 00 00 40 88 70 1f 48 83 c0 10 ba 10 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 43 3c 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
002eh call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 5d 4c 39 5f}
...
00f8h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 43 3c 39 5f}
...
; cells_(n128,16u,16u,16u,16u,16u,16u,16u,16u)[173] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 b0 a7 d9 c7 f7 7f 00 00 ba 08 00 00 00 e8 32 4b 39 5f 66 89 70 10 66 89 78 12 8b 74 24 70 66 89 70 14 8b 74 24 78 66 89 70 16 8b b4 24 80 00 00 00 66 89 70 18 8b b4 24 88 00 00 00 66 89 70 1a 8b b4 24 90 00 00 00 66 89 70 1c 8b b4 24 98 00 00 00 66 89 70 1e 48 83 c0 10 ba 08 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 70 3b 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001ah mov rcx,7ff7c7d9a7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 a7 d9 c7 f7 7f 00 00}
0024h mov edx,8                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 08 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 32 4b 39 5f}
002eh mov [rax+10h],si                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 70 10}
0032h mov [rax+12h],di                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 78 12}
0036h mov esi,[rsp+70h]                       ; MOV r32, r/m32 || o32 8B /r || encoded[4]{8b 74 24 70}
003ah mov [rax+14h],si                        ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 89 70 14}
...
0093h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
0096h lea rsi,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 74 24 20}
009bh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 70 3b 39 5f}
00a0h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
00a2h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
00a5h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
00a9h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
...
; cells_(n128,32u,32u,32u,32u)[125] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 a0 be a0 c7 f7 7f 00 00 ba 04 00 00 00 e8 62 4a 39 5f 89 70 10 89 78 14 8b 74 24 70 89 70 18 8b 74 24 78 89 70 1c 48 83 c0 10 ba 04 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 d0 3a 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001ah mov rcx,7ff7c7a0bea0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a0 be a0 c7 f7 7f 00 00}
0024h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 62 4a 39 5f}
002eh mov [rax+10h],esi                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 10}
0031h mov [rax+14h],edi                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 78 14}
...
006bh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d0 3a 39 5f}
...
; cells_(n128,64u,64u)[113] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 49 8b f0 49 8b f9 48 b9 98 bc a0 c7 f7 7f 00 00 ba 02 00 00 00 e8 c2 49 39 5f 48 89 70 10 48 89 78 18 48 83 c0 10 ba 02 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 3c 3a 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001ah mov rcx,7ff7c7a0bc98h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 98 bc a0 c7 f7 7f 00 00}
0024h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 c2 49 39 5f}
...
0057h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
005ah lea rsi,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 74 24 20}
005fh call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3c 3a 39 5f}
0064h movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
0066h mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0069h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
006dh pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
...
; cells_(n256,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u,8u)[442] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 89 44 24 28 48 8b d9 41 8b f0 41 8b f9 48 b9 10 ea 72 c7 f7 7f 00 00 ba 20 00 00 00 e8 1d 45 39 5f 40 88 70 10 40 88 78 11 8b 74 24 70 40 88 70 12 8b 74 24 78 40 88 70 13 8b b4 24 80 00 00 00 40 88 70 14 8b b4 24 88 00 00 00 40 88 70 15 8b b4 24 90 00 00 00 40 88 70 16 8b b4 24 98 00 00 00 40 88 70 17 8b b4 24 a0 00 00 00 40 88 70 18 8b b4 24 a8 00 00 00 40 88 70 19 8b b4 24 b0 00 00 00 40 88 70 1a 8b b4 24 b8 00 00 00 40 88 70 1b 8b b4 24 c0 00 00 00 40 88 70 1c 8b b4 24 c8 00 00 00 40 88 70 1d 8b b4 24 d0 00 00 00 40 88 70 1e 8b b4 24 d8 00 00 00 40 88 70 1f 8b b4 24 e0 00 00 00 40 88 70 20 8b b4 24 e8 00 00 00 40 88 70 21 8b b4 24 f0 00 00 00 40 88 70 22 8b b4 24 f8 00 00 00 40 88 70 23 8b b4 24 00 01 00 00 40 88 70 24 8b b4 24 08 01 00 00 40 88 70 25 8b b4 24 10 01 00 00 40 88 70 26 8b b4 24 18 01 00 00 40 88 70 27 8b b4 24 20 01 00 00 40 88 70 28 8b b4 24 28 01 00 00 40 88 70 29 8b b4 24 30 01 00 00 40 88 70 2a 8b b4 24 38 01 00 00 40 88 70 2b 8b b4 24 40 01 00 00 40 88 70 2c 8b b4 24 48 01 00 00 40 88 70 2d 8b b4 24 50 01 00 00 40 88 70 2e 8b b4 24 58 01 00 00 40 88 70 2f 48 83 c0 10 ba 20 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 53 34 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
002eh call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 1d 45 39 5f}
0033h mov [rax+10h],sil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 70 10}
0037h mov [rax+11h],dil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 78 11}
003bh mov esi,[rsp+70h]                       ; MOV r32, r/m32 || o32 8B /r || encoded[4]{8b 74 24 70}
003fh mov [rax+12h],sil                       ; MOV r/m8, r8 || 88 /r || encoded[4]{40 88 70 12}
...
01a8h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 53 34 39 5f}
...
; cells_(n256,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u,16u)[266] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 89 44 24 28 48 8b d9 41 8b f0 41 8b f9 48 b9 b0 a7 d9 c7 f7 7f 00 00 ba 10 00 00 00 e8 3d 43 39 5f 66 89 70 10 66 89 78 12 8b 74 24 70 66 89 70 14 8b 74 24 78 66 89 70 16 8b b4 24 80 00 00 00 66 89 70 18 8b b4 24 88 00 00 00 66 89 70 1a 8b b4 24 90 00 00 00 66 89 70 1c 8b b4 24 98 00 00 00 66 89 70 1e 8b b4 24 a0 00 00 00 66 89 70 20 8b b4 24 a8 00 00 00 66 89 70 22 8b b4 24 b0 00 00 00 66 89 70 24 8b b4 24 b8 00 00 00 66 89 70 26 8b b4 24 c0 00 00 00 66 89 70 28 8b b4 24 c8 00 00 00 66 89 70 2a 8b b4 24 d0 00 00 00 66 89 70 2c 8b b4 24 d8 00 00 00 66 89 70 2e 48 83 c0 10 ba 10 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 23 33 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
0019h mov esi,r8d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f0}
001ch mov edi,r9d                             ; MOV r32, r/m32 || o32 8B /r || encoded[3]{41 8b f9}
001fh mov rcx,7ff7c7d9a7b0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 b0 a7 d9 c7 f7 7f 00 00}
0029h mov edx,10h                             ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 10 00 00 00}
002eh call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 3d 43 39 5f}
...
00f0h mov rdi,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b fb}
00f3h lea rsi,[rsp+20h]                       ; LEA r64, m || REX.W 8D /r || encoded[5]{48 8d 74 24 20}
00f8h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 23 33 39 5f}
00fdh movsq                                   ; MOVSQ || REX.W A5 || encoded[2]{48 a5}
00ffh mov rax,rbx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c3}
0102h add rsp,30h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 30}
0106h pop rbx                                 ; POP r64 || 58+ro || encoded[1]{5b}
...
; cells_(n256,32u,32u,32u,32u,32u,32u,32u,32u)[165] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 41 8b f0 41 8b f9 48 b9 a0 be a0 c7 f7 7f 00 00 ba 08 00 00 00 e8 12 42 39 5f 89 70 10 89 78 14 8b 74 24 70 89 70 18 8b 74 24 78 89 70 1c 8b b4 24 80 00 00 00 89 70 20 8b b4 24 88 00 00 00 89 70 24 8b b4 24 90 00 00 00 89 70 28 8b b4 24 98 00 00 00 89 70 2c 48 83 c0 10 ba 08 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 58 32 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001ah mov rcx,7ff7c7a0bea0h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 a0 be a0 c7 f7 7f 00 00}
0024h mov edx,8                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 08 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 12 42 39 5f}
002eh mov [rax+10h],esi                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 10}
0031h mov [rax+14h],edi                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 78 14}
0034h mov esi,[rsp+70h]                       ; MOV r32, r/m32 || o32 8B /r || encoded[4]{8b 74 24 70}
0038h mov [rax+18h],esi                       ; MOV r/m32, r32 || o32 89 /r || encoded[3]{89 70 18}
...
0093h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 58 32 39 5f}
...
; cells_(n256,64u,64u,64u,64u)[131] = {57 56 53 48 83 ec 30 c5 f8 77 33 c0 48 89 44 24 20 48 8b d9 49 8b f0 49 8b f9 48 b9 98 bc a0 c7 f7 7f 00 00 ba 04 00 00 00 e8 52 41 39 5f 48 89 70 10 48 89 78 18 48 8b 74 24 70 48 89 70 20 48 8b 74 24 78 48 89 70 28 48 83 c0 10 ba 04 00 00 00 48 8d 4c 24 20 c5 f8 57 c0 c5 fa 7f 01 48 8d 4c 24 20 48 89 01 89 51 08 48 8b fb 48 8d 74 24 20 e8 ba 31 39 5f 48 a5 48 8b c3 48 83 c4 30 5b 5e 5f c3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h push rbx                                ; PUSH r64 || 50+ro || encoded[1]{53}
...
001ah mov rcx,7ff7c7a0bc98h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 98 bc a0 c7 f7 7f 00 00}
0024h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
0029h call 7ff827266de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 52 41 39 5f}
002eh mov [rax+10h],rsi                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 70 10}
0032h mov [rax+18h],rdi                       ; MOV r/m64, r64 || REX.W 89 /r || encoded[4]{48 89 78 18}
...
0071h call 7ff827265e90h                      ; CALL rel32 || E8 cd || encoded[5]{e8 ba 31 39 5f}
