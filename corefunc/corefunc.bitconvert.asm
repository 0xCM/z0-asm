------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<byte>(in byte src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[8u](8u~in)
; GetBytes_g[8u](8u~in)[62] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x01,0x00,0x00,0x00,0xe8,0x70,0x84,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x01,0x00,0x00,0x00,0x0f,0xb6,0x0f,0x88,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
...
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 70 84 fb 5e}
...
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<sbyte>(in sbyte src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[8i](8i~in)
; GetBytes_g[8i](8i~in)[63] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x01,0x00,0x00,0x00,0xe8,0x10,0x84,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x01,0x00,0x00,0x00,0x48,0x0f,0xbe,0x0f,0x88,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
...
000ch mov rcx,7ff7c635ea10h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 ea 35 c6 f7 7f 00 00}
0016h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 10 84 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
0024h mov edx,1                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 01 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<ushort>(in ushort src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[16u](16u~in)
; GetBytes_g[16u](16u~in)[63] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x02,0x00,0x00,0x00,0xe8,0xb0,0x83,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x02,0x00,0x00,0x00,0x0f,0xb7,0x0f,0x66,0x89,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 b0 83 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
...
003eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<short>(in short src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[16i](16i~in)
; GetBytes_g[16i](16i~in)[64] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x02,0x00,0x00,0x00,0xe8,0x50,0x83,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x02,0x00,0x00,0x00,0x48,0x0f,0xbf,0x0f,0x66,0x89,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
...
000ch mov rcx,7ff7c635ea10h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 ea 35 c6 f7 7f 00 00}
0016h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 50 83 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
0024h mov edx,2                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 02 00 00 00}
...
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<uint>(in uint src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[32u](32u~in)
; GetBytes_g[32u](32u~in)[61] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x04,0x00,0x00,0x00,0xe8,0xf0,0x82,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x04,0x00,0x00,0x00,0x8b,0x0f,0x89,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 f0 82 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
...
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<int>(in int src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[32i](32i~in)
; GetBytes_g[32i](32i~in)[61] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x04,0x00,0x00,0x00,0xe8,0x90,0x82,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x04,0x00,0x00,0x00,0x8b,0x0f,0x89,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_Zx3
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000ch mov rcx,7ff7c635ea10h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 ea 35 c6 f7 7f 00 00}
0016h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 90 82 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
0024h mov edx,4                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 04 00 00 00}
0029h mov ecx,[rdi]                           ; MOV r32, r/m32 || o32 8B /r || encoded[2]{8b 0f}
002bh mov [rax],ecx                           ; MOV r/m32, r32 || o32 89 /r || encoded[2]{89 08}
...
003ch ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<ulong>(in ulong src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[64u](64u~in)
; GetBytes_g[64u](64u~in)[63] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x08,0x00,0x00,0x00,0xe8,0x30,0x82,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x08,0x00,0x00,0x00,0x48,0x8b,0x0f,0x48,0x89,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 30 82 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
...
003eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<long>(in long src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[64i](64i~in)
; GetBytes_g[64i](64i~in)[63] = {0x57,0x56,0x48,0x83,0xec,0x28,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x08,0x00,0x00,0x00,0xe8,0xd0,0x81,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x08,0x00,0x00,0x00,0x48,0x8b,0x0f,0x48,0x89,0x08,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_ZED_SBB
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
000ch mov rcx,7ff7c635ea10h                   ; MOV r64, imm64 || REX.W B8+ro io || encoded[10]{48 b9 10 ea 35 c6 f7 7f 00 00}
0016h mov edx,8                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 08 00 00 00}
001bh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 d0 81 fb 5e}
0020h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
0024h mov edx,8                               ; MOV r32, imm32 || o32 B8+rd id || encoded[5]{ba 08 00 00 00}
0029h mov rcx,[rdi]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 0f}
002ch mov [rax],rcx                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 08}
...
003eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<float>(in float src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[32f](32f~in)
; GetBytes_g[32f](32f~in)[68] = {0x57,0x56,0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x04,0x00,0x00,0x00,0xe8,0x6d,0x81,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x04,0x00,0x00,0x00,0xc5,0xfa,0x10,0x07,0xc5,0xfa,0x11,0x00,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
...
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 6d 81 fb 5e}
...
------------------------------------------------------------------------------------------------------------------------
; Span<byte> GetBytes<double>(in double src), hex://corefunc/BitConvert?GetBytes#GetBytes_g[64f](64f~in)
; GetBytes_g[64f](64f~in)[68] = {0x57,0x56,0x48,0x83,0xec,0x28,0xc5,0xf8,0x77,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x48,0xb9,0x10,0xea,0x35,0xc6,0xf7,0x7f,0x00,0x00,0xba,0x08,0x00,0x00,0x00,0xe8,0x0d,0x81,0xfb,0x5e,0x48,0x83,0xc0,0x10,0xba,0x08,0x00,0x00,0x00,0xc5,0xfb,0x10,0x07,0xc5,0xfb,0x11,0x00,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8b,0xc6,0x48,0x83,0xc4,0x28,0x5e,0x5f,0xc3}
; TermCode = CTC_RET_INTR
0000h push rdi                                ; PUSH r64 || 50+ro || encoded[1]{57}
0001h push rsi                                ; PUSH r64 || 50+ro || encoded[1]{56}
0002h sub rsp,28h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 28}
...
001eh call 7ff825ea6de0h                      ; CALL rel32 || E8 cd || encoded[5]{e8 0d 81 fb 5e}
0023h add rax,10h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c0 10}
...
0043h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<byte>(in byte src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[8u](8u~in,span8u)
...
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<sbyte>(in sbyte src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[8i](8i~in,span8u)
...
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<ushort>(in ushort src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[16u](16u~in,span8u)
...
0024h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<short>(in short src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[16i](16i~in,span8u)
...
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<uint>(in uint src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[32u](32u~in,span8u)
...
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<int>(in int src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[32i](32i~in,span8u)
...
0022h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<ulong>(in ulong src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[64u](64u~in,span8u)
...
0024h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<long>(in long src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[64i](64i~in,span8u)
...
0024h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<float>(in float src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[32f](32f~in,span8u)
...
------------------------------------------------------------------------------------------------------------------------
; void GetBytes<double>(in double src, Span<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_g[64f](64f~in,span8u)
...
0029h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; ref Block64<byte> GetBytes(ulong src, in Block64<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_(64u,b64x8u~in)
; GetBytes_(64u,b64x8u~in)[39] = {0x48,0x83,0xec,0x18,0x33,0xc0,0x48,0x89,0x44,0x24,0x08,0x48,0x8b,0x02,0x44,0x8b,0x42,0x08,0x48,0x89,0x08,0x48,0x89,0x44,0x24,0x08,0x44,0x89,0x44,0x24,0x10,0x48,0x8b,0xc2,0x48,0x83,0xc4,0x18,0xc3}
; TermCode = CTC_RET_ZED_SBB
0000h sub rsp,18h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 18}
0004h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
0006h mov [rsp+8],rax                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[5]{48 89 44 24 08}
000bh mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
000eh mov r8d,[rdx+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[4]{44 8b 42 08}
0012h mov [rax],rcx                           ; MOV r/m64, r64 || REX.W 89 /r || encoded[3]{48 89 08}
0015h mov [rsp+8],rax                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[5]{48 89 44 24 08}
001ah mov [rsp+10h],r8d                       ; MOV r/m32, r32 || o32 89 /r || encoded[5]{44 89 44 24 10}
001fh mov rax,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c2}
0022h add rsp,18h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 18}
0026h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; ref Block32<byte> GetBytes(uint src, in Block32<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_(32u,b32x8u~in)
; GetBytes_(32u,b32x8u~in)[38] = {0x48,0x83,0xec,0x18,0x33,0xc0,0x48,0x89,0x44,0x24,0x08,0x48,0x8b,0x02,0x44,0x8b,0x42,0x08,0x89,0x08,0x48,0x89,0x44,0x24,0x08,0x44,0x89,0x44,0x24,0x10,0x48,0x8b,0xc2,0x48,0x83,0xc4,0x18,0xc3}
; TermCode = CTC_RET_Zx3
0000h sub rsp,18h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 18}
0004h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
0006h mov [rsp+8],rax                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[5]{48 89 44 24 08}
000bh mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
000eh mov r8d,[rdx+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[4]{44 8b 42 08}
0012h mov [rax],ecx                           ; MOV r/m32, r32 || o32 89 /r || encoded[2]{89 08}
0014h mov [rsp+8],rax                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[5]{48 89 44 24 08}
0019h mov [rsp+10h],r8d                       ; MOV r/m32, r32 || o32 89 /r || encoded[5]{44 89 44 24 10}
001eh mov rax,rdx                             ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b c2}
0021h add rsp,18h                             ; ADD r/m64, imm8 || REX.W 83 /0 ib || encoded[4]{48 83 c4 18}
0025h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; ref Block16<byte> GetBytes(ushort src, in Block16<byte> dst), hex://corefunc/BitConvert?GetBytes#GetBytes_(16u,b16x8u~in)
; GetBytes_(16u,b16x8u~in)[48] = {0x48,0x83,0xec,0x18,0x33,0xc0,0x48,0x89,0x44,0x24,0x08,0x89,0x4c,0x24,0x20,0x48,0x8b,0x02,0x8b,0x4a,0x08,0x44,0x0f,0xb7,0x44,0x24,0x20,0x66,0x44,0x89,0x00,0x48,0x89,0x44,0x24,0x08,0x89,0x4c,0x24,0x10,0x48,0x8b,0xc2,0x48,0x83,0xc4,0x18,0xc3}
; TermCode = CTC_RET_SBB
0000h sub rsp,18h                             ; SUB r/m64, imm8 || REX.W 83 /5 ib || encoded[4]{48 83 ec 18}
0004h xor eax,eax                             ; XOR r32, r/m32 || o32 33 /r || encoded[2]{33 c0}
0006h mov [rsp+8],rax                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[5]{48 89 44 24 08}
000bh mov [rsp+20h],ecx                       ; MOV r/m32, r32 || o32 89 /r || encoded[4]{89 4c 24 20}
000fh mov rax,[rdx]                           ; MOV r64, r/m64 || REX.W 8B /r || encoded[3]{48 8b 02}
0012h mov ecx,[rdx+8]                         ; MOV r32, r/m32 || o32 8B /r || encoded[3]{8b 4a 08}
0015h movzx r8d,word ptr [rsp+20h]            ; MOVZX r32, r/m16 || o32 0F B7 /r || encoded[6]{44 0f b7 44 24 20}
001bh mov [rax],r8w                           ; MOV r/m16, r16 || o16 89 /r || encoded[4]{66 44 89 00}
001fh mov [rsp+8],rax                         ; MOV r/m64, r64 || REX.W 89 /r || encoded[5]{48 89 44 24 08}
0024h mov [rsp+10h],ecx                       ; MOV r/m32, r32 || o32 89 /r || encoded[4]{89 4c 24 10}
...
------------------------------------------------------------------------------------------------------------------------
; short ToInt16(ReadOnlySpan<byte> src, int offset), hex://corefunc/BitConvert?ToInt16#ToInt16_(uspan8u,32i)
...
------------------------------------------------------------------------------------------------------------------------
; ushort ToUInt16(ReadOnlySpan<byte> src, int offset), hex://corefunc/BitConvert?ToUInt16#ToUInt16_(uspan8u,32i)
...
------------------------------------------------------------------------------------------------------------------------
; int ToInt32(ReadOnlySpan<byte> src, int offset), hex://corefunc/BitConvert?ToInt32#ToInt32_(uspan8u,32i)
...
------------------------------------------------------------------------------------------------------------------------
; uint ToUInt32(ReadOnlySpan<byte> src, int offset), hex://corefunc/BitConvert?ToUInt32#ToUInt32_(uspan8u,32i)
...
000eh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; long ToInt64(ReadOnlySpan<byte> src, int offset), hex://corefunc/BitConvert?ToInt64#ToInt64_(uspan8u,32i)
...
000fh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; ulong ToUInt64(ReadOnlySpan<byte> src, int offset), hex://corefunc/BitConvert?ToUInt64#ToUInt64_(uspan8u,32i)
...
000fh ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; float ToSingle(int src), hex://corefunc/BitConvert?ToSingle#ToSingle_(32i)
...
------------------------------------------------------------------------------------------------------------------------
; float ToSingle(uint src), hex://corefunc/BitConvert?ToSingle#ToSingle_(32u)
...
0013h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; double ToDouble(long src), hex://corefunc/BitConvert?ToDouble#ToDouble_(64i)
...
------------------------------------------------------------------------------------------------------------------------
; double ToDouble(ulong src), hex://corefunc/BitConvert?ToDouble#ToDouble_(64u)
...
0012h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; int ToInt32(float src), hex://corefunc/BitConvert?ToInt32#ToInt32_(32f)
...
0013h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; uint ToUInt32(float src), hex://corefunc/BitConvert?ToUInt32#ToUInt32_(32f)
...
0013h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; long ToInt64(double src), hex://corefunc/BitConvert?ToInt64#ToInt64_(64f)
...
0012h ret                                     ; RET || C3 || encoded[1]{c3}
------------------------------------------------------------------------------------------------------------------------
; ulong ToUInt64(double src), hex://corefunc/BitConvert?ToUInt64#ToUInt64_(64f)
